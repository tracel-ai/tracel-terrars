...
impl VerifiedaccessGroup {
    ...
    pub fn set_sse_configuration(self, v: impl Into<BlockAssignable<VerifiedaccessGroupSseConfigurationEl>>) -> Self {
        match v.into() {
    ...
    pub fn verifiedaccess_group_arn(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.verifiedaccess_group_arn", self.extract_ref()))
    }
    ...
    pub fn verifiedaccess_group_id(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.verifiedaccess_group_id", self.extract_ref()))
    }
    ...
    pub fn sse_configuration(&self) -> ListRef<VerifiedaccessGroupSseConfigurationElRef> {
        ListRef::new(self.shared().clone(), format!("{}.sse_configuration", self.extract_ref()))
    }
}
