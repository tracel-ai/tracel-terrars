...
impl Referable for ImagebuilderDistributionConfiguration {
...
impl BuildImagebuilderDistributionConfiguration {
    pub fn build(self, stack: &mut Stack) -> ImagebuilderDistributionConfiguration {
        let out = ImagebuilderDistributionConfiguration(Rc::new(
            ImagebuilderDistributionConfiguration_ {
...
impl ImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationEl {
    ...
    pub fn set_launch_permission(
        mut self,
        v : impl Into < BlockAssignable < ImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationElLaunchPermissionEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl ToListMappable
    for ImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationEl
{
...
impl ImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationElRef {
    ...
    #[doc = "Get a reference to the value of field `launch_permission` after provisioning.\n"]    pub fn launch_permission (& self) -> ListRef < ImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationElLaunchPermissionElRef >{
        ListRef::new(
            self.shared().clone(),
...
impl BuildImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryEl { pub fn build (self) -> ImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryEl { ImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryEl { repository_name : self . repository_name , service : self . service , } } }
pub struct ImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for ImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryElRef { fn new (shared : StackShared , base : String) -> ImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryElRef { ImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryElRef { shared : shared , base : base . to_string () , } } }
impl ImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `repository_name` after provisioning.\n"] pub fn repository_name (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.repository_name" , self . base)) } # [doc = "Get a reference to the value of field `service` after provisioning.\n"] pub fn service (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.service" , self . base)) } }
#[derive(Serialize, Default)]
struct ImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElDynamic { target_repository : Option < DynamicBlock < ImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryEl >> , }
#[derive(Serialize)]
pub struct ImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationEl { # [serde (skip_serializing_if = "Option::is_none")] container_tags : Option < SetField < PrimField < String > > > , # [serde (skip_serializing_if = "Option::is_none")] description : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] target_repository : Option < Vec < ImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryEl > > , dynamic : ImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElDynamic , }
impl ImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationEl {
    ...
    pub fn set_target_repository(
        mut self,
        v : impl Into < BlockAssignable < ImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl ToListMappable
    for ImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationEl
{
    type O = BlockAssignable<
...
impl Ref
    for ImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElRef
{
    fn new(
        shared: StackShared,
        base: String,
...
impl ImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElRef {
    ...
    #[doc = "Get a reference to the value of field `target_repository` after provisioning.\n"]    pub fn target_repository (& self) -> ListRef < ImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryElRef >{
        ListRef::new(
            self.shared().clone(),
...
impl ToListMappable
    for ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateEl
{
    type O = BlockAssignable < ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateEl > ;
    fn do_map(self, base: String) -> Self::O {
        BlockAssignable::Dynamic(DynamicBlock {
            for_each: format!("${{{}}}", base),
            iterator: "each".into(),
    ...
    ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateElRef
{
    ...
    pub fn launch_template_version(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.launch_template_version", self.base),
        )
    }
}
#[derive(Serialize)]
...
impl ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationEl { # [doc = "Set the field `target_resource_count`.\n"] pub fn set_target_resource_count (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . target_resource_count = Some (v . into ()) ; self } }
impl ToListMappable for ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationEl { type O = BlockAssignable < ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationEl
{}
impl BuildImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationEl { pub fn build (self) -> ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationEl { ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationEl { target_resource_count : core :: default :: Default :: default () , } } }
pub struct ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationElRef { fn new (shared : StackShared , base : String) -> ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationElRef { ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `target_resource_count` after provisioning.\n"] pub fn target_resource_count (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.target_resource_count" , self . base)) } }
#[derive(Serialize, Default)]
struct ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElDynamic { launch_template : Option < DynamicBlock < ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateEl >> , snapshot_configuration : Option < DynamicBlock < ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationEl >> , }
#[derive(Serialize)]
pub struct ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationEl { account_id : PrimField < String > , enabled : PrimField < bool > , # [serde (skip_serializing_if = "Option::is_none")] max_parallel_launches : Option < PrimField < f64 > > , # [serde (skip_serializing_if = "Option::is_none")] launch_template : Option < Vec < ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateEl > > , # [serde (skip_serializing_if = "Option::is_none")] snapshot_configuration : Option < Vec < ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationEl > > , dynamic : ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElDynamic , }
impl ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationEl {
    ...
    pub fn set_launch_template(
        mut self,
        v : impl Into < BlockAssignable < ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_snapshot_configuration(
        mut self,
        v : impl Into < BlockAssignable < ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl ToListMappable
    for ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationEl
{
    type O = BlockAssignable<
...
impl ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElRef {
    ...
    #[doc = "Get a reference to the value of field `launch_template` after provisioning.\n"]    pub fn launch_template (& self) -> ListRef < ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.launch_template", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `snapshot_configuration` after provisioning.\n"]    pub fn snapshot_configuration (& self) -> ListRef < ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationElRef >{
        ListRef::new(
            self.shared().clone(),
...
impl ToListMappable
    for ImagebuilderDistributionConfigurationDistributionElLaunchTemplateConfigurationEl
{
    type O = BlockAssignable<
...
#[derive(Serialize)]
pub struct ImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationEl {
    disk_image_format: PrimField<String>,
    role_name: PrimField<String>,
    s3_bucket: PrimField<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    s3_prefix: Option<PrimField<String>>,
}
impl ImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationEl {
...
impl ToListMappable for ImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationEl {
    type O =
        BlockAssignable<ImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationEl>;
    fn do_map(self, base: String) -> Self::O {
        BlockAssignable::Dynamic(DynamicBlock {
            for_each: format!("${{{}}}", base),
            iterator: "each".into(),
...
pub struct BuildImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationEl {
    #[doc = ""]
    pub disk_image_format: PrimField<String>,
    #[doc = ""]
    pub role_name: PrimField<String>,
    #[doc = ""]
    pub s3_bucket: PrimField<String>,
}
impl BuildImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationEl {
    pub fn build(
        self,
    ) -> ImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationEl {
        ImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationEl {
...
pub struct ImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationElRef {
    shared: StackShared,
    base: String,
}
impl Ref for ImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationElRef {
    fn new(
        shared: StackShared,
        base: String,
    ) -> ImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationElRef {
        ImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationElRef {
            shared: shared,
            base: base.to_string(),
        }
...
impl ImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize)]
pub struct ImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl ImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationEl {
...
impl ToListMappable
    for ImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationEl
{
    type O = BlockAssignable<
        ImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationEl,
    >;
    fn do_map(self, base: String) -> Self::O {
        BlockAssignable::Dynamic(DynamicBlock {
            for_each: format!("${{{}}}", base),
...
pub struct BuildImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationEl {
    #[doc = ""]
    pub parameter_name: PrimField<String>,
}
impl BuildImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationEl {
    pub fn build(
        self,
    ) -> ImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationEl {
        ImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationEl {
...
pub struct ImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationElRef {
    shared: StackShared,
    base: String,
}
impl Ref for ImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationElRef {
    fn new(
        shared: StackShared,
        base: String,
    ) -> ImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationElRef {
        ImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationElRef {
            shared: shared,
            base: base.to_string(),
        }
...
impl ImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
struct ImagebuilderDistributionConfigurationDistributionElDynamic {
    ...
    launch_template_configuration: Option<
        ...
        >,
    >,
    s3_export_configuration: Option<
        DynamicBlock<ImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationEl>,
    >,
    ssm_parameter_configuration: Option<
        DynamicBlock<
            ImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationEl,
        >,
    >,
...
pub struct ImagebuilderDistributionConfigurationDistributionEl {
    ...
    fast_launch_configuration:
        Option<Vec<ImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    launch_template_configuration: Option<
    ...
    s3_export_configuration:
        Option<Vec<ImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ssm_parameter_configuration:
        Option<Vec<ImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationEl>>,
...
impl ImagebuilderDistributionConfigurationDistributionEl {
    ...
    pub fn set_container_distribution_configuration(
        mut self,
        v : impl Into < BlockAssignable < ImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_s3_export_configuration(
        ...
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.s3_export_configuration = Some(v);
            }
            BlockAssignable::Dynamic(d) => {
                self.dynamic.s3_export_configuration = Some(d);
            }
        }
        self
    }
    ...
    pub fn set_ssm_parameter_configuration(
        ...
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.ssm_parameter_configuration = Some(v);
            }
            BlockAssignable::Dynamic(d) => {
                self.dynamic.ssm_parameter_configuration = Some(d);
            }
        }
        self
    }
...
impl ImagebuilderDistributionConfigurationDistributionElRef {
    ...
    pub fn s3_export_configuration(
        &self,
    ) -> ListRef<ImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationElRef>
    {
        ListRef::new(
            self.shared().clone(),
