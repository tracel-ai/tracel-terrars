...
impl AppconfigExtension {
    ...
    pub fn set_action_point(
        self,
        v: impl Into<BlockAssignable<AppconfigExtensionActionPointEl>>,
    ) -> Self {
        match v.into() {
    ...
    pub fn set_parameter(
        self,
        v: impl Into<BlockAssignable<AppconfigExtensionParameterEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl AppconfigExtensionActionPointEl {
    ...
    pub fn set_action(
        mut self,
        v: impl Into<BlockAssignable<AppconfigExtensionActionPointElActionEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.action = Some(v);
