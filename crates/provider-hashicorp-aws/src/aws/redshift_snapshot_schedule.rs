...
use terrars::*;
#[derive(Serialize)]
struct RedshiftSnapshotScheduleData {
    ...
    definitions: SetField<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
struct RedshiftSnapshotSchedule_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<RedshiftSnapshotScheduleData>,
}
#[derive(Clone)]
pub struct RedshiftSnapshotSchedule(Rc<RedshiftSnapshotSchedule_>);
impl RedshiftSnapshotSchedule {
    ...
    #[doc = "Get a reference to the value of field `definitions` after provisioning.\n"]
    pub fn definitions(&self) -> SetRef<PrimExpr<String>> {
        SetRef::new(
            self.shared().clone(),
            format!("{}.definitions", self.extract_ref()),
        )
    }
...
impl Referable for RedshiftSnapshotSchedule {
...
impl Resource for RedshiftSnapshotSchedule {}
impl ToListMappable for RedshiftSnapshotSchedule {
    type O = ListRef<RedshiftSnapshotScheduleRef>;
    fn do_map(self, base: String) -> Self::O {
        self.0.data.borrow_mut().for_each = Some(format!("${{{}}}", base));
        ListRef::new(self.0.shared.clone(), self.extract_ref())
    }
}
impl Resource_ for RedshiftSnapshotSchedule_ {
    fn extract_resource_type(&self) -> String {
        "aws_redshift_snapshot_schedule".into()
    }
...
pub struct BuildRedshiftSnapshotSchedule {
    pub tf_id: String,
    #[doc = ""]
    pub definitions: SetField<PrimField<String>>,
}
impl BuildRedshiftSnapshotSchedule {
    pub fn build(self, stack: &mut Stack) -> RedshiftSnapshotSchedule {
        let out = RedshiftSnapshotSchedule(Rc::new(RedshiftSnapshotSchedule_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(RedshiftSnapshotScheduleData {
...
pub struct RedshiftSnapshotScheduleRef {
    shared: StackShared,
    base: String,
}
impl Ref for RedshiftSnapshotScheduleRef {
    fn new(shared: StackShared, base: String) -> Self {
        Self { shared, base }
    }
}
impl RedshiftSnapshotScheduleRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
    fn shared(&self) -> &StackShared {
