...
impl GlueDataQualityRuleset {
    ...
    pub fn set_target_table(self, v: impl Into<BlockAssignable<GlueDataQualityRulesetTargetTableEl>>) -> Self {
        match v.into() {
    ...
    pub fn last_modified_on(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.last_modified_on", self.extract_ref()))
    }
    ...
    pub fn recommendation_run_id(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.recommendation_run_id", self.extract_ref()))
    }
    ...
    pub fn ruleset(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.ruleset", self.extract_ref()))
    }
...
impl BuildGlueDataQualityRuleset {
    pub fn build(self, stack: &mut Stack) -> GlueDataQualityRuleset {
        let out = GlueDataQualityRuleset(Rc::new(GlueDataQualityRuleset_ {
            ...
            tf_id: self.tf_id,
            data: RefCell::new(GlueDataQualityRulesetData {
