...
struct ConnectPhoneNumberContactFlowAssociationData {
    ...
    phone_number_id: PrimField<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl ConnectPhoneNumberContactFlowAssociation {
    ...
    pub fn phone_number_id(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.phone_number_id", self.extract_ref()))
    }
...
impl BuildConnectPhoneNumberContactFlowAssociation {
    pub fn build(self, stack: &mut Stack) -> ConnectPhoneNumberContactFlowAssociation {
        let out = ConnectPhoneNumberContactFlowAssociation(Rc::new(ConnectPhoneNumberContactFlowAssociation_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(ConnectPhoneNumberContactFlowAssociationData {
