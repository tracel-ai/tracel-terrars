...
impl DataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationElLaunchPermissionEl { # [doc = "Set the field `organization_arns`.\n"] pub fn set_organization_arns (mut self , v : impl Into < SetField < PrimField < String > > >) -> Self { self . organization_arns = Some (v . into ()) ; self } # [doc = "Set the field `organizational_unit_arns`.\n"] pub fn set_organizational_unit_arns (mut self , v : impl Into < SetField < PrimField < String > > >) -> Self { self . organizational_unit_arns = Some (v . into ()) ; self } # [doc = "Set the field `user_groups`.\n"] pub fn set_user_groups (mut self , v : impl Into < SetField < PrimField < String > > >) -> Self { self . user_groups = Some (v . into ()) ; self } # [doc = "Set the field `user_ids`.\n"] pub fn set_user_ids (mut self , v : impl Into < SetField < PrimField < String > > >) -> Self { self . user_ids = Some (v . into ()) ; self } }
impl ToListMappable for DataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationElLaunchPermissionEl { type O = BlockAssignable < DataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationElLaunchPermissionEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildDataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationElLaunchPermissionEl
{}
impl BuildDataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationElLaunchPermissionEl { pub fn build (self) -> DataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationElLaunchPermissionEl { DataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationElLaunchPermissionEl { organization_arns : core :: default :: Default :: default () , organizational_unit_arns : core :: default :: Default :: default () , user_groups : core :: default :: Default :: default () , user_ids : core :: default :: Default :: default () , } } }
pub struct DataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationElLaunchPermissionElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for DataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationElLaunchPermissionElRef { fn new (shared : StackShared , base : String) -> DataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationElLaunchPermissionElRef { DataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationElLaunchPermissionElRef { shared : shared , base : base . to_string () , } } }
impl DataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationElLaunchPermissionElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `organization_arns` after provisioning.\n"] pub fn organization_arns (& self) -> SetRef < PrimExpr < String > > { SetRef :: new (self . shared () . clone () , format ! ("{}.organization_arns" , self . base)) } # [doc = "Get a reference to the value of field `organizational_unit_arns` after provisioning.\n"] pub fn organizational_unit_arns (& self) -> SetRef < PrimExpr < String > > { SetRef :: new (self . shared () . clone () , format ! ("{}.organizational_unit_arns" , self . base)) } # [doc = "Get a reference to the value of field `user_groups` after provisioning.\n"] pub fn user_groups (& self) -> SetRef < PrimExpr < String > > { SetRef :: new (self . shared () . clone () , format ! ("{}.user_groups" , self . base)) } # [doc = "Get a reference to the value of field `user_ids` after provisioning.\n"] pub fn user_ids (& self) -> SetRef < PrimExpr < String > > { SetRef :: new (self . shared () . clone () , format ! ("{}.user_ids" , self . base)) } }
#[derive(Serialize)]
pub struct DataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationEl { # [serde (skip_serializing_if = "Option::is_none")] ami_tags : Option < RecField < PrimField < String > > > , # [serde (skip_serializing_if = "Option::is_none")] description : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] kms_key_id : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] launch_permission : Option < SetField < DataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationElLaunchPermissionEl > > , # [serde (skip_serializing_if = "Option::is_none")] name : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] target_account_ids : Option < SetField < PrimField < String > > > , }
impl DataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationEl {
    ...
    pub fn set_launch_permission(
        mut self,
        v : impl Into < SetField < DataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationElLaunchPermissionEl > >,
    ) -> Self {
...
impl DataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationElRef {
    ...
    #[doc = "Get a reference to the value of field `launch_permission` after provisioning.\n"]    pub fn launch_permission (& self) -> SetRef < DataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationElLaunchPermissionElRef >{
        SetRef::new(
            self.shared().clone(),
...
impl DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryEl { # [doc = "Set the field `repository_name`.\n"] pub fn set_repository_name (mut self , v : impl Into < PrimField < String > >) -> Self { self . repository_name = Some (v . into ()) ; self } # [doc = "Set the field `service`.\n"] pub fn set_service (mut self , v : impl Into < PrimField < String > >) -> Self { self . service = Some (v . into ()) ; self } }
impl ToListMappable for DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryEl { type O = BlockAssignable < DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryElRef { fn new (shared : StackShared , base : String) -> DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryElRef { DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryElRef { shared : shared , base : base . to_string () , } } }
impl DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `repository_name` after provisioning.\n"] pub fn repository_name (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.repository_name" , self . base)) } # [doc = "Get a reference to the value of field `service` after provisioning.\n"] pub fn service (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.service" , self . base)) } }
#[derive(Serialize)]
pub struct DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationEl { # [serde (skip_serializing_if = "Option::is_none")] container_tags : Option < SetField < PrimField < String > > > , # [serde (skip_serializing_if = "Option::is_none")] description : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] target_repository : Option < SetField < DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryEl > > , }
impl DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationEl {
    ...
    pub fn set_target_repository(
        mut self,
        v : impl Into < SetField < DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryEl > >,
    ) -> Self {
    ...
    BuildDataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationEl
{
    ...
    {
        DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationEl { container_tags : core :: default :: Default :: default () , description : core :: default :: Default :: default () , target_repository : core :: default :: Default :: default () , }
    }
}
...
impl Ref for DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElRef { fn new (shared : StackShared , base : String) -> DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElRef { DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl
    DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElRef
{
    ...
    #[doc = "Get a reference to the value of field `target_repository` after provisioning.\n"]    pub fn target_repository (& self) -> SetRef < DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElTargetRepositoryElRef >{
        SetRef::new(
            self.shared().clone(),
...
impl ToListMappable for DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateEl { type O = BlockAssignable < DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildDataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateEl
{}
impl BuildDataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateEl { pub fn build (self) -> DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateEl { DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateEl { launch_template_id : core :: default :: Default :: default () , launch_template_name : core :: default :: Default :: default () , launch_template_version : core :: default :: Default :: default () , } } }
pub struct DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateElRef { fn new (shared : StackShared , base : String) -> DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateElRef { DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateElRef { shared : shared , base : base . to_string () , } } }
impl DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `launch_template_id` after provisioning.\n"] pub fn launch_template_id (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.launch_template_id" , self . base)) } # [doc = "Get a reference to the value of field `launch_template_name` after provisioning.\n"] pub fn launch_template_name (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.launch_template_name" , self . base)) } # [doc = "Get a reference to the value of field `launch_template_version` after provisioning.\n"] pub fn launch_template_version (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.launch_template_version" , self . base)) } }
#[derive(Serialize)]
...
impl DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationEl { # [doc = "Set the field `target_resource_count`.\n"] pub fn set_target_resource_count (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . target_resource_count = Some (v . into ()) ; self } }
impl ToListMappable for DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationEl { type O = BlockAssignable < DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildDataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationEl
{}
impl BuildDataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationEl { pub fn build (self) -> DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationEl { DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationEl { target_resource_count : core :: default :: Default :: default () , } } }
pub struct DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationElRef { fn new (shared : StackShared , base : String) -> DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationElRef { DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `target_resource_count` after provisioning.\n"] pub fn target_resource_count (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.target_resource_count" , self . base)) } }
#[derive(Serialize)]
pub struct DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationEl { # [serde (skip_serializing_if = "Option::is_none")] account_id : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] enabled : Option < PrimField < bool > > , # [serde (skip_serializing_if = "Option::is_none")] launch_template : Option < SetField < DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateEl > > , # [serde (skip_serializing_if = "Option::is_none")] max_parallel_launches : Option < PrimField < f64 > > , # [serde (skip_serializing_if = "Option::is_none")] snapshot_configuration : Option < SetField < DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationEl > > , }
impl DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationEl {
    ...
    pub fn set_launch_template(
        mut self,
        v : impl Into < SetField < DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateEl > >,
    ) -> Self {
    ...
    pub fn set_snapshot_configuration(
        mut self,
        v : impl Into < SetField < DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationEl > >,
    ) -> Self {
...
impl DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElRef {
    ...
    #[doc = "Get a reference to the value of field `launch_template` after provisioning.\n"]    pub fn launch_template (& self) -> SetRef < DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElLaunchTemplateElRef >{
        SetRef::new(
            self.shared().clone(),
    ...
    #[doc = "Get a reference to the value of field `snapshot_configuration` after provisioning.\n"]    pub fn snapshot_configuration (& self) -> SetRef < DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationElSnapshotConfigurationElRef >{
        SetRef::new(
            self.shared().clone(),
...
#[derive(Serialize)]
pub struct DataImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    disk_image_format: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl DataImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationEl {
    #[doc = "Set the field `disk_image_format`.\n"]
    pub fn set_disk_image_format(mut self, v: impl Into<PrimField<String>>) -> Self {
        self.disk_image_format = Some(v.into());
        self
    }
...
pub struct DataImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationElRef {
    shared: StackShared,
    base: String,
}
impl Ref for DataImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationElRef {
    fn new(
        shared: StackShared,
        base: String,
    ) -> DataImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationElRef {
        DataImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationElRef {
            shared: shared,
            base: base.to_string(),
        }
...
impl DataImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize)]
pub struct DataImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    ami_account_id: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    data_type: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    parameter_name: Option<PrimField<String>>,
}
impl DataImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationEl {
    #[doc = "Set the field `ami_account_id`.\n"]
    pub fn set_ami_account_id(mut self, v: impl Into<PrimField<String>>) -> Self {
        self.ami_account_id = Some(v.into());
        self
    }
    ...
    #[doc = "Set the field `parameter_name`.\n"]
    pub fn set_parameter_name(mut self, v: impl Into<PrimField<String>>) -> Self {
        self.parameter_name = Some(v.into());
        self
    }
}
impl ToListMappable
...
impl BuildDataImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationEl {
    pub fn build(
        ...
        DataImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationEl {
            ...
            parameter_name: core::default::Default::default(),
        }
    }
}
pub struct DataImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationElRef {
    shared: StackShared,
    base: String,
}
impl Ref for DataImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationElRef {
    fn new(
        shared: StackShared,
        base: String,
    ) -> DataImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationElRef {
        DataImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationElRef {
            shared: shared,
            base: base.to_string(),
        }
...
impl DataImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize)]
pub struct DataImagebuilderDistributionConfigurationDistributionEl { # [serde (skip_serializing_if = "Option::is_none")] ami_distribution_configuration : Option < SetField < DataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationEl > > , # [serde (skip_serializing_if = "Option::is_none")] container_distribution_configuration : Option < SetField < DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationEl > > , # [serde (skip_serializing_if = "Option::is_none")] fast_launch_configuration : Option < SetField < DataImagebuilderDistributionConfigurationDistributionElFastLaunchConfigurationEl > > , # [serde (skip_serializing_if = "Option::is_none")] launch_template_configuration : Option < SetField < DataImagebuilderDistributionConfigurationDistributionElLaunchTemplateConfigurationEl > > , # [serde (skip_serializing_if = "Option::is_none")] license_configuration_arns : Option < SetField < PrimField < String > > > , # [serde (skip_serializing_if = "Option::is_none")] region : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] s3_export_configuration : Option < SetField < DataImagebuilderDistributionConfigurationDistributionElS3ExportConfigurationEl > > , # [serde (skip_serializing_if = "Option::is_none")] ssm_parameter_configuration : Option < SetField < DataImagebuilderDistributionConfigurationDistributionElSsmParameterConfigurationEl > > , }
impl DataImagebuilderDistributionConfigurationDistributionEl {
    ...
    pub fn set_ami_distribution_configuration(
        mut self,
        v : impl Into < SetField < DataImagebuilderDistributionConfigurationDistributionElAmiDistributionConfigurationEl > >,
    ) -> Self {
    ...
    pub fn set_container_distribution_configuration(
        mut self,
        v : impl Into < SetField < DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationEl > >,
    ) -> Self {
...
impl BuildDataImagebuilderDistributionConfigurationDistributionEl {
    pub fn build(self) -> DataImagebuilderDistributionConfigurationDistributionEl {
        DataImagebuilderDistributionConfigurationDistributionEl {
            ...
            region: core::default::Default::default(),
            s3_export_configuration: core::default::Default::default(),
            ssm_parameter_configuration: core::default::Default::default(),
        }
    }
}
...
impl DataImagebuilderDistributionConfigurationDistributionElRef {
    ...
    #[doc = "Get a reference to the value of field `container_distribution_configuration` after provisioning.\n"]    pub fn container_distribution_configuration (& self) -> SetRef < DataImagebuilderDistributionConfigurationDistributionElContainerDistributionConfigurationElRef >{
        SetRef::new(
            self.shared().clone(),
