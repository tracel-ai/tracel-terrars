...
impl FinspaceKxVolume {
    ...
    pub fn set_nas1_configuration(self, v: impl Into<BlockAssignable<FinspaceKxVolumeNas1ConfigurationEl>>) -> Self {
        match v.into() {
    ...
    pub fn attached_clusters(&self) -> ListRef<FinspaceKxVolumeAttachedClustersElRef> {
        ListRef::new(self.shared().clone(), format!("{}.attached_clusters", self.extract_ref()))
    }
    ...
    pub fn nas1_configuration(&self) -> ListRef<FinspaceKxVolumeNas1ConfigurationElRef> {
        ListRef::new(self.shared().clone(), format!("{}.nas1_configuration", self.extract_ref()))
    }

    #[doc = "Get a reference to the value of field `timeouts` after provisioning.\n"]
    pub fn timeouts(&self) -> FinspaceKxVolumeTimeoutsElRef {
        FinspaceKxVolumeTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
}
...
impl FinspaceKxVolumeAttachedClustersElRef {
    ...
    pub fn cluster_status(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.cluster_status", self.base))
    }
