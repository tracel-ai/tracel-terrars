...
impl BillingView {
    ...
    pub fn set_data_filter_expression(self, v: impl Into<BlockAssignable<BillingViewDataFilterExpressionEl>>) -> Self {
        match v.into() {
    ...
    pub fn billing_view_type(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.billing_view_type", self.extract_ref()))
    }
    ...
    pub fn derived_view_count(&self) -> PrimExpr<f64> {
        PrimExpr::new(self.shared().clone(), format!("{}.derived_view_count", self.extract_ref()))
    }
    ...
    pub fn source_account_id(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.source_account_id", self.extract_ref()))
    }

    #[doc = "Get a reference to the value of field `source_view_count` after provisioning.\n"]
    pub fn source_view_count(&self) -> PrimExpr<f64> {
        PrimExpr::new(self.shared().clone(), format!("{}.source_view_count", self.extract_ref()))
    }
    ...
    pub fn source_views(&self) -> ListRef<PrimExpr<String>> {
        ListRef::new(self.shared().clone(), format!("{}.source_views", self.extract_ref()))
    }
    ...
    pub fn view_definition_last_updated_at(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.view_definition_last_updated_at", self.extract_ref()))
    }
    ...
    pub fn data_filter_expression(&self) -> ListRef<BillingViewDataFilterExpressionElRef> {
        ListRef::new(self.shared().clone(), format!("{}.data_filter_expression", self.extract_ref()))
    }

    #[doc = "Get a reference to the value of field `timeouts` after provisioning.\n"]
    pub fn timeouts(&self) -> BillingViewTimeoutsElRef {
        BillingViewTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
}
...
impl BillingViewDataFilterExpressionElTimeRangeElRef {
    ...
    pub fn begin_date_inclusive(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.begin_date_inclusive", self.base))
    }
    ...
    pub fn end_date_inclusive(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.end_date_inclusive", self.base))
    }
}
...
impl BillingViewDataFilterExpressionEl {
    ...
    #[doc = "Set the field `tags`.\n"]
    pub fn set_tags(mut self, v: impl Into<BlockAssignable<BillingViewDataFilterExpressionElTagsEl>>) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.tags = Some(v);
            },
