...
struct Apigatewayv2Model_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<Apigatewayv2ModelData>,
}

#[derive(Clone)]
pub struct Apigatewayv2Model(Rc<Apigatewayv2Model_>);

impl Apigatewayv2Model {
...
impl Resource_ for Apigatewayv2Model_ {
    fn extract_resource_type(&self) -> String {
        "aws_apigatewayv2_model".into()
    }
...
pub struct BuildApigatewayv2Model {
    pub tf_id: String,
    #[doc = ""]
...
impl BuildApigatewayv2Model {
    pub fn build(self, stack: &mut Stack) -> Apigatewayv2Model {
        let out = Apigatewayv2Model(Rc::new(Apigatewayv2Model_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(Apigatewayv2ModelData {
...
pub struct Apigatewayv2ModelRef {
    shared: StackShared,
    base: String,
}

impl Ref for Apigatewayv2ModelRef {
    fn new(shared: StackShared, base: String) -> Self {
        Self { shared, base }
    }
}

impl Apigatewayv2ModelRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
