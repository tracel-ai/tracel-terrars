...
impl ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationElBackupConfigurationEl {
...
impl ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationElBackupConfigurationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
impl ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationElLogsEncryptionConfigurationEl {
    #[doc = "Set the field `encryption_conflict_resolution_strategy`.\n"]
    pub fn set_encryption_conflict_resolution_strategy(mut self, v: impl Into<PrimField<String>>) -> Self {
        self.encryption_conflict_resolution_strategy = Some(v.into());
        self
    }
...
impl BuildObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationElLogsEncryptionConfigurationEl {
    pub fn build(
        ...
        ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationElLogsEncryptionConfigurationEl {
            encryption_conflict_resolution_strategy: core::default::Default::default(),
            encryption_strategy: self.encryption_strategy,
            kms_key_arn: core::default::Default::default(),
        }
    }
}
...
impl ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationElLogsEncryptionConfigurationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }

    #[doc = "Get a reference to the value of field `encryption_conflict_resolution_strategy` after provisioning.\n"]
    pub fn encryption_conflict_resolution_strategy(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.encryption_conflict_resolution_strategy", self.base))
    }

    #[doc = "Get a reference to the value of field `encryption_strategy` after provisioning.\n"]
    pub fn encryption_strategy(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.encryption_strategy", self.base))
    }
...
struct ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationElDynamic {
    backup_configuration: Option<
        DynamicBlock<
            ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationElBackupConfigurationEl,
        >,
    >,
    logs_encryption_configuration: Option<
        DynamicBlock<
            ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationElLogsEncryptionConfigurationEl,
        >,
    >,
...
#[derive(Serialize)]
pub struct ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    backup_configuration: Option<
        Vec<
            ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationElBackupConfigurationEl,
...
impl ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationEl {
    ...
    #[doc = "Set the field `logs_encryption_configuration`.\n"]
    pub fn set_logs_encryption_configuration(
        mut self,
        v:
            impl
        ...
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.logs_encryption_configuration = Some(v);
            },
            BlockAssignable::Dynamic(d) => {
                self.dynamic.logs_encryption_configuration = Some(d);
            },
        }
        self
    }
...
impl ToListMappable for ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationEl {
    type O =
        BlockAssignable<
            ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationEl,
        >;
...
impl BuildObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationEl {
    pub fn build(
        ...
        ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationEl {
            ...
            logs_encryption_configuration: core::default::Default::default(),
            dynamic: Default::default(),
        }
    }
}
...
impl ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    ...
    #[doc = "Get a reference to the value of field `logs_encryption_configuration` after provisioning.\n"]
    pub fn logs_encryption_configuration(
        &self,
    ) -> ListRef<
        ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationElLogsEncryptionConfigurationElRef,
    > {
        ListRef::new(self.shared().clone(), format!("{}.logs_encryption_configuration", self.base))
    }
}

#[derive(Serialize, Default)]
struct ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDynamic {
    destination_logs_configuration: Option<
        DynamicBlock<
            ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationEl,
        >,
    >,
...
#[derive(Serialize)]
pub struct ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationEl {
    account: PrimField<String>,
    region: PrimField<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    destination_logs_configuration: Option<
        Vec<ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationEl>,
    >,
...
impl ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElRef {
    ...
    pub fn destination_logs_configuration(
        &self,
    ) -> ListRef<
        ObservabilityadminCentralizationRuleForOrganizationRuleElDestinationElDestinationLogsConfigurationElRef,
    > {
...
#[derive(Serialize, Default)]
struct ObservabilityadminCentralizationRuleForOrganizationRuleElSourceElDynamic {
    source_logs_configuration: Option<
        DynamicBlock<ObservabilityadminCentralizationRuleForOrganizationRuleElSourceElSourceLogsConfigurationEl>,
    >,
}

#[derive(Serialize)]
pub struct ObservabilityadminCentralizationRuleForOrganizationRuleElSourceEl {
    regions: SetField<PrimField<String>>,
    scope: PrimField<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    source_logs_configuration: Option<
        Vec<ObservabilityadminCentralizationRuleForOrganizationRuleElSourceElSourceLogsConfigurationEl>,
    >,
