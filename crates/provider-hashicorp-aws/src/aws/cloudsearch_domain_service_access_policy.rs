...
impl CloudsearchDomainServiceAccessPolicy {
    ...
    pub fn set_timeouts(
        self,
        v: impl Into<CloudsearchDomainServiceAccessPolicyTimeoutsEl>,
    ) -> Self {
...
impl Referable for CloudsearchDomainServiceAccessPolicy {
...
impl BuildCloudsearchDomainServiceAccessPolicy {
    pub fn build(self, stack: &mut Stack) -> CloudsearchDomainServiceAccessPolicy {
        let out =
            CloudsearchDomainServiceAccessPolicy(Rc::new(CloudsearchDomainServiceAccessPolicy_ {
