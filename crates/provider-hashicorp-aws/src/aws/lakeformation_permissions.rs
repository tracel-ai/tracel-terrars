...
impl LakeformationPermissions {
    ...
    pub fn set_permissions_with_grant_option(self, v: impl Into<SetField<PrimField<String>>>) -> Self {
    ...
    pub fn permissions_with_grant_option(&self) -> SetRef<PrimExpr<String>> {
        SetRef::new(self.shared().clone(), format!("{}.permissions_with_grant_option", self.extract_ref()))
    }
