...
impl DataEc2PublicIpv4Pool {
    ...
    pub fn pool_address_ranges(&self) -> ListRef<DataEc2PublicIpv4PoolPoolAddressRangesElRef> {
        ListRef::new(self.shared().clone(), format!("{}.pool_address_ranges", self.extract_ref()))
    }
    ...
    pub fn total_address_count(&self) -> PrimExpr<f64> {
        PrimExpr::new(self.shared().clone(), format!("{}.total_address_count", self.extract_ref()))
    }
    ...
    pub fn total_available_address_count(&self) -> PrimExpr<f64> {
        PrimExpr::new(self.shared().clone(), format!("{}.total_available_address_count", self.extract_ref()))
    }
}
...
impl DataEc2PublicIpv4PoolPoolAddressRangesElRef {
    ...
    pub fn address_count(&self) -> PrimExpr<f64> {
        PrimExpr::new(self.shared().clone(), format!("{}.address_count", self.base))
    }
    ...
    pub fn available_address_count(&self) -> PrimExpr<f64> {
        PrimExpr::new(self.shared().clone(), format!("{}.available_address_count", self.base))
    }
