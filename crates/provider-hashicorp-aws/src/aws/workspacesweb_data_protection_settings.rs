...
impl WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationElInlineRedactionPatternElCustomPatternEl {
    #[doc = "Set the field `keyword_regex`.\n"]
    pub fn set_keyword_regex(mut self, v: impl Into<PrimField<String>>) -> Self {
        self.keyword_regex = Some(v.into());
        self
    }

    #[doc = "Set the field `pattern_description`.\n"]
    pub fn set_pattern_description(mut self, v: impl Into<PrimField<String>>) -> Self {
        self.pattern_description = Some(v.into());
        self
    }
}
...
impl BuildWorkspaceswebDataProtectionSettingsInlineRedactionConfigurationElInlineRedactionPatternElCustomPatternEl {
    pub fn build(
        ...
        WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationElInlineRedactionPatternElCustomPatternEl {
            keyword_regex: core::default::Default::default(),
            pattern_description: core::default::Default::default(),
...
impl WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationElInlineRedactionPatternElCustomPatternElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }

    #[doc = "Get a reference to the value of field `keyword_regex` after provisioning.\n"]
    pub fn keyword_regex(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.keyword_regex", self.base))
    }

    #[doc = "Get a reference to the value of field `pattern_description` after provisioning.\n"]
    pub fn pattern_description(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.pattern_description", self.base))
    }

    #[doc = "Get a reference to the value of field `pattern_name` after provisioning.\n"]
    pub fn pattern_name(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.pattern_name", self.base))
    }

    #[doc = "Get a reference to the value of field `pattern_regex` after provisioning.\n"]
    pub fn pattern_regex(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.pattern_regex", self.base))
    }
}
...
impl WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationElInlineRedactionPatternElRedactionPlaceHolderEl {
    #[doc = "Set the field `redaction_place_holder_text`.\n"]
    pub fn set_redaction_place_holder_text(mut self, v: impl Into<PrimField<String>>) -> Self {
        self.redaction_place_holder_text = Some(v.into());
        self
    }
}
...
impl BuildWorkspaceswebDataProtectionSettingsInlineRedactionConfigurationElInlineRedactionPatternElRedactionPlaceHolderEl {
    pub fn build(
        ...
        WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationElInlineRedactionPatternElRedactionPlaceHolderEl {
            redaction_place_holder_text: core::default::Default::default(),
            redaction_place_holder_type: self.redaction_place_holder_type,
        }
    }
}
...
impl WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationElInlineRedactionPatternElRedactionPlaceHolderElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }

    #[doc = "Get a reference to the value of field `redaction_place_holder_text` after provisioning.\n"]
    pub fn redaction_place_holder_text(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.redaction_place_holder_text", self.base))
    }

    #[doc = "Get a reference to the value of field `redaction_place_holder_type` after provisioning.\n"]
    pub fn redaction_place_holder_type(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.redaction_place_holder_type", self.base))
    }
}

#[derive(Serialize, Default)]
struct WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationElInlineRedactionPatternElDynamic {
    custom_pattern: Option<
        DynamicBlock<
            WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationElInlineRedactionPatternElCustomPatternEl,
        >,
    >,
    redaction_place_holder: Option<
        DynamicBlock<
            WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationElInlineRedactionPatternElRedactionPlaceHolderEl,
        >,
    >,
...
#[derive(Serialize)]
pub struct WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationElInlineRedactionPatternEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    built_in_pattern_id: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    confidence_level: Option<PrimField<f64>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    enforced_urls: Option<ListField<PrimField<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    exempt_urls: Option<ListField<PrimField<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    custom_pattern: Option<
        Vec<WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationElInlineRedactionPatternElCustomPatternEl>,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    redaction_place_holder: Option<
        Vec<
...
#[derive(Serialize, Default)]
struct WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationElDynamic {
    inline_redaction_pattern: Option<
        DynamicBlock<WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationElInlineRedactionPatternEl>,
    >,
}

#[derive(Serialize)]
pub struct WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    global_confidence_level: Option<PrimField<f64>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    global_enforced_urls: Option<ListField<PrimField<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    global_exempt_urls: Option<ListField<PrimField<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    inline_redaction_pattern: Option<
        Vec<WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationElInlineRedactionPatternEl>,
    >,
    dynamic: WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationElDynamic,
}
