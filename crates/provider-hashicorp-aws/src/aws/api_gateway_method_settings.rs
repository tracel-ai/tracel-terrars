...
impl ApiGatewayMethodSettings {
    ...
    pub fn set_settings(
        self,
        v: impl Into<BlockAssignable<ApiGatewayMethodSettingsSettingsEl>>,
    ) -> Self {
        match v.into() {
    ...
    pub fn method_path(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.method_path", self.extract_ref()),
        )
    }
...
impl ApiGatewayMethodSettingsSettingsElRef {
    ...
    pub fn cache_data_encrypted(&self) -> PrimExpr<bool> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.cache_data_encrypted", self.base),
        )
    }
    ...
    pub fn cache_ttl_in_seconds(&self) -> PrimExpr<f64> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.cache_ttl_in_seconds", self.base),
        )
    }
    ...
    pub fn caching_enabled(&self) -> PrimExpr<bool> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.caching_enabled", self.base),
        )
    }
    ...
    pub fn metrics_enabled(&self) -> PrimExpr<bool> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.metrics_enabled", self.base),
        )
    }
    ...
    pub fn require_authorization_for_cache_control(&self) -> PrimExpr<bool> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.require_authorization_for_cache_control", self.base),
        )
    }
    ...
    pub fn throttling_rate_limit(&self) -> PrimExpr<f64> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.throttling_rate_limit", self.base),
        )
    }
    ...
    pub fn unauthorized_cache_control_header_strategy(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.unauthorized_cache_control_header_strategy", self.base),
        )
    }
}
