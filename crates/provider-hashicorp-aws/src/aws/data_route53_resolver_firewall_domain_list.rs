...
impl DataRoute53ResolverFirewallDomainList {
    ...
    pub fn domain_count(&self) -> PrimExpr<f64> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.domain_count", self.extract_ref()),
        )
    }
...
impl Referable for DataRoute53ResolverFirewallDomainList {
...
impl BuildDataRoute53ResolverFirewallDomainList {
    pub fn build(self, stack: &mut Stack) -> DataRoute53ResolverFirewallDomainList {
        let out = DataRoute53ResolverFirewallDomainList(Rc::new(
            DataRoute53ResolverFirewallDomainList_ {
