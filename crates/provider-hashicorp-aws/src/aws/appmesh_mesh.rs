...
impl BuildAppmeshMeshSpecElServiceDiscoveryEl {
    pub fn build(self) -> AppmeshMeshSpecElServiceDiscoveryEl {
        AppmeshMeshSpecElServiceDiscoveryEl { ip_preference: core::default::Default::default() }
    }
}
...
impl AppmeshMeshSpecEl {
    ...
    pub fn set_service_discovery(mut self, v: impl Into<BlockAssignable<AppmeshMeshSpecElServiceDiscoveryEl>>) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
