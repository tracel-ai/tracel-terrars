...
impl WorkspacesConnectionAlias {
    ...
    #[doc =
        "Get a reference to the value of field `connection_string` after provisioning.\nThe connection string specified for the connection alias. The connection string must be in the form of a fully qualified domain name (FQDN), such as www.example.com."]
    pub fn connection_string(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.connection_string", self.extract_ref()))
    }
    ...
    #[doc =
        "Get a reference to the value of field `owner_account_id` after provisioning.\nThe identifier of the Amazon Web Services account that owns the connection alias."]
    ...
    #[doc =
        "Get a reference to the value of field `state` after provisioning.\nThe current state of the connection alias."]
...
impl BuildWorkspacesConnectionAlias {
    pub fn build(self, stack: &mut Stack) -> WorkspacesConnectionAlias {
        let out = WorkspacesConnectionAlias(Rc::new(WorkspacesConnectionAlias_ {
            ...
            tf_id: self.tf_id,
            data: RefCell::new(WorkspacesConnectionAliasData {
