...
struct WorkspaceswebDataProtectionSettingsAssociationData {
    ...
    data_protection_settings_arn: PrimField<String>,
    portal_arn: PrimField<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    region: Option<PrimField<String>>,
}
struct WorkspaceswebDataProtectionSettingsAssociation_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<WorkspaceswebDataProtectionSettingsAssociationData>,
}
#[derive(Clone)]
...
impl Resource_ for WorkspaceswebDataProtectionSettingsAssociation_ {
    fn extract_resource_type(&self) -> String {
        "aws_workspacesweb_data_protection_settings_association".into()
    }
...
pub struct BuildWorkspaceswebDataProtectionSettingsAssociation {
    pub tf_id: String,
    #[doc = ""]
    pub data_protection_settings_arn: PrimField<String>,
    #[doc = ""]
...
pub struct WorkspaceswebDataProtectionSettingsAssociationRef {
    shared: StackShared,
    base: String,
}
...
impl WorkspaceswebDataProtectionSettingsAssociationRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
    fn shared(&self) -> &StackShared {
