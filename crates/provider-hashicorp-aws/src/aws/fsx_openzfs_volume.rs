...
struct FsxOpenzfsVolumeData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    delete_volume_options: Option<ListField<PrimField<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl FsxOpenzfsVolume {
    ...
    pub fn set_nfs_exports(
        self,
        v: impl Into<BlockAssignable<FsxOpenzfsVolumeNfsExportsEl>>,
    ) -> Self {
        match v.into() {
    ...
    pub fn set_origin_snapshot(
        self,
        v: impl Into<BlockAssignable<FsxOpenzfsVolumeOriginSnapshotEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_user_and_group_quotas(
        self,
        v: impl Into<BlockAssignable<FsxOpenzfsVolumeUserAndGroupQuotasEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn build(self, stack: &mut Stack) -> FsxOpenzfsVolume {
        let out = FsxOpenzfsVolume(Rc::new(FsxOpenzfsVolume_ {
            ...
            data: RefCell::new(FsxOpenzfsVolumeData {
                ...
                delete_volume_options: core::default::Default::default(),
