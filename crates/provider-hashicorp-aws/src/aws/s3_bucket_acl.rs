...
impl S3BucketAcl {
    ...
    pub fn set_access_control_policy(
        self,
        v: impl Into<BlockAssignable<S3BucketAclAccessControlPolicyEl>>,
    ) -> Self {
        match v.into() {
    ...
    pub fn access_control_policy(&self) -> ListRef<S3BucketAclAccessControlPolicyElRef> {
        ListRef::new(
            self.shared().clone(),
            format!("{}.access_control_policy", self.extract_ref()),
        )
    }
}
...
impl S3BucketAclAccessControlPolicyEl {
    ...
    pub fn set_grant(
        mut self,
        v: impl Into<BlockAssignable<S3BucketAclAccessControlPolicyElGrantEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.grant = Some(v);
    ...
    pub fn set_owner(
        mut self,
        v: impl Into<BlockAssignable<S3BucketAclAccessControlPolicyElOwnerEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.owner = Some(v);
