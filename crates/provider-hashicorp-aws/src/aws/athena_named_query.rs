...
struct AthenaNamedQuery_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<AthenaNamedQueryData>,
}
#[derive(Clone)]
pub struct AthenaNamedQuery(Rc<AthenaNamedQuery_>);
...
impl Referable for AthenaNamedQuery {
...
impl ToListMappable for AthenaNamedQuery {
    type O = ListRef<AthenaNamedQueryRef>;
    fn do_map(self, base: String) -> Self::O {
        self.0.data.borrow_mut().for_each = Some(format!("${{{}}}", base));
        ListRef::new(self.0.shared.clone(), self.extract_ref())
    }
}
impl Resource_ for AthenaNamedQuery_ {
...
pub struct BuildAthenaNamedQuery {
    pub tf_id: String,
    #[doc = ""]
...
impl BuildAthenaNamedQuery {
    pub fn build(self, stack: &mut Stack) -> AthenaNamedQuery {
        let out = AthenaNamedQuery(Rc::new(AthenaNamedQuery_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(AthenaNamedQueryData {
...
pub struct AthenaNamedQueryRef {
    shared: StackShared,
    base: String,
}
impl Ref for AthenaNamedQueryRef {
    fn new(shared: StackShared, base: String) -> Self {
        Self { shared, base }
    }
}
impl AthenaNamedQueryRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
    fn shared(&self) -> &StackShared {
