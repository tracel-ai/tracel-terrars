...
struct GlacierVaultData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    access_policy: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl GlacierVault {
    ...
    pub fn set_notification(self, v: impl Into<BlockAssignable<GlacierVaultNotificationEl>>) -> Self {
        match v.into() {
    ...
    pub fn notification(&self) -> ListRef<GlacierVaultNotificationElRef> {
        ListRef::new(self.shared().clone(), format!("{}.notification", self.extract_ref()))
    }
}
...
impl BuildGlacierVault {
    pub fn build(self, stack: &mut Stack) -> GlacierVault {
        let out = GlacierVault(Rc::new(GlacierVault_ {
            ...
            tf_id: self.tf_id,
            data: RefCell::new(GlacierVaultData {
                depends_on: core::default::Default::default(),
                provider: None,
                lifecycle: core::default::Default::default(),
                for_each: None,
                access_policy: core::default::Default::default(),
