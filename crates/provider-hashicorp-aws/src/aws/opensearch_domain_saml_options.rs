...
impl OpensearchDomainSamlOptions {
    ...
    pub fn set_saml_options(
        self,
        v: impl Into<BlockAssignable<OpensearchDomainSamlOptionsSamlOptionsEl>>,
    ) -> Self {
        match v.into() {
...
impl Referable for OpensearchDomainSamlOptions {
...
impl OpensearchDomainSamlOptionsSamlOptionsEl {
    ...
    pub fn set_idp(
        mut self,
        v: impl Into<BlockAssignable<OpensearchDomainSamlOptionsSamlOptionsElIdpEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.idp = Some(v);
