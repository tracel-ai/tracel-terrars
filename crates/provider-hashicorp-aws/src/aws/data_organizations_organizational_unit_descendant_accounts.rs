...
impl DataOrganizationsOrganizationalUnitDescendantAccounts {
    ...
    pub fn accounts(
        &self,
    ) -> ListRef<DataOrganizationsOrganizationalUnitDescendantAccountsAccountsElRef> {
        ListRef::new(
            self.shared().clone(),
...
impl BuildDataOrganizationsOrganizationalUnitDescendantAccounts {
    pub fn build(self, stack: &mut Stack) -> DataOrganizationsOrganizationalUnitDescendantAccounts {
        let out = DataOrganizationsOrganizationalUnitDescendantAccounts(Rc::new(
            DataOrganizationsOrganizationalUnitDescendantAccounts_ {
