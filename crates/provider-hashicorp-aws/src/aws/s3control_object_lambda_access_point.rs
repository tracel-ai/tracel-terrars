...
impl S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElAwsLambdaEl { # [doc = "Set the field `function_payload`.\n"] pub fn set_function_payload (mut self , v : impl Into < PrimField < String > >) -> Self { self . function_payload = Some (v . into ()) ; self } }
impl ToListMappable for S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElAwsLambdaEl { type O = BlockAssignable < S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElAwsLambdaEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl BuildS3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElAwsLambdaEl { pub fn build (self) -> S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElAwsLambdaEl { S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElAwsLambdaEl { function_arn : self . function_arn , function_payload : core :: default :: Default :: default () , } } }
...
impl Ref for S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElAwsLambdaElRef { fn new (shared : StackShared , base : String) -> S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElAwsLambdaElRef { S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElAwsLambdaElRef { shared : shared , base : base . to_string () , } } }
impl S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElAwsLambdaElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `function_arn` after provisioning.\n"] pub fn function_arn (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.function_arn" , self . base)) } # [doc = "Get a reference to the value of field `function_payload` after provisioning.\n"] pub fn function_payload (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.function_payload" , self . base)) } }
#[derive(Serialize, Default)]
struct S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElDynamic { aws_lambda : Option < DynamicBlock < S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElAwsLambdaEl >> , }
#[derive(Serialize)]
pub struct S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationEl { # [serde (skip_serializing_if = "Option::is_none")] aws_lambda : Option < Vec < S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElAwsLambdaEl > > , dynamic : S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElDynamic , }
impl S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationEl { # [doc = "Set the field `aws_lambda`.\n"] pub fn set_aws_lambda (mut self , v : impl Into < BlockAssignable < S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElAwsLambdaEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . aws_lambda = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . aws_lambda = Some (d) ; } } self } }
impl ToListMappable for S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationEl { type O = BlockAssignable < S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildS3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationEl
{}
impl BuildS3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationEl { pub fn build (self) -> S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationEl { S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationEl { aws_lambda : core :: default :: Default :: default () , dynamic : Default :: default () , } } }
pub struct S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElRef { fn new (shared : StackShared , base : String) -> S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElRef { S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElRef { shared : shared , base : base . to_string () , } } }
impl S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `aws_lambda` after provisioning.\n"] pub fn aws_lambda (& self) -> ListRef < S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElAwsLambdaElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.aws_lambda" , self . base)) } }
#[derive(Serialize, Default)]
struct S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElDynamic { content_transformation : Option < DynamicBlock < S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationEl >> , }
#[derive(Serialize)]
pub struct S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationEl { actions : SetField < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] content_transformation : Option < Vec < S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationEl > > , dynamic : S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElDynamic , }
impl S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationEl {
    ...
    pub fn set_content_transformation(
        mut self,
        v : impl Into < BlockAssignable < S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElRef {
    ...
    #[doc = "Get a reference to the value of field `content_transformation` after provisioning.\n"]    pub fn content_transformation (& self) -> ListRef < S3controlObjectLambdaAccessPointConfigurationElTransformationConfigurationElContentTransformationElRef >{
        ListRef::new(
            self.shared().clone(),
