...
struct GlueDataCatalogEncryptionSettingsData {
    ...
    data_catalog_encryption_settings:
        Option<Vec<GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsEl>>,
        ...
        match v.into() {
            ...
            BlockAssignable::Dynamic(d) => {
                self.0
                    ...
                    .borrow_mut()
                    .dynamic
                    .data_catalog_encryption_settings = Some(d);
            }
        }
        self
    }
...
impl Referable for GlueDataCatalogEncryptionSettings {
...
impl ToListMappable for GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsElConnectionPasswordEncryptionEl { type O = BlockAssignable < GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsElConnectionPasswordEncryptionEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
pub struct GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsElEncryptionAtRestEl {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    catalog_encryption_service_role: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl ToListMappable
    for GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsElEncryptionAtRestEl
{
...
impl BuildGlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsElEncryptionAtRestEl {
    pub fn build(
        ...
        GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsElEncryptionAtRestEl {
            ...
            catalog_encryption_service_role: core::default::Default::default(),
...
impl GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsElEncryptionAtRestElRef {
    ...
    pub fn sse_aws_kms_key_id(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.sse_aws_kms_key_id", self.base),
        )
    }
}
#[derive(Serialize, Default)]
struct GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsElDynamic { connection_password_encryption : Option < DynamicBlock < GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsElConnectionPasswordEncryptionEl >> , encryption_at_rest : Option < DynamicBlock < GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsElEncryptionAtRestEl >> , }
#[derive(Serialize)]
pub struct GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsEl { # [serde (skip_serializing_if = "Option::is_none")] connection_password_encryption : Option < Vec < GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsElConnectionPasswordEncryptionEl > > , # [serde (skip_serializing_if = "Option::is_none")] encryption_at_rest : Option < Vec < GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsElEncryptionAtRestEl > > , dynamic : GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsElDynamic , }
impl GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsEl {
    ...
    pub fn set_connection_password_encryption(
        mut self,
        v : impl Into < BlockAssignable < GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsElConnectionPasswordEncryptionEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsElRef {
    ...
    #[doc = "Get a reference to the value of field `connection_password_encryption` after provisioning.\n"]    pub fn connection_password_encryption (& self) -> ListRef < GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsElConnectionPasswordEncryptionElRef >{
        ListRef::new(
            self.shared().clone(),
    ...
    > {
        ListRef::new(
            self.shared().clone(),
            format!("{}.encryption_at_rest", self.base),
        )
    }
}
#[derive(Serialize, Default)]
struct GlueDataCatalogEncryptionSettingsDynamic {
    data_catalog_encryption_settings:
        Option<DynamicBlock<GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsEl>>,
}
