...
impl FmsResourceSet {
    ...
    pub fn set_resource_set(
        self,
        v: impl Into<BlockAssignable<FmsResourceSetResourceSetEl>>,
    ) -> Self {
        match v.into() {
    ...
    pub fn resource_set(&self) -> ListRef<FmsResourceSetResourceSetElRef> {
        ListRef::new(
            self.shared().clone(),
            format!("{}.resource_set", self.extract_ref()),
        )
    }

    #[doc = "Get a reference to the value of field `timeouts` after provisioning.\n"]
    pub fn timeouts(&self) -> FmsResourceSetTimeoutsElRef {
        FmsResourceSetTimeoutsElRef::new(
            self.shared().clone(),
...
impl FmsResourceSetResourceSetElRef {
    ...
    pub fn last_update_time(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.last_update_time", self.base),
        )
    }
    ...
    pub fn resource_set_status(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.resource_set_status", self.base),
        )
    }
    ...
    pub fn resource_type_list(&self) -> ListRef<PrimExpr<String>> {
        ListRef::new(
            self.shared().clone(),
            format!("{}.resource_type_list", self.base),
        )
    }
