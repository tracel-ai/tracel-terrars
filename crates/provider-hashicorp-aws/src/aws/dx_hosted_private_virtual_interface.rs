...
use terrars::*;
#[derive(Serialize)]
struct DxHostedPrivateVirtualInterfaceData {
    ...
    vlan: PrimField<f64>,
    #[serde(skip_serializing_if = "Option::is_none")]
    timeouts: Option<DxHostedPrivateVirtualInterfaceTimeoutsEl>,
}
struct DxHostedPrivateVirtualInterface_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<DxHostedPrivateVirtualInterfaceData>,
}
#[derive(Clone)]
pub struct DxHostedPrivateVirtualInterface(Rc<DxHostedPrivateVirtualInterface_>);
impl DxHostedPrivateVirtualInterface {
    ...
    pub fn set_timeouts(self, v: impl Into<DxHostedPrivateVirtualInterfaceTimeoutsEl>) -> Self {
    ...
    pub fn timeouts(&self) -> DxHostedPrivateVirtualInterfaceTimeoutsElRef {
        DxHostedPrivateVirtualInterfaceTimeoutsElRef::new(
            self.shared().clone(),
            format!("{}.timeouts", self.extract_ref()),
        )
    }
}
impl Referable for DxHostedPrivateVirtualInterface {
...
impl Resource for DxHostedPrivateVirtualInterface {}
impl ToListMappable for DxHostedPrivateVirtualInterface {
    type O = ListRef<DxHostedPrivateVirtualInterfaceRef>;
    fn do_map(self, base: String) -> Self::O {
        self.0.data.borrow_mut().for_each = Some(format!("${{{}}}", base));
        ListRef::new(self.0.shared.clone(), self.extract_ref())
    }
}
impl Resource_ for DxHostedPrivateVirtualInterface_ {
    fn extract_resource_type(&self) -> String {
        "aws_dx_hosted_private_virtual_interface".into()
    }
...
pub struct BuildDxHostedPrivateVirtualInterface {
    pub tf_id: String,
    #[doc = ""]
...
impl BuildDxHostedPrivateVirtualInterface {
    pub fn build(self, stack: &mut Stack) -> DxHostedPrivateVirtualInterface {
        let out = DxHostedPrivateVirtualInterface(Rc::new(DxHostedPrivateVirtualInterface_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(DxHostedPrivateVirtualInterfaceData {
...
pub struct DxHostedPrivateVirtualInterfaceRef {
    shared: StackShared,
    base: String,
}
impl Ref for DxHostedPrivateVirtualInterfaceRef {
    fn new(shared: StackShared, base: String) -> Self {
        Self { shared, base }
    }
}
impl DxHostedPrivateVirtualInterfaceRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
    fn shared(&self) -> &StackShared {
...
#[derive(Serialize)]
pub struct DxHostedPrivateVirtualInterfaceTimeoutsEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    create: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    delete: Option<PrimField<String>>,
}
impl DxHostedPrivateVirtualInterfaceTimeoutsEl {
...
impl ToListMappable for DxHostedPrivateVirtualInterfaceTimeoutsEl {
    type O = BlockAssignable<DxHostedPrivateVirtualInterfaceTimeoutsEl>;
    fn do_map(self, base: String) -> Self::O {
...
pub struct BuildDxHostedPrivateVirtualInterfaceTimeoutsEl {}
impl BuildDxHostedPrivateVirtualInterfaceTimeoutsEl {
    pub fn build(self) -> DxHostedPrivateVirtualInterfaceTimeoutsEl {
        DxHostedPrivateVirtualInterfaceTimeoutsEl {
            create: core::default::Default::default(),
            delete: core::default::Default::default(),
        }
    }
}
pub struct DxHostedPrivateVirtualInterfaceTimeoutsElRef {
    shared: StackShared,
    base: String,
}
impl Ref for DxHostedPrivateVirtualInterfaceTimeoutsElRef {
    fn new(shared: StackShared, base: String) -> DxHostedPrivateVirtualInterfaceTimeoutsElRef {
        DxHostedPrivateVirtualInterfaceTimeoutsElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
}
impl DxHostedPrivateVirtualInterfaceTimeoutsElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
