...
struct CloudfrontFieldLevelEncryptionConfigContentTypeProfileConfigElContentTypeProfilesElDynamic { items : Option < DynamicBlock < CloudfrontFieldLevelEncryptionConfigContentTypeProfileConfigElContentTypeProfilesElItemsEl >> , }
#[derive(Serialize)]
pub struct CloudfrontFieldLevelEncryptionConfigContentTypeProfileConfigElContentTypeProfilesEl { # [serde (skip_serializing_if = "Option::is_none")] items : Option < Vec < CloudfrontFieldLevelEncryptionConfigContentTypeProfileConfigElContentTypeProfilesElItemsEl > > , dynamic : CloudfrontFieldLevelEncryptionConfigContentTypeProfileConfigElContentTypeProfilesElDynamic , }
impl CloudfrontFieldLevelEncryptionConfigContentTypeProfileConfigElContentTypeProfilesEl {
    #[doc = "Set the field `items`.\n"]
    pub fn set_items(
        mut self,
        v : impl Into < BlockAssignable < CloudfrontFieldLevelEncryptionConfigContentTypeProfileConfigElContentTypeProfilesElItemsEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.items = Some(v);
...
impl CloudfrontFieldLevelEncryptionConfigQueryArgProfileConfigElQueryArgProfilesEl {
    ...
    pub fn set_items(
        mut self,
        v : impl Into < BlockAssignable < CloudfrontFieldLevelEncryptionConfigQueryArgProfileConfigElQueryArgProfilesElItemsEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.items = Some(v);
