...
impl Ec2TransitGatewayMulticastGroupMember {
    ...
    pub fn group_ip_address(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.group_ip_address", self.extract_ref()),
        )
    }
...
impl Referable for Ec2TransitGatewayMulticastGroupMember {
...
impl BuildEc2TransitGatewayMulticastGroupMember {
    pub fn build(self, stack: &mut Stack) -> Ec2TransitGatewayMulticastGroupMember {
        let out = Ec2TransitGatewayMulticastGroupMember(Rc::new(
            Ec2TransitGatewayMulticastGroupMember_ {
