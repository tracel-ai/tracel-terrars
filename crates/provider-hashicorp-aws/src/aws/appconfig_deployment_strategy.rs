...
impl AppconfigDeploymentStrategy {
    ...
    pub fn deployment_duration_in_minutes(&self) -> PrimExpr<f64> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.deployment_duration_in_minutes", self.extract_ref()),
        )
    }
    ...
    pub fn final_bake_time_in_minutes(&self) -> PrimExpr<f64> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.final_bake_time_in_minutes", self.extract_ref()),
        )
    }
    ...
    pub fn growth_factor(&self) -> PrimExpr<f64> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.growth_factor", self.extract_ref()),
        )
    }
    ...
    pub fn growth_type(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.growth_type", self.extract_ref()),
        )
    }
    ...
    pub fn replicate_to(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.replicate_to", self.extract_ref()),
        )
    }
