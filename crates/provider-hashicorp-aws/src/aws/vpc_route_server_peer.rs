...
impl VpcRouteServerPeer {
    ...
    pub fn set_bgp_options(self, v: impl Into<BlockAssignable<VpcRouteServerPeerBgpOptionsEl>>) -> Self {
        match v.into() {
    ...
    pub fn endpoint_eni_address(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.endpoint_eni_address", self.extract_ref()))
    }

    #[doc = "Get a reference to the value of field `endpoint_eni_id` after provisioning.\n"]
    pub fn endpoint_eni_id(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.endpoint_eni_id", self.extract_ref()))
    }
    ...
    pub fn route_server_peer_id(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.route_server_peer_id", self.extract_ref()))
    }
    ...
    pub fn timeouts(&self) -> VpcRouteServerPeerTimeoutsElRef {
        VpcRouteServerPeerTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
}
...
impl VpcRouteServerPeerBgpOptionsElRef {
    ...
    pub fn peer_liveness_detection(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.peer_liveness_detection", self.base))
    }
}
