...
impl BatchJobQueue {
    ...
    pub fn job_state_time_limit_action(&self) -> ListRef<BatchJobQueueJobStateTimeLimitActionElRef> {
    ...
    pub fn timeouts(&self) -> BatchJobQueueTimeoutsElRef {
        BatchJobQueueTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
}
