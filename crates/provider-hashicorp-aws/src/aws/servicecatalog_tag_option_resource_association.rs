...
#[derive(Clone)]
pub struct ServicecatalogTagOptionResourceAssociation(
    Rc<ServicecatalogTagOptionResourceAssociation_>,
);
impl ServicecatalogTagOptionResourceAssociation {
    ...
    pub fn set_timeouts(
        self,
        v: impl Into<ServicecatalogTagOptionResourceAssociationTimeoutsEl>,
    ) -> Self {
    ...
    pub fn resource_created_time(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.resource_created_time", self.extract_ref()),
        )
    }
    ...
    pub fn resource_description(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.resource_description", self.extract_ref()),
        )
    }
    ...
    pub fn tag_option_id(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.tag_option_id", self.extract_ref()),
        )
    }
...
impl Referable for ServicecatalogTagOptionResourceAssociation {
...
impl BuildServicecatalogTagOptionResourceAssociation {
    pub fn build(self, stack: &mut Stack) -> ServicecatalogTagOptionResourceAssociation {
        let out = ServicecatalogTagOptionResourceAssociation(Rc::new(
            ServicecatalogTagOptionResourceAssociation_ {
