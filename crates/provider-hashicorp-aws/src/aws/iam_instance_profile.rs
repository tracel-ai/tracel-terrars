...
struct IamInstanceProfile_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<IamInstanceProfileData>,
}

#[derive(Clone)]
pub struct IamInstanceProfile(Rc<IamInstanceProfile_>);
...
impl Referable for IamInstanceProfile {
...
impl ToListMappable for IamInstanceProfile {
    type O = ListRef<IamInstanceProfileRef>;
...
impl Resource_ for IamInstanceProfile_ {
...
pub struct BuildIamInstanceProfile {
    pub tf_id: String,
}

impl BuildIamInstanceProfile {
    pub fn build(self, stack: &mut Stack) -> IamInstanceProfile {
        let out = IamInstanceProfile(Rc::new(IamInstanceProfile_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(IamInstanceProfileData {
...
pub struct IamInstanceProfileRef {
    shared: StackShared,
    base: String,
}

impl Ref for IamInstanceProfileRef {
