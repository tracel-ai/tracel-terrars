...
struct LoadBalancerListenerPolicyData {
    ...
    load_balancer_port: PrimField<f64>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
struct LoadBalancerListenerPolicy_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<LoadBalancerListenerPolicyData>,
}
#[derive(Clone)]
pub struct LoadBalancerListenerPolicy(Rc<LoadBalancerListenerPolicy_>);
impl LoadBalancerListenerPolicy {
...
impl Resource_ for LoadBalancerListenerPolicy_ {
    fn extract_resource_type(&self) -> String {
        "aws_load_balancer_listener_policy".into()
    }
...
pub struct BuildLoadBalancerListenerPolicy {
    pub tf_id: String,
    #[doc = ""]
    pub load_balancer_name: PrimField<String>,
    #[doc = ""]
    pub load_balancer_port: PrimField<f64>,
}
impl BuildLoadBalancerListenerPolicy {
    pub fn build(self, stack: &mut Stack) -> LoadBalancerListenerPolicy {
        let out = LoadBalancerListenerPolicy(Rc::new(LoadBalancerListenerPolicy_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(LoadBalancerListenerPolicyData {
...
pub struct LoadBalancerListenerPolicyRef {
    shared: StackShared,
    base: String,
}
...
impl LoadBalancerListenerPolicyRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
    fn shared(&self) -> &StackShared {
