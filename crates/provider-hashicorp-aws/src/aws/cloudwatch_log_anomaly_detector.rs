...
impl CloudwatchLogAnomalyDetector {
    ...
    pub fn anomaly_visibility_time(&self) -> PrimExpr<f64> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.anomaly_visibility_time", self.extract_ref()),
        )
    }
    ...
    pub fn detector_name(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.detector_name", self.extract_ref()),
        )
    }
    ...
    pub fn evaluation_frequency(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.evaluation_frequency", self.extract_ref()),
        )
    }
    ...
    pub fn log_group_arn_list(&self) -> ListRef<PrimExpr<String>> {
        ListRef::new(
            self.shared().clone(),
            format!("{}.log_group_arn_list", self.extract_ref()),
        )
    }
