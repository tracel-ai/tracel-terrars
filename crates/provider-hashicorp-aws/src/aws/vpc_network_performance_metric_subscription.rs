...
impl Referable for VpcNetworkPerformanceMetricSubscription {
...
impl BuildVpcNetworkPerformanceMetricSubscription {
    pub fn build(self, stack: &mut Stack) -> VpcNetworkPerformanceMetricSubscription {
        let out = VpcNetworkPerformanceMetricSubscription(Rc::new(
            VpcNetworkPerformanceMetricSubscription_ {
