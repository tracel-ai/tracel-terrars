...
struct InspectorAssessmentTemplateData {
    ...
    rules_package_arns: SetField<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl InspectorAssessmentTemplate {
    ...
    pub fn set_event_subscription(
        self,
        v: impl Into<BlockAssignable<InspectorAssessmentTemplateEventSubscriptionEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.0.data.borrow_mut().event_subscription = Some(v);
            },
            BlockAssignable::Dynamic(d) => {
                self.0.data.borrow_mut().dynamic.event_subscription = Some(d);
            },
        }
        self
    }
    ...
    pub fn rules_package_arns(&self) -> SetRef<PrimExpr<String>> {
        SetRef::new(self.shared().clone(), format!("{}.rules_package_arns", self.extract_ref()))
    }
...
pub struct BuildInspectorAssessmentTemplate {
    ...
    #[doc = ""]
    pub rules_package_arns: SetField<PrimField<String>>,
    #[doc = ""]
...
impl BuildInspectorAssessmentTemplate {
    pub fn build(self, stack: &mut Stack) -> InspectorAssessmentTemplate {
        let out = InspectorAssessmentTemplate(Rc::new(InspectorAssessmentTemplate_ {
            ...
            tf_id: self.tf_id,
            data: RefCell::new(InspectorAssessmentTemplateData {
                ...
                event_subscription: core::default::Default::default(),
