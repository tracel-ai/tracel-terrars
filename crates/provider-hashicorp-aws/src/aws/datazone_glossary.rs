...
struct DatazoneGlossary_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<DatazoneGlossaryData>,
}
#[derive(Clone)]
pub struct DatazoneGlossary(Rc<DatazoneGlossary_>);
impl DatazoneGlossary {
...
impl Referable for DatazoneGlossary {
...
impl Resource for DatazoneGlossary {}
impl ToListMappable for DatazoneGlossary {
    type O = ListRef<DatazoneGlossaryRef>;
    fn do_map(self, base: String) -> Self::O {
        self.0.data.borrow_mut().for_each = Some(format!("${{{}}}", base));
        ListRef::new(self.0.shared.clone(), self.extract_ref())
    }
}
impl Resource_ for DatazoneGlossary_ {
    fn extract_resource_type(&self) -> String {
        "aws_datazone_glossary".into()
    }
...
pub struct BuildDatazoneGlossary {
    pub tf_id: String,
    #[doc = ""]
...
impl BuildDatazoneGlossary {
    pub fn build(self, stack: &mut Stack) -> DatazoneGlossary {
        let out = DatazoneGlossary(Rc::new(DatazoneGlossary_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(DatazoneGlossaryData {
...
pub struct DatazoneGlossaryRef {
    shared: StackShared,
    base: String,
}
impl Ref for DatazoneGlossaryRef {
    fn new(shared: StackShared, base: String) -> Self {
        Self { shared, base }
    }
}
impl DatazoneGlossaryRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
    fn shared(&self) -> &StackShared {
