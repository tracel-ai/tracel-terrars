...
struct DataLexIntent_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<DataLexIntentData>,
}
#[derive(Clone)]
pub struct DataLexIntent(Rc<DataLexIntent_>);
impl DataLexIntent {
...
impl Referable for DataLexIntent {
...
impl Datasource for DataLexIntent {}
impl ToListMappable for DataLexIntent {
    type O = ListRef<DataLexIntentRef>;
    fn do_map(self, base: String) -> Self::O {
        self.0.data.borrow_mut().for_each = Some(format!("${{{}}}", base));
        ListRef::new(self.0.shared.clone(), self.extract_ref())
    }
}
impl Datasource_ for DataLexIntent_ {
...
pub struct BuildDataLexIntent {
    pub tf_id: String,
    #[doc = ""]
    pub name: PrimField<String>,
}
impl BuildDataLexIntent {
    pub fn build(self, stack: &mut Stack) -> DataLexIntent {
        let out = DataLexIntent(Rc::new(DataLexIntent_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(DataLexIntentData {
...
pub struct DataLexIntentRef {
    shared: StackShared,
    base: String,
}
impl Ref for DataLexIntentRef {
    fn new(shared: StackShared, base: String) -> Self {
        Self { shared, base }
    }
}
impl DataLexIntentRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    fn extract_ref(&self) -> String {
