...
struct AutoscalingGroupData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    ignore_failed_scaling_activities: Option<PrimField<bool>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    availability_zone_distribution: Option<Vec<AutoscalingGroupAvailabilityZoneDistributionEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    capacity_reservation_specification:
        Option<Vec<AutoscalingGroupCapacityReservationSpecificationEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    initial_lifecycle_hook: Option<Vec<AutoscalingGroupInitialLifecycleHookEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    instance_maintenance_policy: Option<Vec<AutoscalingGroupInstanceMaintenancePolicyEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    traffic_source: Option<Vec<AutoscalingGroupTrafficSourceEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl AutoscalingGroup {
    ...
    #[doc = "Set the field `ignore_failed_scaling_activities`.\n"]
    pub fn set_ignore_failed_scaling_activities(self, v: impl Into<PrimField<bool>>) -> Self {
        self.0.data.borrow_mut().ignore_failed_scaling_activities = Some(v.into());
        self
    }
    ...
    #[doc = "Set the field `availability_zone_distribution`.\n"]
    pub fn set_availability_zone_distribution(
        self,
        v: impl Into<BlockAssignable<AutoscalingGroupAvailabilityZoneDistributionEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.0.data.borrow_mut().availability_zone_distribution = Some(v);
            }
            BlockAssignable::Dynamic(d) => {
                self.0
                    ...
                    .borrow_mut()
                    .dynamic
                    .availability_zone_distribution = Some(d);
            }
        }
        self
    }
    ...
    pub fn set_capacity_reservation_specification(
        self,
        v: impl Into<BlockAssignable<AutoscalingGroupCapacityReservationSpecificationEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
            ...
            BlockAssignable::Dynamic(d) => {
                self.0
                    ...
                    .borrow_mut()
                    .dynamic
                    .capacity_reservation_specification = Some(d);
            }
        }
        self
    }
    ...
    #[doc = "Set the field `instance_maintenance_policy`.\n"]
    pub fn set_instance_maintenance_policy(
        self,
        v: impl Into<BlockAssignable<AutoscalingGroupInstanceMaintenancePolicyEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.0.data.borrow_mut().instance_maintenance_policy = Some(v);
            }
            BlockAssignable::Dynamic(d) => {
                self.0.data.borrow_mut().dynamic.instance_maintenance_policy = Some(d);
            }
        }
        self
    }
    #[doc = "Set the field `instance_refresh`.\n"]
    pub fn set_instance_refresh(
        self,
        v: impl Into<BlockAssignable<AutoscalingGroupInstanceRefreshEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_launch_template(
        self,
        v: impl Into<BlockAssignable<AutoscalingGroupLaunchTemplateEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_traffic_source(
        self,
        v: impl Into<BlockAssignable<AutoscalingGroupTrafficSourceEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn capacity_rebalance(&self) -> PrimExpr<bool> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.capacity_rebalance", self.extract_ref()),
        )
    }
    ...
    pub fn default_instance_warmup(&self) -> PrimExpr<f64> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.default_instance_warmup", self.extract_ref()),
        )
    }
    ...
    pub fn force_delete_warm_pool(&self) -> PrimExpr<bool> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.force_delete_warm_pool", self.extract_ref()),
        )
    }
    ...
    #[doc = "Get a reference to the value of field `ignore_failed_scaling_activities` after provisioning.\n"]
    pub fn ignore_failed_scaling_activities(&self) -> PrimExpr<bool> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.ignore_failed_scaling_activities", self.extract_ref()),
        )
    }
    ...
    pub fn metrics_granularity(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.metrics_granularity", self.extract_ref()),
        )
    }
    ...
    pub fn min_elb_capacity(&self) -> PrimExpr<f64> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.min_elb_capacity", self.extract_ref()),
        )
    }
    ...
    pub fn protect_from_scale_in(&self) -> PrimExpr<bool> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.protect_from_scale_in", self.extract_ref()),
        )
    }
    ...
    pub fn wait_for_capacity_timeout(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.wait_for_capacity_timeout", self.extract_ref()),
        )
    }
    ...
    pub fn wait_for_elb_capacity(&self) -> PrimExpr<f64> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.wait_for_elb_capacity", self.extract_ref()),
        )
    }
    ...
    #[doc = "Get a reference to the value of field `availability_zone_distribution` after provisioning.\n"]
    pub fn availability_zone_distribution(
        &self,
    ) -> ListRef<AutoscalingGroupAvailabilityZoneDistributionElRef> {
        ListRef::new(
            self.shared().clone(),
            format!("{}.availability_zone_distribution", self.extract_ref()),
        )
    }
    ...
    pub fn capacity_reservation_specification(
        &self,
    ) -> ListRef<AutoscalingGroupCapacityReservationSpecificationElRef> {
        ListRef::new(
            self.shared().clone(),
    ...
    pub fn instance_maintenance_policy(
        &self,
    ) -> ListRef<AutoscalingGroupInstanceMaintenancePolicyElRef> {
        ListRef::new(
            self.shared().clone(),
    ...
    pub fn instance_refresh(&self) -> ListRef<AutoscalingGroupInstanceRefreshElRef> {
        ListRef::new(
            self.shared().clone(),
            format!("{}.instance_refresh", self.extract_ref()),
        )
    }
    ...
    pub fn timeouts(&self) -> AutoscalingGroupTimeoutsElRef {
        AutoscalingGroupTimeoutsElRef::new(
            self.shared().clone(),
...
impl Referable for AutoscalingGroup {
    ...
    pub fn build(self, stack: &mut Stack) -> AutoscalingGroup {
        let out = AutoscalingGroup(Rc::new(AutoscalingGroup_ {
            ...
            data: RefCell::new(AutoscalingGroupData {
                ...
                ignore_failed_scaling_activities: core::default::Default::default(),
                ...
                availability_zone_distribution: core::default::Default::default(),
                capacity_reservation_specification: core::default::Default::default(),
                initial_lifecycle_hook: core::default::Default::default(),
                instance_maintenance_policy: core::default::Default::default(),
...
#[derive(Serialize)]
pub struct AutoscalingGroupAvailabilityZoneDistributionEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    capacity_distribution_strategy: Option<PrimField<String>>,
}
impl AutoscalingGroupAvailabilityZoneDistributionEl {
    #[doc = "Set the field `capacity_distribution_strategy`.\n"]
    pub fn set_capacity_distribution_strategy(mut self, v: impl Into<PrimField<String>>) -> Self {
        self.capacity_distribution_strategy = Some(v.into());
        self
    }
}
impl ToListMappable for AutoscalingGroupAvailabilityZoneDistributionEl {
    type O = BlockAssignable<AutoscalingGroupAvailabilityZoneDistributionEl>;
    fn do_map(self, base: String) -> Self::O {
...
pub struct BuildAutoscalingGroupAvailabilityZoneDistributionEl {}
impl BuildAutoscalingGroupAvailabilityZoneDistributionEl {
    pub fn build(self) -> AutoscalingGroupAvailabilityZoneDistributionEl {
        AutoscalingGroupAvailabilityZoneDistributionEl {
            capacity_distribution_strategy: core::default::Default::default(),
        }
    }
}
pub struct AutoscalingGroupAvailabilityZoneDistributionElRef {
    shared: StackShared,
    base: String,
}
impl Ref for AutoscalingGroupAvailabilityZoneDistributionElRef {
    fn new(shared: StackShared, base: String) -> AutoscalingGroupAvailabilityZoneDistributionElRef {
        AutoscalingGroupAvailabilityZoneDistributionElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
}
impl AutoscalingGroupAvailabilityZoneDistributionElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    #[doc = "Get a reference to the value of field `capacity_distribution_strategy` after provisioning.\n"]
    pub fn capacity_distribution_strategy(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.capacity_distribution_strategy", self.base),
        )
    }
}
#[derive(Serialize)]
pub struct AutoscalingGroupCapacityReservationSpecificationElCapacityReservationTargetEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    capacity_reservation_ids: Option<ListField<PrimField<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    capacity_reservation_resource_group_arns: Option<ListField<PrimField<String>>>,
}
impl AutoscalingGroupCapacityReservationSpecificationElCapacityReservationTargetEl {
    #[doc = "Set the field `capacity_reservation_ids`.\n"]
    pub fn set_capacity_reservation_ids(
        mut self,
        v: impl Into<ListField<PrimField<String>>>,
    ) -> Self {
        self.capacity_reservation_ids = Some(v.into());
        self
    }
    #[doc = "Set the field `capacity_reservation_resource_group_arns`.\n"]
    pub fn set_capacity_reservation_resource_group_arns(
        mut self,
        v: impl Into<ListField<PrimField<String>>>,
    ) -> Self {
        self.capacity_reservation_resource_group_arns = Some(v.into());
        self
    }
}
impl ToListMappable
    for AutoscalingGroupCapacityReservationSpecificationElCapacityReservationTargetEl
{
    type O = BlockAssignable<
        AutoscalingGroupCapacityReservationSpecificationElCapacityReservationTargetEl,
    >;
    fn do_map(self, base: String) -> Self::O {
        BlockAssignable::Dynamic(DynamicBlock {
            for_each: format!("${{{}}}", base),
...
pub struct BuildAutoscalingGroupCapacityReservationSpecificationElCapacityReservationTargetEl {}
impl BuildAutoscalingGroupCapacityReservationSpecificationElCapacityReservationTargetEl {
    pub fn build(
        self,
    ) -> AutoscalingGroupCapacityReservationSpecificationElCapacityReservationTargetEl {
        AutoscalingGroupCapacityReservationSpecificationElCapacityReservationTargetEl {
            capacity_reservation_ids: core::default::Default::default(),
            capacity_reservation_resource_group_arns: core::default::Default::default(),
        }
    }
}
pub struct AutoscalingGroupCapacityReservationSpecificationElCapacityReservationTargetElRef {
    shared: StackShared,
    base: String,
}
impl Ref for AutoscalingGroupCapacityReservationSpecificationElCapacityReservationTargetElRef {
    fn new(
        shared: StackShared,
        base: String,
    ) -> AutoscalingGroupCapacityReservationSpecificationElCapacityReservationTargetElRef {
        AutoscalingGroupCapacityReservationSpecificationElCapacityReservationTargetElRef {
            shared: shared,
            base: base.to_string(),
        }
...
impl AutoscalingGroupCapacityReservationSpecificationElCapacityReservationTargetElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    #[doc = "Get a reference to the value of field `capacity_reservation_ids` after provisioning.\n"]
    pub fn capacity_reservation_ids(&self) -> ListRef<PrimExpr<String>> {
        ListRef::new(
            self.shared().clone(),
            format!("{}.capacity_reservation_ids", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `capacity_reservation_resource_group_arns` after provisioning.\n"]
    pub fn capacity_reservation_resource_group_arns(&self) -> ListRef<PrimExpr<String>> {
        ListRef::new(
            self.shared().clone(),
            format!("{}.capacity_reservation_resource_group_arns", self.base),
        )
    }
}
#[derive(Serialize, Default)]
struct AutoscalingGroupCapacityReservationSpecificationElDynamic {
    capacity_reservation_target: Option<
        DynamicBlock<AutoscalingGroupCapacityReservationSpecificationElCapacityReservationTargetEl>,
    >,
}
#[derive(Serialize)]
pub struct AutoscalingGroupCapacityReservationSpecificationEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    capacity_reservation_preference: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    capacity_reservation_target:
        Option<Vec<AutoscalingGroupCapacityReservationSpecificationElCapacityReservationTargetEl>>,
    dynamic: AutoscalingGroupCapacityReservationSpecificationElDynamic,
}
impl AutoscalingGroupCapacityReservationSpecificationEl {
...
impl ToListMappable for AutoscalingGroupCapacityReservationSpecificationEl {
    type O = BlockAssignable<AutoscalingGroupCapacityReservationSpecificationEl>;
    fn do_map(self, base: String) -> Self::O {
        BlockAssignable::Dynamic(DynamicBlock {
            for_each: format!("${{{}}}", base),
            iterator: "each".into(),
...
pub struct BuildAutoscalingGroupCapacityReservationSpecificationEl {}
impl BuildAutoscalingGroupCapacityReservationSpecificationEl {
    pub fn build(self) -> AutoscalingGroupCapacityReservationSpecificationEl {
        AutoscalingGroupCapacityReservationSpecificationEl {
...
pub struct AutoscalingGroupCapacityReservationSpecificationElRef {
    shared: StackShared,
    base: String,
}
impl Ref for AutoscalingGroupCapacityReservationSpecificationElRef {
    fn new(
        shared: StackShared,
        base: String,
    ) -> AutoscalingGroupCapacityReservationSpecificationElRef {
        AutoscalingGroupCapacityReservationSpecificationElRef {
            shared: shared,
            base: base.to_string(),
        }
...
impl AutoscalingGroupCapacityReservationSpecificationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    ...
    pub fn capacity_reservation_target(
        &self,
    ) -> ListRef<AutoscalingGroupCapacityReservationSpecificationElCapacityReservationTargetElRef>
    {
        ListRef::new(
            self.shared().clone(),
            format!("{}.capacity_reservation_target", self.base),
        )
    }
}
#[derive(Serialize)]
...
impl AutoscalingGroupInitialLifecycleHookElRef {
    ...
    pub fn default_result(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.default_result", self.base),
        )
    }
    ...
    pub fn heartbeat_timeout(&self) -> PrimExpr<f64> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.heartbeat_timeout", self.base),
        )
    }
    ...
    pub fn lifecycle_transition(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.lifecycle_transition", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `name` after provisioning.\n"]
    pub fn name(&self) -> PrimExpr<String> {
    ...
    pub fn notification_metadata(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.notification_metadata", self.base),
        )
    }
    ...
    pub fn notification_target_arn(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.notification_target_arn", self.base),
        )
    }
...
#[derive(Serialize)]
pub struct AutoscalingGroupInstanceMaintenancePolicyEl {
    max_healthy_percentage: PrimField<f64>,
    min_healthy_percentage: PrimField<f64>,
}
impl AutoscalingGroupInstanceMaintenancePolicyEl {}
impl ToListMappable for AutoscalingGroupInstanceMaintenancePolicyEl {
    type O = BlockAssignable<AutoscalingGroupInstanceMaintenancePolicyEl>;
    fn do_map(self, base: String) -> Self::O {
        BlockAssignable::Dynamic(DynamicBlock {
            for_each: format!("${{{}}}", base),
            iterator: "each".into(),
...
pub struct BuildAutoscalingGroupInstanceMaintenancePolicyEl {
    #[doc = ""]
    pub max_healthy_percentage: PrimField<f64>,
    #[doc = ""]
    pub min_healthy_percentage: PrimField<f64>,
}
impl BuildAutoscalingGroupInstanceMaintenancePolicyEl {
    pub fn build(self) -> AutoscalingGroupInstanceMaintenancePolicyEl {
        AutoscalingGroupInstanceMaintenancePolicyEl {
            max_healthy_percentage: self.max_healthy_percentage,
            min_healthy_percentage: self.min_healthy_percentage,
        }
    }
}
pub struct AutoscalingGroupInstanceMaintenancePolicyElRef {
    shared: StackShared,
    base: String,
}
impl Ref for AutoscalingGroupInstanceMaintenancePolicyElRef {
    fn new(shared: StackShared, base: String) -> AutoscalingGroupInstanceMaintenancePolicyElRef {
        AutoscalingGroupInstanceMaintenancePolicyElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
}
impl AutoscalingGroupInstanceMaintenancePolicyElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize)]
pub struct AutoscalingGroupInstanceRefreshElPreferencesElAlarmSpecificationEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    alarms: Option<ListField<PrimField<String>>>,
}
impl AutoscalingGroupInstanceRefreshElPreferencesElAlarmSpecificationEl {
...
impl ToListMappable for AutoscalingGroupInstanceRefreshElPreferencesElAlarmSpecificationEl {
    type O = BlockAssignable<AutoscalingGroupInstanceRefreshElPreferencesElAlarmSpecificationEl>;
    fn do_map(self, base: String) -> Self::O {
        BlockAssignable::Dynamic(DynamicBlock {
            for_each: format!("${{{}}}", base),
            iterator: "each".into(),
...
pub struct BuildAutoscalingGroupInstanceRefreshElPreferencesElAlarmSpecificationEl {}
impl BuildAutoscalingGroupInstanceRefreshElPreferencesElAlarmSpecificationEl {
    pub fn build(self) -> AutoscalingGroupInstanceRefreshElPreferencesElAlarmSpecificationEl {
        AutoscalingGroupInstanceRefreshElPreferencesElAlarmSpecificationEl {
            alarms: core::default::Default::default(),
        }
    }
}
pub struct AutoscalingGroupInstanceRefreshElPreferencesElAlarmSpecificationElRef {
    shared: StackShared,
    base: String,
}
impl Ref for AutoscalingGroupInstanceRefreshElPreferencesElAlarmSpecificationElRef {
    fn new(
        shared: StackShared,
        base: String,
    ) -> AutoscalingGroupInstanceRefreshElPreferencesElAlarmSpecificationElRef {
        AutoscalingGroupInstanceRefreshElPreferencesElAlarmSpecificationElRef {
            shared: shared,
            base: base.to_string(),
        }
...
impl AutoscalingGroupInstanceRefreshElPreferencesElAlarmSpecificationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize, Default)]
struct AutoscalingGroupInstanceRefreshElPreferencesElDynamic {
    alarm_specification:
        Option<DynamicBlock<AutoscalingGroupInstanceRefreshElPreferencesElAlarmSpecificationEl>>,
}
#[derive(Serialize)]
pub struct AutoscalingGroupInstanceRefreshElPreferencesEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    auto_rollback: Option<PrimField<bool>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    scale_in_protected_instances: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    skip_matching: Option<PrimField<bool>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    standby_instances: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    alarm_specification:
        Option<Vec<AutoscalingGroupInstanceRefreshElPreferencesElAlarmSpecificationEl>>,
    dynamic: AutoscalingGroupInstanceRefreshElPreferencesElDynamic,
}
impl AutoscalingGroupInstanceRefreshElPreferencesEl {
    #[doc = "Set the field `auto_rollback`.\n"]
    pub fn set_auto_rollback(mut self, v: impl Into<PrimField<bool>>) -> Self {
        self.auto_rollback = Some(v.into());
        self
    }
    ...
    #[doc = "Set the field `scale_in_protected_instances`.\n"]
    pub fn set_scale_in_protected_instances(mut self, v: impl Into<PrimField<String>>) -> Self {
        self.scale_in_protected_instances = Some(v.into());
        self
    }
    ...
    #[doc = "Set the field `standby_instances`.\n"]
    pub fn set_standby_instances(mut self, v: impl Into<PrimField<String>>) -> Self {
        self.standby_instances = Some(v.into());
        self
    }
    #[doc = "Set the field `alarm_specification`.\n"]
    pub fn set_alarm_specification(
        mut self,
        v: impl Into<
            BlockAssignable<AutoscalingGroupInstanceRefreshElPreferencesElAlarmSpecificationEl>,
        >,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.alarm_specification = Some(v);
            }
            BlockAssignable::Dynamic(d) => {
                self.dynamic.alarm_specification = Some(d);
            }
        }
        self
    }
...
impl BuildAutoscalingGroupInstanceRefreshElPreferencesEl {
    pub fn build(self) -> AutoscalingGroupInstanceRefreshElPreferencesEl {
        AutoscalingGroupInstanceRefreshElPreferencesEl {
            auto_rollback: core::default::Default::default(),
            ...
            scale_in_protected_instances: core::default::Default::default(),
            skip_matching: core::default::Default::default(),
            standby_instances: core::default::Default::default(),
            alarm_specification: core::default::Default::default(),
            dynamic: Default::default(),
        }
    }
}
...
impl AutoscalingGroupInstanceRefreshElPreferencesElRef {
    ...
    #[doc = "Get a reference to the value of field `auto_rollback` after provisioning.\n"]
    pub fn auto_rollback(&self) -> PrimExpr<bool> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.auto_rollback", self.base),
        )
    }
    ...
    pub fn checkpoint_delay(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.checkpoint_delay", self.base),
        )
    }
    ...
    pub fn checkpoint_percentages(&self) -> ListRef<PrimExpr<f64>> {
        ListRef::new(
            self.shared().clone(),
            format!("{}.checkpoint_percentages", self.base),
        )
    }
    ...
    pub fn instance_warmup(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.instance_warmup", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `max_healthy_percentage` after provisioning.\n"]
    pub fn max_healthy_percentage(&self) -> PrimExpr<f64> {
    ...
    #[doc = "Get a reference to the value of field `scale_in_protected_instances` after provisioning.\n"]
    pub fn scale_in_protected_instances(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.scale_in_protected_instances", self.base),
        )
    }
    ...
    pub fn skip_matching(&self) -> PrimExpr<bool> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.skip_matching", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `standby_instances` after provisioning.\n"]
    pub fn standby_instances(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.standby_instances", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `alarm_specification` after provisioning.\n"]
    pub fn alarm_specification(
        &self,
    ) -> ListRef<AutoscalingGroupInstanceRefreshElPreferencesElAlarmSpecificationElRef> {
        ListRef::new(
            self.shared().clone(),
            format!("{}.alarm_specification", self.base),
        )
    }
}
#[derive(Serialize, Default)]
...
impl ToListMappable
    for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElLaunchTemplateSpecificationEl
{
    type O = BlockAssignable<
...
impl Ref
    for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElLaunchTemplateSpecificationElRef
{
    fn new(
        shared: StackShared,
        base: String,
...
impl AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElAcceleratorTotalMemoryMibEl { # [doc = "Set the field `max`.\n"] pub fn set_max (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . max = Some (v . into ()) ; self } # [doc = "Set the field `min`.\n"] pub fn set_min (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . min = Some (v . into ()) ; self } }
impl ToListMappable for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElAcceleratorTotalMemoryMibEl { type O = BlockAssignable < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElAcceleratorTotalMemoryMibEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElAcceleratorTotalMemoryMibElRef { fn new (shared : StackShared , base : String) -> AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElAcceleratorTotalMemoryMibElRef { AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElAcceleratorTotalMemoryMibElRef { shared : shared , base : base . to_string () , } } }
impl AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElAcceleratorTotalMemoryMibElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `max` after provisioning.\n"] pub fn max (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.max" , self . base)) } # [doc = "Get a reference to the value of field `min` after provisioning.\n"] pub fn min (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.min" , self . base)) } }
#[derive(Serialize)]
...
impl AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElBaselineEbsBandwidthMbpsEl { # [doc = "Set the field `max`.\n"] pub fn set_max (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . max = Some (v . into ()) ; self } # [doc = "Set the field `min`.\n"] pub fn set_min (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . min = Some (v . into ()) ; self } }
impl ToListMappable for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElBaselineEbsBandwidthMbpsEl { type O = BlockAssignable < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElBaselineEbsBandwidthMbpsEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElBaselineEbsBandwidthMbpsElRef { fn new (shared : StackShared , base : String) -> AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElBaselineEbsBandwidthMbpsElRef { AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElBaselineEbsBandwidthMbpsElRef { shared : shared , base : base . to_string () , } } }
impl AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElBaselineEbsBandwidthMbpsElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `max` after provisioning.\n"] pub fn max (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.max" , self . base)) } # [doc = "Get a reference to the value of field `min` after provisioning.\n"] pub fn min (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.min" , self . base)) } }
#[derive(Serialize)]
...
impl AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryMibEl { # [doc = "Set the field `max`.\n"] pub fn set_max (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . max = Some (v . into ()) ; self } # [doc = "Set the field `min`.\n"] pub fn set_min (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . min = Some (v . into ()) ; self } }
impl ToListMappable for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryMibEl { type O = BlockAssignable < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryMibEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildAutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryMibEl
{}
impl BuildAutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryMibEl { pub fn build (self) -> AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryMibEl { AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryMibEl { max : core :: default :: Default :: default () , min : core :: default :: Default :: default () , } } }
pub struct AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryMibElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryMibElRef { fn new (shared : StackShared , base : String) -> AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryMibElRef { AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryMibElRef { shared : shared , base : base . to_string () , } } }
impl AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryMibElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `max` after provisioning.\n"] pub fn max (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.max" , self . base)) } # [doc = "Get a reference to the value of field `min` after provisioning.\n"] pub fn min (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.min" , self . base)) } }
#[derive(Serialize)]
pub struct AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkBandwidthGbpsEl
{
    #[serde(skip_serializing_if = "Option::is_none")]
    max: Option<PrimField<f64>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkBandwidthGbpsEl { # [doc = "Set the field `max`.\n"] pub fn set_max (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . max = Some (v . into ()) ; self } # [doc = "Set the field `min`.\n"] pub fn set_min (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . min = Some (v . into ()) ; self } }
impl ToListMappable for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkBandwidthGbpsEl { type O = BlockAssignable < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkBandwidthGbpsEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildAutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkBandwidthGbpsEl
{}
impl BuildAutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkBandwidthGbpsEl { pub fn build (self) -> AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkBandwidthGbpsEl { AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkBandwidthGbpsEl { max : core :: default :: Default :: default () , min : core :: default :: Default :: default () , } } }
pub struct AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkBandwidthGbpsElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkBandwidthGbpsElRef { fn new (shared : StackShared , base : String) -> AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkBandwidthGbpsElRef { AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkBandwidthGbpsElRef { shared : shared , base : base . to_string () , } } }
impl AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkBandwidthGbpsElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `max` after provisioning.\n"] pub fn max (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.max" , self . base)) } # [doc = "Get a reference to the value of field `min` after provisioning.\n"] pub fn min (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.min" , self . base)) } }
#[derive(Serialize)]
...
impl AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkInterfaceCountEl { # [doc = "Set the field `max`.\n"] pub fn set_max (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . max = Some (v . into ()) ; self } # [doc = "Set the field `min`.\n"] pub fn set_min (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . min = Some (v . into ()) ; self } }
impl ToListMappable for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkInterfaceCountEl { type O = BlockAssignable < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkInterfaceCountEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkInterfaceCountElRef { fn new (shared : StackShared , base : String) -> AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkInterfaceCountElRef { AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkInterfaceCountElRef { shared : shared , base : base . to_string () , } } }
impl AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkInterfaceCountElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `max` after provisioning.\n"] pub fn max (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.max" , self . base)) } # [doc = "Get a reference to the value of field `min` after provisioning.\n"] pub fn min (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.min" , self . base)) } }
#[derive(Serialize)]
...
impl AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElTotalLocalStorageGbEl { # [doc = "Set the field `max`.\n"] pub fn set_max (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . max = Some (v . into ()) ; self } # [doc = "Set the field `min`.\n"] pub fn set_min (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . min = Some (v . into ()) ; self } }
impl ToListMappable for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElTotalLocalStorageGbEl { type O = BlockAssignable < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElTotalLocalStorageGbEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElTotalLocalStorageGbElRef { fn new (shared : StackShared , base : String) -> AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElTotalLocalStorageGbElRef { AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElTotalLocalStorageGbElRef { shared : shared , base : base . to_string () , } } }
impl AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElTotalLocalStorageGbElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `max` after provisioning.\n"] pub fn max (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.max" , self . base)) } # [doc = "Get a reference to the value of field `min` after provisioning.\n"] pub fn min (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.min" , self . base)) } }
#[derive(Serialize)]
...
impl AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElVcpuCountEl { # [doc = "Set the field `max`.\n"] pub fn set_max (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . max = Some (v . into ()) ; self } # [doc = "Set the field `min`.\n"] pub fn set_min (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . min = Some (v . into ()) ; self } }
impl ToListMappable for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElVcpuCountEl { type O = BlockAssignable < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElVcpuCountEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildAutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElVcpuCountEl
{}
impl BuildAutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElVcpuCountEl { pub fn build (self) -> AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElVcpuCountEl { AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElVcpuCountEl { max : core :: default :: Default :: default () , min : core :: default :: Default :: default () , } } }
pub struct AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElVcpuCountElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElVcpuCountElRef { fn new (shared : StackShared , base : String) -> AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElVcpuCountElRef { AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElVcpuCountElRef { shared : shared , base : base . to_string () , } } }
impl AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElVcpuCountElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `max` after provisioning.\n"] pub fn max (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.max" , self . base)) } # [doc = "Get a reference to the value of field `min` after provisioning.\n"] pub fn min (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.min" , self . base)) } }
#[derive(Serialize, Default)]
struct AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElDynamic { accelerator_count : Option < DynamicBlock < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElAcceleratorCountEl >> , accelerator_total_memory_mib : Option < DynamicBlock < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElAcceleratorTotalMemoryMibEl >> , baseline_ebs_bandwidth_mbps : Option < DynamicBlock < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElBaselineEbsBandwidthMbpsEl >> , memory_gib_per_vcpu : Option < DynamicBlock < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryGibPerVcpuEl >> , memory_mib : Option < DynamicBlock < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryMibEl >> , network_bandwidth_gbps : Option < DynamicBlock < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkBandwidthGbpsEl >> , network_interface_count : Option < DynamicBlock < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkInterfaceCountEl >> , total_local_storage_gb : Option < DynamicBlock < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElTotalLocalStorageGbEl >> , vcpu_count : Option < DynamicBlock < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElVcpuCountEl >> , }
#[derive(Serialize)]
pub struct AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsEl { # [serde (skip_serializing_if = "Option::is_none")] accelerator_manufacturers : Option < SetField < PrimField < String > > > , # [serde (skip_serializing_if = "Option::is_none")] accelerator_names : Option < SetField < PrimField < String > > > , # [serde (skip_serializing_if = "Option::is_none")] accelerator_types : Option < SetField < PrimField < String > > > , # [serde (skip_serializing_if = "Option::is_none")] allowed_instance_types : Option < SetField < PrimField < String > > > , # [serde (skip_serializing_if = "Option::is_none")] bare_metal : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] burstable_performance : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] cpu_manufacturers : Option < SetField < PrimField < String > > > , # [serde (skip_serializing_if = "Option::is_none")] excluded_instance_types : Option < SetField < PrimField < String > > > , # [serde (skip_serializing_if = "Option::is_none")] instance_generations : Option < SetField < PrimField < String > > > , # [serde (skip_serializing_if = "Option::is_none")] local_storage : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] local_storage_types : Option < SetField < PrimField < String > > > , # [serde (skip_serializing_if = "Option::is_none")] max_spot_price_as_percentage_of_optimal_on_demand_price : Option < PrimField < f64 > > , # [serde (skip_serializing_if = "Option::is_none")] on_demand_max_price_percentage_over_lowest_price : Option < PrimField < f64 > > , # [serde (skip_serializing_if = "Option::is_none")] require_hibernate_support : Option < PrimField < bool > > , # [serde (skip_serializing_if = "Option::is_none")] spot_max_price_percentage_over_lowest_price : Option < PrimField < f64 > > , # [serde (skip_serializing_if = "Option::is_none")] accelerator_count : Option < Vec < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElAcceleratorCountEl > > , # [serde (skip_serializing_if = "Option::is_none")] accelerator_total_memory_mib : Option < Vec < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElAcceleratorTotalMemoryMibEl > > , # [serde (skip_serializing_if = "Option::is_none")] baseline_ebs_bandwidth_mbps : Option < Vec < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElBaselineEbsBandwidthMbpsEl > > , # [serde (skip_serializing_if = "Option::is_none")] memory_gib_per_vcpu : Option < Vec < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryGibPerVcpuEl > > , # [serde (skip_serializing_if = "Option::is_none")] memory_mib : Option < Vec < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryMibEl > > , # [serde (skip_serializing_if = "Option::is_none")] network_bandwidth_gbps : Option < Vec < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkBandwidthGbpsEl > > , # [serde (skip_serializing_if = "Option::is_none")] network_interface_count : Option < Vec < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkInterfaceCountEl > > , # [serde (skip_serializing_if = "Option::is_none")] total_local_storage_gb : Option < Vec < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElTotalLocalStorageGbEl > > , # [serde (skip_serializing_if = "Option::is_none")] vcpu_count : Option < Vec < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElVcpuCountEl > > , dynamic : AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElDynamic , }
impl AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsEl {
    ...
    pub fn set_accelerator_count(
        mut self,
        v : impl Into < BlockAssignable < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElAcceleratorCountEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_accelerator_total_memory_mib(
        mut self,
        v : impl Into < BlockAssignable < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElAcceleratorTotalMemoryMibEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_baseline_ebs_bandwidth_mbps(
        mut self,
        v : impl Into < BlockAssignable < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElBaselineEbsBandwidthMbpsEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_memory_gib_per_vcpu(
        mut self,
        v : impl Into < BlockAssignable < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryGibPerVcpuEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_memory_mib(
        mut self,
        v : impl Into < BlockAssignable < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryMibEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_network_bandwidth_gbps(
        mut self,
        v : impl Into < BlockAssignable < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkBandwidthGbpsEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_network_interface_count(
        mut self,
        v : impl Into < BlockAssignable < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkInterfaceCountEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_total_local_storage_gb(
        mut self,
        v : impl Into < BlockAssignable < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElTotalLocalStorageGbEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_vcpu_count(
        mut self,
        v : impl Into < BlockAssignable < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElVcpuCountEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl ToListMappable
    for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsEl
{
    type O = BlockAssignable<
...
impl Ref
    for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElRef
{
    fn new(
        shared: StackShared,
        base: String,
...
impl AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElRef {
    ...
    #[doc = "Get a reference to the value of field `accelerator_count` after provisioning.\n"]    pub fn accelerator_count (& self) -> ListRef < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElAcceleratorCountElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.accelerator_count", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `accelerator_total_memory_mib` after provisioning.\n"]    pub fn accelerator_total_memory_mib (& self) -> ListRef < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElAcceleratorTotalMemoryMibElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.accelerator_total_memory_mib", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `baseline_ebs_bandwidth_mbps` after provisioning.\n"]    pub fn baseline_ebs_bandwidth_mbps (& self) -> ListRef < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElBaselineEbsBandwidthMbpsElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.baseline_ebs_bandwidth_mbps", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `memory_gib_per_vcpu` after provisioning.\n"]    pub fn memory_gib_per_vcpu (& self) -> ListRef < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryGibPerVcpuElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.memory_gib_per_vcpu", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `memory_mib` after provisioning.\n"]    pub fn memory_mib (& self) -> ListRef < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElMemoryMibElRef >{
        ListRef::new(self.shared().clone(), format!("{}.memory_mib", self.base))
    }
    #[doc = "Get a reference to the value of field `network_bandwidth_gbps` after provisioning.\n"]    pub fn network_bandwidth_gbps (& self) -> ListRef < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkBandwidthGbpsElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.network_bandwidth_gbps", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `network_interface_count` after provisioning.\n"]    pub fn network_interface_count (& self) -> ListRef < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElNetworkInterfaceCountElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.network_interface_count", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `total_local_storage_gb` after provisioning.\n"]    pub fn total_local_storage_gb (& self) -> ListRef < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElTotalLocalStorageGbElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.total_local_storage_gb", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `vcpu_count` after provisioning.\n"]    pub fn vcpu_count (& self) -> ListRef < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsElVcpuCountElRef >{
...
impl ToListMappable for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElLaunchTemplateSpecificationEl { type O = BlockAssignable < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElLaunchTemplateSpecificationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildAutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElLaunchTemplateSpecificationEl
{}
impl BuildAutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElLaunchTemplateSpecificationEl { pub fn build (self) -> AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElLaunchTemplateSpecificationEl { AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElLaunchTemplateSpecificationEl { launch_template_id : core :: default :: Default :: default () , launch_template_name : core :: default :: Default :: default () , version : core :: default :: Default :: default () , } } }
pub struct AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElLaunchTemplateSpecificationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElLaunchTemplateSpecificationElRef { fn new (shared : StackShared , base : String) -> AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElLaunchTemplateSpecificationElRef { AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElLaunchTemplateSpecificationElRef { shared : shared , base : base . to_string () , } } }
impl
...
#[derive(Serialize, Default)]
struct AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElDynamic { instance_requirements : Option < DynamicBlock < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsEl >> , launch_template_specification : Option < DynamicBlock < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElLaunchTemplateSpecificationEl >> , }
#[derive(Serialize)]
pub struct AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideEl { # [serde (skip_serializing_if = "Option::is_none")] instance_type : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] weighted_capacity : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] instance_requirements : Option < Vec < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsEl > > , # [serde (skip_serializing_if = "Option::is_none")] launch_template_specification : Option < Vec < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElLaunchTemplateSpecificationEl > > , dynamic : AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElDynamic , }
impl AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideEl {
    ...
    pub fn set_instance_requirements(
        mut self,
        v : impl Into < BlockAssignable < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElInstanceRequirementsEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_launch_template_specification(
        mut self,
        v : impl Into < BlockAssignable < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElLaunchTemplateSpecificationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElRef {
    ...
    #[doc = "Get a reference to the value of field `launch_template_specification` after provisioning.\n"]    pub fn launch_template_specification (& self) -> ListRef < AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElLaunchTemplateSpecificationElRef >{
        ListRef::new(
            self.shared().clone(),
...
struct AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElDynamic {
    ...
    >,
    override_:
        Option<DynamicBlock<AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideEl>>,
}
#[derive(Serialize)]
...
impl AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElRef {
    ...
    pub fn override_(
        &self,
    ) -> ListRef<AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElOverrideElRef> {
...
struct AutoscalingGroupMixedInstancesPolicyElDynamic {
    instances_distribution:
        Option<DynamicBlock<AutoscalingGroupMixedInstancesPolicyElInstancesDistributionEl>>,
...
pub struct AutoscalingGroupMixedInstancesPolicyEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    instances_distribution:
        Option<Vec<AutoscalingGroupMixedInstancesPolicyElInstancesDistributionEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl AutoscalingGroupMixedInstancesPolicyElRef {
    ...
    pub fn instances_distribution(
        &self,
    ) -> ListRef<AutoscalingGroupMixedInstancesPolicyElInstancesDistributionElRef> {
        ListRef::new(
            self.shared().clone(),
    ...
    pub fn launch_template(
        &self,
    ) -> ListRef<AutoscalingGroupMixedInstancesPolicyElLaunchTemplateElRef> {
        ListRef::new(
            self.shared().clone(),
...
#[derive(Serialize)]
pub struct AutoscalingGroupTrafficSourceEl {
    identifier: PrimField<String>,
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    type_: Option<PrimField<String>>,
}
impl AutoscalingGroupTrafficSourceEl {
...
impl ToListMappable for AutoscalingGroupTrafficSourceEl {
    type O = BlockAssignable<AutoscalingGroupTrafficSourceEl>;
    fn do_map(self, base: String) -> Self::O {
        BlockAssignable::Dynamic(DynamicBlock {
            for_each: format!("${{{}}}", base),
            iterator: "each".into(),
...
pub struct BuildAutoscalingGroupTrafficSourceEl {
    #[doc = ""]
    pub identifier: PrimField<String>,
}
impl BuildAutoscalingGroupTrafficSourceEl {
    pub fn build(self) -> AutoscalingGroupTrafficSourceEl {
        AutoscalingGroupTrafficSourceEl {
            identifier: self.identifier,
            type_: core::default::Default::default(),
        }
    }
}
pub struct AutoscalingGroupTrafficSourceElRef {
    shared: StackShared,
    base: String,
}
impl Ref for AutoscalingGroupTrafficSourceElRef {
    fn new(shared: StackShared, base: String) -> AutoscalingGroupTrafficSourceElRef {
        AutoscalingGroupTrafficSourceElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
}
impl AutoscalingGroupTrafficSourceElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
impl BuildAutoscalingGroupWarmPoolElInstanceReusePolicyEl {
    pub fn build(self) -> AutoscalingGroupWarmPoolElInstanceReusePolicyEl {
        AutoscalingGroupWarmPoolElInstanceReusePolicyEl {
...
impl AutoscalingGroupWarmPoolElRef {
    ...
    pub fn instance_reuse_policy(
        &self,
    ) -> ListRef<AutoscalingGroupWarmPoolElInstanceReusePolicyElRef> {
        ListRef::new(
            self.shared().clone(),
...
struct AutoscalingGroupDynamic {
    availability_zone_distribution:
        Option<DynamicBlock<AutoscalingGroupAvailabilityZoneDistributionEl>>,
    capacity_reservation_specification:
        Option<DynamicBlock<AutoscalingGroupCapacityReservationSpecificationEl>>,
    initial_lifecycle_hook: Option<DynamicBlock<AutoscalingGroupInitialLifecycleHookEl>>,
    instance_maintenance_policy: Option<DynamicBlock<AutoscalingGroupInstanceMaintenancePolicyEl>>,
    ...
    traffic_source: Option<DynamicBlock<AutoscalingGroupTrafficSourceEl>>,
