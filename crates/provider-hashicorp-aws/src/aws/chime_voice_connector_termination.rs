...
impl ChimeVoiceConnectorTermination {
    ...
    pub fn calling_regions(&self) -> SetRef<PrimExpr<String>> {
        SetRef::new(
            self.shared().clone(),
            format!("{}.calling_regions", self.extract_ref()),
        )
    }
    ...
    pub fn cidr_allow_list(&self) -> SetRef<PrimExpr<String>> {
        SetRef::new(
            self.shared().clone(),
            format!("{}.cidr_allow_list", self.extract_ref()),
        )
    }
    ...
    pub fn cps_limit(&self) -> PrimExpr<f64> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.cps_limit", self.extract_ref()),
        )
    }
    ...
    pub fn default_phone_number(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.default_phone_number", self.extract_ref()),
        )
    }
...
impl Referable for ChimeVoiceConnectorTermination {
