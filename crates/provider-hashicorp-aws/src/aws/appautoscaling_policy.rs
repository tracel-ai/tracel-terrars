...
struct AppautoscalingPolicyData {
    ...
    predictive_scaling_policy_configuration:
        Option<Vec<AppautoscalingPolicyPredictiveScalingPolicyConfigurationEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    step_scaling_policy_configuration:
        Option<Vec<AppautoscalingPolicyStepScalingPolicyConfigurationEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    target_tracking_scaling_policy_configuration:
        Option<Vec<AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationEl>>,
...
impl AppautoscalingPolicy {
        ...
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.0
                    .data
                    .borrow_mut()
                    .predictive_scaling_policy_configuration = Some(v);
            }
            BlockAssignable::Dynamic(d) => {
                self.0
                    ...
                    .borrow_mut()
                    .dynamic
                    .predictive_scaling_policy_configuration = Some(d);
            }
        }
        self
    }
        ...
        match v.into() {
            ...
            BlockAssignable::Dynamic(d) => {
                self.0
                    ...
                    .borrow_mut()
                    .dynamic
                    .step_scaling_policy_configuration = Some(d);
            }
        }
        self
    }
        ...
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.0
                    .data
                    .borrow_mut()
                    .target_tracking_scaling_policy_configuration = Some(v);
            }
            BlockAssignable::Dynamic(d) => {
                self.0
                    .data
                    .borrow_mut()
                    .dynamic
                    .target_tracking_scaling_policy_configuration = Some(d);
            }
        }
        self
    }
    ...
    pub fn alarm_arns(&self) -> ListRef<PrimExpr<String>> {
        ListRef::new(
            self.shared().clone(),
            format!("{}.alarm_arns", self.extract_ref()),
        )
    }
    ...
    pub fn step_scaling_policy_configuration(
        &self,
    ) -> ListRef<AppautoscalingPolicyStepScalingPolicyConfigurationElRef> {
        ListRef::new(
            self.shared().clone(),
            format!("{}.step_scaling_policy_configuration", self.extract_ref()),
        )
    }
...
impl Ref for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionElRef { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `name` after provisioning.\n"] pub fn name (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.name" , self . base)) } # [doc = "Get a reference to the value of field `value` after provisioning.\n"] pub fn value (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.value" , self . base)) } }
#[derive(Serialize, Default)]
struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricElDynamic { dimension : Option < DynamicBlock < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionEl >> , }
#[derive(Serialize)]
pub struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricEl { # [serde (skip_serializing_if = "Option::is_none")] metric_name : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] namespace : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] dimension : Option < Vec < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionEl > > , dynamic : AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricElDynamic , }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricEl { # [doc = "Set the field `metric_name`.\n"] pub fn set_metric_name (mut self , v : impl Into < PrimField < String > >) -> Self { self . metric_name = Some (v . into ()) ; self } # [doc = "Set the field `namespace`.\n"] pub fn set_namespace (mut self , v : impl Into < PrimField < String > >) -> Self { self . namespace = Some (v . into ()) ; self } # [doc = "Set the field `dimension`.\n"] pub fn set_dimension (mut self , v : impl Into < BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . dimension = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . dimension = Some (d) ; } } self } }
impl ToListMappable for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricEl { type O = BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricElRef { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `metric_name` after provisioning.\n"] pub fn metric_name (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.metric_name" , self . base)) } # [doc = "Get a reference to the value of field `namespace` after provisioning.\n"] pub fn namespace (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.namespace" , self . base)) } }
#[derive(Serialize, Default)]
struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElDynamic { metric : Option < DynamicBlock < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricEl >> , }
#[derive(Serialize)]
pub struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatEl { stat : PrimField < String > , # [serde (skip_serializing_if = "Option::is_none")] unit : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] metric : Option < Vec < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricEl > > , dynamic : AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElDynamic , }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatEl { # [doc = "Set the field `unit`.\n"] pub fn set_unit (mut self , v : impl Into < PrimField < String > >) -> Self { self . unit = Some (v . into ()) ; self } # [doc = "Set the field `metric`.\n"] pub fn set_metric (mut self , v : impl Into < BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . metric = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . metric = Some (d) ; } } self } }
impl ToListMappable for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatEl { type O = BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElRef { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `stat` after provisioning.\n"] pub fn stat (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.stat" , self . base)) } # [doc = "Get a reference to the value of field `unit` after provisioning.\n"] pub fn unit (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.unit" , self . base)) } # [doc = "Get a reference to the value of field `metric` after provisioning.\n"] pub fn metric (& self) -> ListRef < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElMetricElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.metric" , self . base)) } }
#[derive(Serialize, Default)]
struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElDynamic { metric_stat : Option < DynamicBlock < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatEl >> , }
#[derive(Serialize)]
pub struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryEl { # [serde (skip_serializing_if = "Option::is_none")] expression : Option < PrimField < String > > , id : PrimField < String > , # [serde (skip_serializing_if = "Option::is_none")] label : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] return_data : Option < PrimField < bool > > , # [serde (skip_serializing_if = "Option::is_none")] metric_stat : Option < Vec < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatEl > > , dynamic : AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElDynamic , }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryEl { # [doc = "Set the field `expression`.\n"] pub fn set_expression (mut self , v : impl Into < PrimField < String > >) -> Self { self . expression = Some (v . into ()) ; self } # [doc = "Set the field `label`.\n"] pub fn set_label (mut self , v : impl Into < PrimField < String > >) -> Self { self . label = Some (v . into ()) ; self } # [doc = "Set the field `return_data`.\n"] pub fn set_return_data (mut self , v : impl Into < PrimField < bool > >) -> Self { self . return_data = Some (v . into ()) ; self } # [doc = "Set the field `metric_stat`.\n"] pub fn set_metric_stat (mut self , v : impl Into < BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . metric_stat = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . metric_stat = Some (d) ; } } self } }
impl ToListMappable for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryEl { type O = BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl BuildAppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryEl { pub fn build (self) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryEl { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryEl { expression : core :: default :: Default :: default () , id : self . id , label : core :: default :: Default :: default () , return_data : core :: default :: Default :: default () , metric_stat : core :: default :: Default :: default () , dynamic : Default :: default () , } } }
...
impl Ref for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElRef { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `expression` after provisioning.\n"] pub fn expression (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.expression" , self . base)) } # [doc = "Get a reference to the value of field `id` after provisioning.\n"] pub fn id (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.id" , self . base)) } # [doc = "Get a reference to the value of field `label` after provisioning.\n"] pub fn label (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.label" , self . base)) } # [doc = "Get a reference to the value of field `return_data` after provisioning.\n"] pub fn return_data (& self) -> PrimExpr < bool > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.return_data" , self . base)) } # [doc = "Get a reference to the value of field `metric_stat` after provisioning.\n"] pub fn metric_stat (& self) -> ListRef < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElMetricStatElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.metric_stat" , self . base)) } }
#[derive(Serialize, Default)]
struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElDynamic { metric_data_query : Option < DynamicBlock < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryEl >> , }
#[derive(Serialize)]
pub struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationEl { # [serde (skip_serializing_if = "Option::is_none")] metric_data_query : Option < Vec < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryEl > > , dynamic : AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElDynamic , }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationEl { # [doc = "Set the field `metric_data_query`.\n"] pub fn set_metric_data_query (mut self , v : impl Into < BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . metric_data_query = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . metric_data_query = Some (d) ; } } self } }
impl ToListMappable for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationEl { type O = BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElRef { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `metric_data_query` after provisioning.\n"] pub fn metric_data_query (& self) -> ListRef < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElMetricDataQueryElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.metric_data_query" , self . base)) } }
#[derive(Serialize)]
...
impl Ref for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionElRef { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `name` after provisioning.\n"] pub fn name (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.name" , self . base)) } # [doc = "Get a reference to the value of field `value` after provisioning.\n"] pub fn value (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.value" , self . base)) } }
#[derive(Serialize, Default)]
struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricElDynamic { dimension : Option < DynamicBlock < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionEl >> , }
#[derive(Serialize)]
pub struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricEl { # [serde (skip_serializing_if = "Option::is_none")] metric_name : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] namespace : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] dimension : Option < Vec < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionEl > > , dynamic : AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricElDynamic , }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricEl { # [doc = "Set the field `metric_name`.\n"] pub fn set_metric_name (mut self , v : impl Into < PrimField < String > >) -> Self { self . metric_name = Some (v . into ()) ; self } # [doc = "Set the field `namespace`.\n"] pub fn set_namespace (mut self , v : impl Into < PrimField < String > >) -> Self { self . namespace = Some (v . into ()) ; self } # [doc = "Set the field `dimension`.\n"] pub fn set_dimension (mut self , v : impl Into < BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . dimension = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . dimension = Some (d) ; } } self } }
impl ToListMappable for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricEl { type O = BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricElRef { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `metric_name` after provisioning.\n"] pub fn metric_name (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.metric_name" , self . base)) } # [doc = "Get a reference to the value of field `namespace` after provisioning.\n"] pub fn namespace (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.namespace" , self . base)) } }
#[derive(Serialize, Default)]
struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElDynamic { metric : Option < DynamicBlock < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricEl >> , }
#[derive(Serialize)]
pub struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatEl { stat : PrimField < String > , # [serde (skip_serializing_if = "Option::is_none")] unit : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] metric : Option < Vec < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricEl > > , dynamic : AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElDynamic , }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatEl { # [doc = "Set the field `unit`.\n"] pub fn set_unit (mut self , v : impl Into < PrimField < String > >) -> Self { self . unit = Some (v . into ()) ; self } # [doc = "Set the field `metric`.\n"] pub fn set_metric (mut self , v : impl Into < BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . metric = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . metric = Some (d) ; } } self } }
impl ToListMappable for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatEl { type O = BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElRef { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `stat` after provisioning.\n"] pub fn stat (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.stat" , self . base)) } # [doc = "Get a reference to the value of field `unit` after provisioning.\n"] pub fn unit (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.unit" , self . base)) } # [doc = "Get a reference to the value of field `metric` after provisioning.\n"] pub fn metric (& self) -> ListRef < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElMetricElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.metric" , self . base)) } }
#[derive(Serialize, Default)]
struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElDynamic { metric_stat : Option < DynamicBlock < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatEl >> , }
#[derive(Serialize)]
pub struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryEl { # [serde (skip_serializing_if = "Option::is_none")] expression : Option < PrimField < String > > , id : PrimField < String > , # [serde (skip_serializing_if = "Option::is_none")] label : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] return_data : Option < PrimField < bool > > , # [serde (skip_serializing_if = "Option::is_none")] metric_stat : Option < Vec < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatEl > > , dynamic : AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElDynamic , }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryEl { # [doc = "Set the field `expression`.\n"] pub fn set_expression (mut self , v : impl Into < PrimField < String > >) -> Self { self . expression = Some (v . into ()) ; self } # [doc = "Set the field `label`.\n"] pub fn set_label (mut self , v : impl Into < PrimField < String > >) -> Self { self . label = Some (v . into ()) ; self } # [doc = "Set the field `return_data`.\n"] pub fn set_return_data (mut self , v : impl Into < PrimField < bool > >) -> Self { self . return_data = Some (v . into ()) ; self } # [doc = "Set the field `metric_stat`.\n"] pub fn set_metric_stat (mut self , v : impl Into < BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . metric_stat = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . metric_stat = Some (d) ; } } self } }
impl ToListMappable for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryEl { type O = BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElRef { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `expression` after provisioning.\n"] pub fn expression (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.expression" , self . base)) } # [doc = "Get a reference to the value of field `id` after provisioning.\n"] pub fn id (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.id" , self . base)) } # [doc = "Get a reference to the value of field `label` after provisioning.\n"] pub fn label (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.label" , self . base)) } # [doc = "Get a reference to the value of field `return_data` after provisioning.\n"] pub fn return_data (& self) -> PrimExpr < bool > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.return_data" , self . base)) } # [doc = "Get a reference to the value of field `metric_stat` after provisioning.\n"] pub fn metric_stat (& self) -> ListRef < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElMetricStatElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.metric_stat" , self . base)) } }
#[derive(Serialize, Default)]
struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElDynamic { metric_data_query : Option < DynamicBlock < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryEl >> , }
#[derive(Serialize)]
pub struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationEl { # [serde (skip_serializing_if = "Option::is_none")] metric_data_query : Option < Vec < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryEl > > , dynamic : AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElDynamic , }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationEl { # [doc = "Set the field `metric_data_query`.\n"] pub fn set_metric_data_query (mut self , v : impl Into < BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . metric_data_query = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . metric_data_query = Some (d) ; } } self } }
impl ToListMappable for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationEl { type O = BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
{}
impl BuildAppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationEl { pub fn build (self) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationEl { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationEl { metric_data_query : core :: default :: Default :: default () , dynamic : Default :: default () , } } }
...
impl Ref for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElRef { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `metric_data_query` after provisioning.\n"] pub fn metric_data_query (& self) -> ListRef < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElMetricDataQueryElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.metric_data_query" , self . base)) } }
#[derive(Serialize)]
...
impl Ref for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionElRef { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `name` after provisioning.\n"] pub fn name (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.name" , self . base)) } # [doc = "Get a reference to the value of field `value` after provisioning.\n"] pub fn value (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.value" , self . base)) } }
#[derive(Serialize, Default)]
struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricElDynamic { dimension : Option < DynamicBlock < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionEl >> , }
#[derive(Serialize)]
pub struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricEl { # [serde (skip_serializing_if = "Option::is_none")] metric_name : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] namespace : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] dimension : Option < Vec < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionEl > > , dynamic : AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricElDynamic , }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricEl { # [doc = "Set the field `metric_name`.\n"] pub fn set_metric_name (mut self , v : impl Into < PrimField < String > >) -> Self { self . metric_name = Some (v . into ()) ; self } # [doc = "Set the field `namespace`.\n"] pub fn set_namespace (mut self , v : impl Into < PrimField < String > >) -> Self { self . namespace = Some (v . into ()) ; self } # [doc = "Set the field `dimension`.\n"] pub fn set_dimension (mut self , v : impl Into < BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricElDimensionEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . dimension = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . dimension = Some (d) ; } } self } }
impl ToListMappable for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricEl { type O = BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricElRef { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `metric_name` after provisioning.\n"] pub fn metric_name (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.metric_name" , self . base)) } # [doc = "Get a reference to the value of field `namespace` after provisioning.\n"] pub fn namespace (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.namespace" , self . base)) } }
#[derive(Serialize, Default)]
struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElDynamic { metric : Option < DynamicBlock < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricEl >> , }
#[derive(Serialize)]
pub struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatEl { stat : PrimField < String > , # [serde (skip_serializing_if = "Option::is_none")] unit : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] metric : Option < Vec < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricEl > > , dynamic : AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElDynamic , }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatEl { # [doc = "Set the field `unit`.\n"] pub fn set_unit (mut self , v : impl Into < PrimField < String > >) -> Self { self . unit = Some (v . into ()) ; self } # [doc = "Set the field `metric`.\n"] pub fn set_metric (mut self , v : impl Into < BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . metric = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . metric = Some (d) ; } } self } }
impl ToListMappable for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatEl { type O = BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElRef { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `stat` after provisioning.\n"] pub fn stat (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.stat" , self . base)) } # [doc = "Get a reference to the value of field `unit` after provisioning.\n"] pub fn unit (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.unit" , self . base)) } # [doc = "Get a reference to the value of field `metric` after provisioning.\n"] pub fn metric (& self) -> ListRef < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElMetricElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.metric" , self . base)) } }
#[derive(Serialize, Default)]
struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElDynamic { metric_stat : Option < DynamicBlock < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatEl >> , }
#[derive(Serialize)]
pub struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryEl { # [serde (skip_serializing_if = "Option::is_none")] expression : Option < PrimField < String > > , id : PrimField < String > , # [serde (skip_serializing_if = "Option::is_none")] label : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] return_data : Option < PrimField < bool > > , # [serde (skip_serializing_if = "Option::is_none")] metric_stat : Option < Vec < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatEl > > , dynamic : AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElDynamic , }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryEl { # [doc = "Set the field `expression`.\n"] pub fn set_expression (mut self , v : impl Into < PrimField < String > >) -> Self { self . expression = Some (v . into ()) ; self } # [doc = "Set the field `label`.\n"] pub fn set_label (mut self , v : impl Into < PrimField < String > >) -> Self { self . label = Some (v . into ()) ; self } # [doc = "Set the field `return_data`.\n"] pub fn set_return_data (mut self , v : impl Into < PrimField < bool > >) -> Self { self . return_data = Some (v . into ()) ; self } # [doc = "Set the field `metric_stat`.\n"] pub fn set_metric_stat (mut self , v : impl Into < BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . metric_stat = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . metric_stat = Some (d) ; } } self } }
impl ToListMappable for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryEl { type O = BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElRef { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `expression` after provisioning.\n"] pub fn expression (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.expression" , self . base)) } # [doc = "Get a reference to the value of field `id` after provisioning.\n"] pub fn id (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.id" , self . base)) } # [doc = "Get a reference to the value of field `label` after provisioning.\n"] pub fn label (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.label" , self . base)) } # [doc = "Get a reference to the value of field `return_data` after provisioning.\n"] pub fn return_data (& self) -> PrimExpr < bool > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.return_data" , self . base)) } # [doc = "Get a reference to the value of field `metric_stat` after provisioning.\n"] pub fn metric_stat (& self) -> ListRef < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElMetricStatElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.metric_stat" , self . base)) } }
#[derive(Serialize, Default)]
struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElDynamic { metric_data_query : Option < DynamicBlock < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryEl >> , }
#[derive(Serialize)]
pub struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationEl { # [serde (skip_serializing_if = "Option::is_none")] metric_data_query : Option < Vec < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryEl > > , dynamic : AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElDynamic , }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationEl { # [doc = "Set the field `metric_data_query`.\n"] pub fn set_metric_data_query (mut self , v : impl Into < BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . metric_data_query = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . metric_data_query = Some (d) ; } } self } }
impl ToListMappable for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationEl { type O = BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElRef { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `metric_data_query` after provisioning.\n"] pub fn metric_data_query (& self) -> ListRef < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElMetricDataQueryElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.metric_data_query" , self . base)) } }
#[derive(Serialize)]
...
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedLoadMetricSpecificationEl { # [doc = "Set the field `resource_label`.\n"] pub fn set_resource_label (mut self , v : impl Into < PrimField < String > >) -> Self { self . resource_label = Some (v . into ()) ; self } }
impl ToListMappable for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedLoadMetricSpecificationEl { type O = BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedLoadMetricSpecificationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl BuildAppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedLoadMetricSpecificationEl { pub fn build (self) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedLoadMetricSpecificationEl { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedLoadMetricSpecificationEl { predefined_metric_type : self . predefined_metric_type , resource_label : core :: default :: Default :: default () , } } }
...
impl Ref for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedLoadMetricSpecificationElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedLoadMetricSpecificationElRef { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedLoadMetricSpecificationElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedLoadMetricSpecificationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `predefined_metric_type` after provisioning.\n"] pub fn predefined_metric_type (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.predefined_metric_type" , self . base)) } # [doc = "Get a reference to the value of field `resource_label` after provisioning.\n"] pub fn resource_label (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.resource_label" , self . base)) } }
#[derive(Serialize)]
...
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedMetricPairSpecificationEl { # [doc = "Set the field `resource_label`.\n"] pub fn set_resource_label (mut self , v : impl Into < PrimField < String > >) -> Self { self . resource_label = Some (v . into ()) ; self } }
impl ToListMappable for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedMetricPairSpecificationEl { type O = BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedMetricPairSpecificationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedMetricPairSpecificationElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedMetricPairSpecificationElRef { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedMetricPairSpecificationElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedMetricPairSpecificationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `predefined_metric_type` after provisioning.\n"] pub fn predefined_metric_type (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.predefined_metric_type" , self . base)) } # [doc = "Get a reference to the value of field `resource_label` after provisioning.\n"] pub fn resource_label (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.resource_label" , self . base)) } }
#[derive(Serialize)]
...
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedScalingMetricSpecificationEl { # [doc = "Set the field `resource_label`.\n"] pub fn set_resource_label (mut self , v : impl Into < PrimField < String > >) -> Self { self . resource_label = Some (v . into ()) ; self } }
impl ToListMappable for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedScalingMetricSpecificationEl { type O = BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedScalingMetricSpecificationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl BuildAppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedScalingMetricSpecificationEl { pub fn build (self) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedScalingMetricSpecificationEl { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedScalingMetricSpecificationEl { predefined_metric_type : self . predefined_metric_type , resource_label : core :: default :: Default :: default () , } } }
...
impl Ref for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedScalingMetricSpecificationElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedScalingMetricSpecificationElRef { AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedScalingMetricSpecificationElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedScalingMetricSpecificationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `predefined_metric_type` after provisioning.\n"] pub fn predefined_metric_type (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.predefined_metric_type" , self . base)) } # [doc = "Get a reference to the value of field `resource_label` after provisioning.\n"] pub fn resource_label (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.resource_label" , self . base)) } }
#[derive(Serialize, Default)]
struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElDynamic { customized_capacity_metric_specification : Option < DynamicBlock < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationEl >> , customized_load_metric_specification : Option < DynamicBlock < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationEl >> , customized_scaling_metric_specification : Option < DynamicBlock < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationEl >> , predefined_load_metric_specification : Option < DynamicBlock < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedLoadMetricSpecificationEl >> , predefined_metric_pair_specification : Option < DynamicBlock < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedMetricPairSpecificationEl >> , predefined_scaling_metric_specification : Option < DynamicBlock < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedScalingMetricSpecificationEl >> , }
#[derive(Serialize)]
pub struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationEl { target_value : PrimField < String > , # [serde (skip_serializing_if = "Option::is_none")] customized_capacity_metric_specification : Option < Vec < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationEl > > , # [serde (skip_serializing_if = "Option::is_none")] customized_load_metric_specification : Option < Vec < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationEl > > , # [serde (skip_serializing_if = "Option::is_none")] customized_scaling_metric_specification : Option < Vec < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationEl > > , # [serde (skip_serializing_if = "Option::is_none")] predefined_load_metric_specification : Option < Vec < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedLoadMetricSpecificationEl > > , # [serde (skip_serializing_if = "Option::is_none")] predefined_metric_pair_specification : Option < Vec < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedMetricPairSpecificationEl > > , # [serde (skip_serializing_if = "Option::is_none")] predefined_scaling_metric_specification : Option < Vec < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedScalingMetricSpecificationEl > > , dynamic : AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElDynamic , }
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationEl {
    ...
    pub fn set_customized_capacity_metric_specification(
        mut self,
        v : impl Into < BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_customized_load_metric_specification(
        mut self,
        v : impl Into < BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_customized_scaling_metric_specification(
        mut self,
        v : impl Into < BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_predefined_load_metric_specification(
        mut self,
        v : impl Into < BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedLoadMetricSpecificationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_predefined_metric_pair_specification(
        mut self,
        v : impl Into < BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedMetricPairSpecificationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_predefined_scaling_metric_specification(
        mut self,
        v : impl Into < BlockAssignable < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedScalingMetricSpecificationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl ToListMappable
    for AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationEl
{
...
impl AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElRef {
    ...
    #[doc = "Get a reference to the value of field `customized_capacity_metric_specification` after provisioning.\n"]    pub fn customized_capacity_metric_specification (& self) -> ListRef < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedCapacityMetricSpecificationElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.customized_capacity_metric_specification", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `customized_load_metric_specification` after provisioning.\n"]    pub fn customized_load_metric_specification (& self) -> ListRef < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedLoadMetricSpecificationElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.customized_load_metric_specification", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `customized_scaling_metric_specification` after provisioning.\n"]    pub fn customized_scaling_metric_specification (& self) -> ListRef < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElCustomizedScalingMetricSpecificationElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.customized_scaling_metric_specification", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `predefined_load_metric_specification` after provisioning.\n"]    pub fn predefined_load_metric_specification (& self) -> ListRef < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedLoadMetricSpecificationElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.predefined_load_metric_specification", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `predefined_metric_pair_specification` after provisioning.\n"]    pub fn predefined_metric_pair_specification (& self) -> ListRef < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedMetricPairSpecificationElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.predefined_metric_pair_specification", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `predefined_scaling_metric_specification` after provisioning.\n"]    pub fn predefined_scaling_metric_specification (& self) -> ListRef < AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationElPredefinedScalingMetricSpecificationElRef >{
        ListRef::new(
            self.shared().clone(),
...
pub struct AppautoscalingPolicyPredictiveScalingPolicyConfigurationEl {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    metric_specification: Option<
        Vec<AppautoscalingPolicyPredictiveScalingPolicyConfigurationElMetricSpecificationEl>,
    >,
...
struct AppautoscalingPolicyStepScalingPolicyConfigurationElDynamic {
    step_adjustment:
        Option<DynamicBlock<AppautoscalingPolicyStepScalingPolicyConfigurationElStepAdjustmentEl>>,
}
#[derive(Serialize)]
pub struct AppautoscalingPolicyStepScalingPolicyConfigurationEl {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    step_adjustment:
        Option<Vec<AppautoscalingPolicyStepScalingPolicyConfigurationElStepAdjustmentEl>>,
...
impl AppautoscalingPolicyStepScalingPolicyConfigurationEl {
    ...
    pub fn set_step_adjustment(
        mut self,
        v: impl Into<
            BlockAssignable<AppautoscalingPolicyStepScalingPolicyConfigurationElStepAdjustmentEl>,
        >,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl AppautoscalingPolicyStepScalingPolicyConfigurationElRef {
    ...
    pub fn adjustment_type(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.adjustment_type", self.base),
        )
    }
    ...
    pub fn metric_aggregation_type(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.metric_aggregation_type", self.base),
        )
    }
    ...
    pub fn min_adjustment_magnitude(&self) -> PrimExpr<f64> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.min_adjustment_magnitude", self.base),
        )
    }
}
#[derive(Serialize)]
...
impl BuildAppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElDimensionsEl { pub fn build (self) -> AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElDimensionsEl { AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElDimensionsEl { name : self . name , value : self . value , } } }
pub struct AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElDimensionsElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElDimensionsElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElDimensionsElRef { AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElDimensionsElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElDimensionsElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `name` after provisioning.\n"] pub fn name (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.name" , self . base)) } # [doc = "Get a reference to the value of field `value` after provisioning.\n"] pub fn value (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.value" , self . base)) } }
#[derive(Serialize)]
...
impl Ref for AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricElDimensionsElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricElDimensionsElRef { AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricElDimensionsElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricElDimensionsElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `name` after provisioning.\n"] pub fn name (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.name" , self . base)) } # [doc = "Get a reference to the value of field `value` after provisioning.\n"] pub fn value (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.value" , self . base)) } }
#[derive(Serialize, Default)]
struct AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricElDynamic { dimensions : Option < DynamicBlock < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricElDimensionsEl >> , }
#[derive(Serialize)]
pub struct AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricEl { metric_name : PrimField < String > , namespace : PrimField < String > , # [serde (skip_serializing_if = "Option::is_none")] dimensions : Option < Vec < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricElDimensionsEl > > , dynamic : AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricElDynamic , }
impl AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricEl { # [doc = "Set the field `dimensions`.\n"] pub fn set_dimensions (mut self , v : impl Into < BlockAssignable < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricElDimensionsEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . dimensions = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . dimensions = Some (d) ; } } self } }
impl ToListMappable for AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricEl { type O = BlockAssignable < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl BuildAppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricEl { pub fn build (self) -> AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricEl { AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricEl { metric_name : self . metric_name , namespace : self . namespace , dimensions : core :: default :: Default :: default () , dynamic : Default :: default () , } } }
...
impl Ref for AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricElRef { AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `metric_name` after provisioning.\n"] pub fn metric_name (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.metric_name" , self . base)) } # [doc = "Get a reference to the value of field `namespace` after provisioning.\n"] pub fn namespace (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.namespace" , self . base)) } }
#[derive(Serialize, Default)]
struct AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElDynamic { metric : Option < DynamicBlock < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricEl >> , }
#[derive(Serialize)]
pub struct AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatEl { stat : PrimField < String > , # [serde (skip_serializing_if = "Option::is_none")] unit : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] metric : Option < Vec < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricEl > > , dynamic : AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElDynamic , }
impl AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatEl { # [doc = "Set the field `unit`.\n"] pub fn set_unit (mut self , v : impl Into < PrimField < String > >) -> Self { self . unit = Some (v . into ()) ; self } # [doc = "Set the field `metric`.\n"] pub fn set_metric (mut self , v : impl Into < BlockAssignable < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . metric = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . metric = Some (d) ; } } self } }
impl ToListMappable for AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatEl { type O = BlockAssignable < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElRef { AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `stat` after provisioning.\n"] pub fn stat (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.stat" , self . base)) } # [doc = "Get a reference to the value of field `unit` after provisioning.\n"] pub fn unit (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.unit" , self . base)) } # [doc = "Get a reference to the value of field `metric` after provisioning.\n"] pub fn metric (& self) -> ListRef < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElMetricElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.metric" , self . base)) } }
#[derive(Serialize, Default)]
struct AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElDynamic { metric_stat : Option < DynamicBlock < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatEl >> , }
#[derive(Serialize)]
pub struct AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsEl { # [serde (skip_serializing_if = "Option::is_none")] expression : Option < PrimField < String > > , id : PrimField < String > , # [serde (skip_serializing_if = "Option::is_none")] label : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] return_data : Option < PrimField < bool > > , # [serde (skip_serializing_if = "Option::is_none")] metric_stat : Option < Vec < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatEl > > , dynamic : AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElDynamic , }
impl AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsEl { # [doc = "Set the field `expression`.\n"] pub fn set_expression (mut self , v : impl Into < PrimField < String > >) -> Self { self . expression = Some (v . into ()) ; self } # [doc = "Set the field `label`.\n"] pub fn set_label (mut self , v : impl Into < PrimField < String > >) -> Self { self . label = Some (v . into ()) ; self } # [doc = "Set the field `return_data`.\n"] pub fn set_return_data (mut self , v : impl Into < PrimField < bool > >) -> Self { self . return_data = Some (v . into ()) ; self } # [doc = "Set the field `metric_stat`.\n"] pub fn set_metric_stat (mut self , v : impl Into < BlockAssignable < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . metric_stat = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . metric_stat = Some (d) ; } } self } }
impl ToListMappable for AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsEl { type O = BlockAssignable < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildAppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsEl
{
    #[doc = ""]
    pub id: PrimField<String>,
}
impl BuildAppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsEl { pub fn build (self) -> AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsEl { AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsEl { expression : core :: default :: Default :: default () , id : self . id , label : core :: default :: Default :: default () , return_data : core :: default :: Default :: default () , metric_stat : core :: default :: Default :: default () , dynamic : Default :: default () , } } }
pub struct AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElRef { AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElRef { shared : shared , base : base . to_string () , } } }
impl AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `expression` after provisioning.\n"] pub fn expression (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.expression" , self . base)) } # [doc = "Get a reference to the value of field `id` after provisioning.\n"] pub fn id (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.id" , self . base)) } # [doc = "Get a reference to the value of field `label` after provisioning.\n"] pub fn label (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.label" , self . base)) } # [doc = "Get a reference to the value of field `return_data` after provisioning.\n"] pub fn return_data (& self) -> PrimExpr < bool > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.return_data" , self . base)) } # [doc = "Get a reference to the value of field `metric_stat` after provisioning.\n"] pub fn metric_stat (& self) -> ListRef < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsElMetricStatElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.metric_stat" , self . base)) } }
#[derive(Serialize, Default)]
struct AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElDynamic { dimensions : Option < DynamicBlock < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElDimensionsEl >> , metrics : Option < DynamicBlock < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsEl >> , }
#[derive(Serialize)]
pub struct AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationEl { # [serde (skip_serializing_if = "Option::is_none")] metric_name : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] namespace : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] statistic : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] unit : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] dimensions : Option < Vec < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElDimensionsEl > > , # [serde (skip_serializing_if = "Option::is_none")] metrics : Option < Vec < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsEl > > , dynamic : AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElDynamic , }
impl AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationEl {
    ...
    pub fn set_dimensions(
        mut self,
        v : impl Into < BlockAssignable < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElDimensionsEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_metrics(
        mut self,
        v : impl Into < BlockAssignable < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElMetricsEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.metrics = Some(v);
...
impl ToListMappable for AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationEl { type O = BlockAssignable < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildAppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationEl
{}
impl BuildAppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationEl { pub fn build (self) -> AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationEl { AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationEl { metric_name : core :: default :: Default :: default () , namespace : core :: default :: Default :: default () , statistic : core :: default :: Default :: default () , unit : core :: default :: Default :: default () , dimensions : core :: default :: Default :: default () , metrics : core :: default :: Default :: default () , dynamic : Default :: default () , } } }
pub struct AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElRef { fn new (shared : StackShared , base : String) -> AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElRef { AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElRef { shared : shared , base : base . to_string () , } } }
impl
...
#[derive(Serialize, Default)]
struct AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElDynamic { customized_metric_specification : Option < DynamicBlock < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationEl >> , predefined_metric_specification : Option < DynamicBlock < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElPredefinedMetricSpecificationEl >> , }
#[derive(Serialize)]
pub struct AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationEl { # [serde (skip_serializing_if = "Option::is_none")] disable_scale_in : Option < PrimField < bool > > , # [serde (skip_serializing_if = "Option::is_none")] scale_in_cooldown : Option < PrimField < f64 > > , # [serde (skip_serializing_if = "Option::is_none")] scale_out_cooldown : Option < PrimField < f64 > > , target_value : PrimField < f64 > , # [serde (skip_serializing_if = "Option::is_none")] customized_metric_specification : Option < Vec < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationEl > > , # [serde (skip_serializing_if = "Option::is_none")] predefined_metric_specification : Option < Vec < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElPredefinedMetricSpecificationEl > > , dynamic : AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElDynamic , }
impl AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationEl {
    ...
    pub fn set_customized_metric_specification(
        mut self,
        v : impl Into < BlockAssignable < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_predefined_metric_specification(
        mut self,
        v : impl Into < BlockAssignable < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElPredefinedMetricSpecificationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElRef {
    ...
    #[doc = "Get a reference to the value of field `customized_metric_specification` after provisioning.\n"]    pub fn customized_metric_specification (& self) -> ListRef < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElCustomizedMetricSpecificationElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.customized_metric_specification", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `predefined_metric_specification` after provisioning.\n"]    pub fn predefined_metric_specification (& self) -> ListRef < AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationElPredefinedMetricSpecificationElRef >{
        ListRef::new(
            self.shared().clone(),
...
struct AppautoscalingPolicyDynamic {
    predictive_scaling_policy_configuration:
        Option<DynamicBlock<AppautoscalingPolicyPredictiveScalingPolicyConfigurationEl>>,
    step_scaling_policy_configuration:
        Option<DynamicBlock<AppautoscalingPolicyStepScalingPolicyConfigurationEl>>,
    target_tracking_scaling_policy_configuration:
        Option<DynamicBlock<AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationEl>>,
}
