...
impl SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl { # [doc = "Set the field `idle_timeout_in_minutes`.\n"] pub fn set_idle_timeout_in_minutes (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . idle_timeout_in_minutes = Some (v . into ()) ; self } # [doc = "Set the field `lifecycle_management`.\n"] pub fn set_lifecycle_management (mut self , v : impl Into < PrimField < String > >) -> Self { self . lifecycle_management = Some (v . into ()) ; self } # [doc = "Set the field `max_idle_timeout_in_minutes`.\n"] pub fn set_max_idle_timeout_in_minutes (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . max_idle_timeout_in_minutes = Some (v . into ()) ; self } # [doc = "Set the field `min_idle_timeout_in_minutes`.\n"] pub fn set_min_idle_timeout_in_minutes (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . min_idle_timeout_in_minutes = Some (v . into ()) ; self } }
impl ToListMappable for SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl { type O = BlockAssignable < SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildSagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl
{}
impl BuildSagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl { pub fn build (self) -> SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl { SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl { idle_timeout_in_minutes : core :: default :: Default :: default () , lifecycle_management : core :: default :: Default :: default () , max_idle_timeout_in_minutes : core :: default :: Default :: default () , min_idle_timeout_in_minutes : core :: default :: Default :: default () , } } }
pub struct SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsElRef { fn new (shared : StackShared , base : String) -> SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsElRef { SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsElRef { shared : shared , base : base . to_string () , } } }
impl SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `idle_timeout_in_minutes` after provisioning.\n"] pub fn idle_timeout_in_minutes (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.idle_timeout_in_minutes" , self . base)) } # [doc = "Get a reference to the value of field `lifecycle_management` after provisioning.\n"] pub fn lifecycle_management (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.lifecycle_management" , self . base)) } # [doc = "Get a reference to the value of field `max_idle_timeout_in_minutes` after provisioning.\n"] pub fn max_idle_timeout_in_minutes (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.max_idle_timeout_in_minutes" , self . base)) } # [doc = "Get a reference to the value of field `min_idle_timeout_in_minutes` after provisioning.\n"] pub fn min_idle_timeout_in_minutes (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.min_idle_timeout_in_minutes" , self . base)) } }
#[derive(Serialize, Default)]
struct SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementElDynamic { idle_settings : Option < DynamicBlock < SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl >> , }
#[derive(Serialize)]
pub struct SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementEl { # [serde (skip_serializing_if = "Option::is_none")] idle_settings : Option < Vec < SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl > > , dynamic : SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementElDynamic , }
impl SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementEl {
    ...
    pub fn set_idle_settings(
        mut self,
        v : impl Into < BlockAssignable < SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementElRef {
    ...
    #[doc = "Get a reference to the value of field `idle_settings` after provisioning.\n"]    pub fn idle_settings (& self) -> ListRef < SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsElRef >{
        ListRef::new(
            self.shared().clone(),
...
impl SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsEl {
    ...
    pub fn set_app_lifecycle_management(
        mut self,
        v : impl Into < BlockAssignable < SagemakerDomainDefaultSpaceSettingsElJupyterLabAppSettingsElAppLifecycleManagementEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl SagemakerDomainDefaultSpaceSettingsElJupyterServerAppSettingsEl {
    ...
    pub fn set_default_resource_spec(
        mut self,
        v : impl Into < BlockAssignable < SagemakerDomainDefaultSpaceSettingsElJupyterServerAppSettingsElDefaultResourceSpecEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.default_resource_spec = Some(v);
...
impl SagemakerDomainDefaultSpaceSettingsElKernelGatewayAppSettingsEl {
    ...
    pub fn set_default_resource_spec(
        mut self,
        v : impl Into < BlockAssignable < SagemakerDomainDefaultSpaceSettingsElKernelGatewayAppSettingsElDefaultResourceSpecEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.default_resource_spec = Some(v);
...
impl SagemakerDomainDefaultSpaceSettingsElSpaceStorageSettingsEl {
    ...
    pub fn set_default_ebs_storage_settings(
        mut self,
        v : impl Into < BlockAssignable < SagemakerDomainDefaultSpaceSettingsElSpaceStorageSettingsElDefaultEbsStorageSettingsEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl SagemakerDomainDefaultUserSettingsElCanvasAppSettingsEl {
    ...
    pub fn set_identity_provider_oauth_settings(
        mut self,
        v : impl Into < BlockAssignable < SagemakerDomainDefaultUserSettingsElCanvasAppSettingsElIdentityProviderOauthSettingsEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_time_series_forecasting_settings(
        mut self,
        v : impl Into < BlockAssignable < SagemakerDomainDefaultUserSettingsElCanvasAppSettingsElTimeSeriesForecastingSettingsEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl SagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElIdleSettingsEl { # [doc = "Set the field `idle_timeout_in_minutes`.\n"] pub fn set_idle_timeout_in_minutes (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . idle_timeout_in_minutes = Some (v . into ()) ; self } # [doc = "Set the field `lifecycle_management`.\n"] pub fn set_lifecycle_management (mut self , v : impl Into < PrimField < String > >) -> Self { self . lifecycle_management = Some (v . into ()) ; self } # [doc = "Set the field `max_idle_timeout_in_minutes`.\n"] pub fn set_max_idle_timeout_in_minutes (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . max_idle_timeout_in_minutes = Some (v . into ()) ; self } # [doc = "Set the field `min_idle_timeout_in_minutes`.\n"] pub fn set_min_idle_timeout_in_minutes (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . min_idle_timeout_in_minutes = Some (v . into ()) ; self } }
impl ToListMappable for SagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElIdleSettingsEl { type O = BlockAssignable < SagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElIdleSettingsEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildSagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElIdleSettingsEl
{}
impl BuildSagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElIdleSettingsEl { pub fn build (self) -> SagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElIdleSettingsEl { SagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElIdleSettingsEl { idle_timeout_in_minutes : core :: default :: Default :: default () , lifecycle_management : core :: default :: Default :: default () , max_idle_timeout_in_minutes : core :: default :: Default :: default () , min_idle_timeout_in_minutes : core :: default :: Default :: default () , } } }
pub struct SagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElIdleSettingsElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for SagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElIdleSettingsElRef { fn new (shared : StackShared , base : String) -> SagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElIdleSettingsElRef { SagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElIdleSettingsElRef { shared : shared , base : base . to_string () , } } }
impl SagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElIdleSettingsElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `idle_timeout_in_minutes` after provisioning.\n"] pub fn idle_timeout_in_minutes (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.idle_timeout_in_minutes" , self . base)) } # [doc = "Get a reference to the value of field `lifecycle_management` after provisioning.\n"] pub fn lifecycle_management (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.lifecycle_management" , self . base)) } # [doc = "Get a reference to the value of field `max_idle_timeout_in_minutes` after provisioning.\n"] pub fn max_idle_timeout_in_minutes (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.max_idle_timeout_in_minutes" , self . base)) } # [doc = "Get a reference to the value of field `min_idle_timeout_in_minutes` after provisioning.\n"] pub fn min_idle_timeout_in_minutes (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.min_idle_timeout_in_minutes" , self . base)) } }
#[derive(Serialize, Default)]
struct SagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElDynamic { idle_settings : Option < DynamicBlock < SagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElIdleSettingsEl >> , }
#[derive(Serialize)]
pub struct SagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementEl { # [serde (skip_serializing_if = "Option::is_none")] idle_settings : Option < Vec < SagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElIdleSettingsEl > > , dynamic : SagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElDynamic , }
impl SagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementEl {
    #[doc = "Set the field `idle_settings`.\n"]
    pub fn set_idle_settings(
        mut self,
        v : impl Into < BlockAssignable < SagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElIdleSettingsEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.idle_settings = Some(v);
...
impl SagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElRef {
    ...
    #[doc = "Get a reference to the value of field `idle_settings` after provisioning.\n"]    pub fn idle_settings (& self) -> ListRef < SagemakerDomainDefaultUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElIdleSettingsElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.idle_settings", self.base),
        )
...
impl SagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl { # [doc = "Set the field `idle_timeout_in_minutes`.\n"] pub fn set_idle_timeout_in_minutes (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . idle_timeout_in_minutes = Some (v . into ()) ; self } # [doc = "Set the field `lifecycle_management`.\n"] pub fn set_lifecycle_management (mut self , v : impl Into < PrimField < String > >) -> Self { self . lifecycle_management = Some (v . into ()) ; self } # [doc = "Set the field `max_idle_timeout_in_minutes`.\n"] pub fn set_max_idle_timeout_in_minutes (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . max_idle_timeout_in_minutes = Some (v . into ()) ; self } # [doc = "Set the field `min_idle_timeout_in_minutes`.\n"] pub fn set_min_idle_timeout_in_minutes (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . min_idle_timeout_in_minutes = Some (v . into ()) ; self } }
impl ToListMappable for SagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl { type O = BlockAssignable < SagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildSagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl
{}
impl BuildSagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl { pub fn build (self) -> SagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl { SagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl { idle_timeout_in_minutes : core :: default :: Default :: default () , lifecycle_management : core :: default :: Default :: default () , max_idle_timeout_in_minutes : core :: default :: Default :: default () , min_idle_timeout_in_minutes : core :: default :: Default :: default () , } } }
pub struct SagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for SagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsElRef { fn new (shared : StackShared , base : String) -> SagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsElRef { SagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsElRef { shared : shared , base : base . to_string () , } } }
impl SagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `idle_timeout_in_minutes` after provisioning.\n"] pub fn idle_timeout_in_minutes (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.idle_timeout_in_minutes" , self . base)) } # [doc = "Get a reference to the value of field `lifecycle_management` after provisioning.\n"] pub fn lifecycle_management (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.lifecycle_management" , self . base)) } # [doc = "Get a reference to the value of field `max_idle_timeout_in_minutes` after provisioning.\n"] pub fn max_idle_timeout_in_minutes (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.max_idle_timeout_in_minutes" , self . base)) } # [doc = "Get a reference to the value of field `min_idle_timeout_in_minutes` after provisioning.\n"] pub fn min_idle_timeout_in_minutes (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.min_idle_timeout_in_minutes" , self . base)) } }
#[derive(Serialize, Default)]
struct SagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElDynamic { idle_settings : Option < DynamicBlock < SagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl >> , }
#[derive(Serialize)]
pub struct SagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementEl { # [serde (skip_serializing_if = "Option::is_none")] idle_settings : Option < Vec < SagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl > > , dynamic : SagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElDynamic , }
impl SagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementEl {
    #[doc = "Set the field `idle_settings`.\n"]
    pub fn set_idle_settings(
        mut self,
        v : impl Into < BlockAssignable < SagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.idle_settings = Some(v);
...
impl SagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElRef {
    ...
    #[doc = "Get a reference to the value of field `idle_settings` after provisioning.\n"]    pub fn idle_settings (& self) -> ListRef < SagemakerDomainDefaultUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.idle_settings", self.base),
        )
...
impl SagemakerDomainDefaultUserSettingsElSpaceStorageSettingsEl {
    ...
    pub fn set_default_ebs_storage_settings(
        mut self,
        v : impl Into < BlockAssignable < SagemakerDomainDefaultUserSettingsElSpaceStorageSettingsElDefaultEbsStorageSettingsEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.default_ebs_storage_settings = Some(v);
...
impl SagemakerDomainDomainSettingsElRStudioServerProDomainSettingsEl {
    ...
    pub fn set_default_resource_spec(
        mut self,
        v : impl Into < BlockAssignable < SagemakerDomainDomainSettingsElRStudioServerProDomainSettingsElDefaultResourceSpecEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.default_resource_spec = Some(v);
