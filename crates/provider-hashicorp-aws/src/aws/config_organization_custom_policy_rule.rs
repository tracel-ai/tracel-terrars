...
struct ConfigOrganizationCustomPolicyRuleData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    debug_log_delivery_accounts: Option<SetField<PrimField<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    timeouts: Option<ConfigOrganizationCustomPolicyRuleTimeoutsEl>,
}

struct ConfigOrganizationCustomPolicyRule_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<ConfigOrganizationCustomPolicyRuleData>,
}

#[derive(Clone)]
pub struct ConfigOrganizationCustomPolicyRule(Rc<ConfigOrganizationCustomPolicyRule_>);

impl ConfigOrganizationCustomPolicyRule {
    ...
    pub fn set_timeouts(self, v: impl Into<ConfigOrganizationCustomPolicyRuleTimeoutsEl>) -> Self {
    ...
    pub fn timeouts(&self) -> ConfigOrganizationCustomPolicyRuleTimeoutsElRef {
        ConfigOrganizationCustomPolicyRuleTimeoutsElRef::new(
            self.shared().clone(),
...
impl Resource_ for ConfigOrganizationCustomPolicyRule_ {
    fn extract_resource_type(&self) -> String {
        "aws_config_organization_custom_policy_rule".into()
    }
...
pub struct BuildConfigOrganizationCustomPolicyRule {
    pub tf_id: String,
    #[doc = ""]
...
pub struct ConfigOrganizationCustomPolicyRuleRef {
    shared: StackShared,
    base: String,
}
...
impl ConfigOrganizationCustomPolicyRuleRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
...
#[derive(Serialize)]
pub struct ConfigOrganizationCustomPolicyRuleTimeoutsEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl ConfigOrganizationCustomPolicyRuleTimeoutsEl {
...
impl ToListMappable for ConfigOrganizationCustomPolicyRuleTimeoutsEl {
    type O = BlockAssignable<ConfigOrganizationCustomPolicyRuleTimeoutsEl>;
...
pub struct BuildConfigOrganizationCustomPolicyRuleTimeoutsEl {}

impl BuildConfigOrganizationCustomPolicyRuleTimeoutsEl {
    pub fn build(self) -> ConfigOrganizationCustomPolicyRuleTimeoutsEl {
        ConfigOrganizationCustomPolicyRuleTimeoutsEl {
...
pub struct ConfigOrganizationCustomPolicyRuleTimeoutsElRef {
    shared: StackShared,
    base: String,
}

impl Ref for ConfigOrganizationCustomPolicyRuleTimeoutsElRef {
    fn new(shared: StackShared, base: String) -> ConfigOrganizationCustomPolicyRuleTimeoutsElRef {
        ConfigOrganizationCustomPolicyRuleTimeoutsElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl ConfigOrganizationCustomPolicyRuleTimeoutsElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
