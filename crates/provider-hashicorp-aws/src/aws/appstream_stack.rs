...
struct AppstreamStackData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    streaming_experience_settings: Option<Vec<AppstreamStackStreamingExperienceSettingsEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl AppstreamStack {
    ...
    pub fn set_access_endpoints(
        self,
        v: impl Into<BlockAssignable<AppstreamStackAccessEndpointsEl>>,
    ) -> Self {
        match v.into() {
    ...
    pub fn set_application_settings(
        self,
        v: impl Into<BlockAssignable<AppstreamStackApplicationSettingsEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_storage_connectors(
        self,
        v: impl Into<BlockAssignable<AppstreamStackStorageConnectorsEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_streaming_experience_settings(
        self,
        v: impl Into<BlockAssignable<AppstreamStackStreamingExperienceSettingsEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.0.data.borrow_mut().streaming_experience_settings = Some(v);
            }
            BlockAssignable::Dynamic(d) => {
                self.0
                    .data
                    .borrow_mut()
                    .dynamic
                    .streaming_experience_settings = Some(d);
            }
        }
        self
    }
    ...
    pub fn set_user_settings(
        self,
        v: impl Into<BlockAssignable<AppstreamStackUserSettingsEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn streaming_experience_settings(
        &self,
    ) -> ListRef<AppstreamStackStreamingExperienceSettingsElRef> {
        ListRef::new(
            self.shared().clone(),
            format!("{}.streaming_experience_settings", self.extract_ref()),
        )
    }
}
    ...
    pub fn build(self, stack: &mut Stack) -> AppstreamStack {
        let out = AppstreamStack(Rc::new(AppstreamStack_ {
            ...
            data: RefCell::new(AppstreamStackData {
                ...
                streaming_experience_settings: core::default::Default::default(),
...
impl AppstreamStackApplicationSettingsElRef {
    ...
    pub fn settings_group(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.settings_group", self.base),
        )
    }
}
...
impl AppstreamStackStorageConnectorsElRef {
    ...
    pub fn resource_identifier(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.resource_identifier", self.base),
        )
    }
}
...
impl AppstreamStackStreamingExperienceSettingsEl {
    ...
    pub fn set_preferred_protocol(mut self, v: impl Into<PrimField<String>>) -> Self {
        self.preferred_protocol = Some(v.into());
        self
    }
}
...
impl BuildAppstreamStackStreamingExperienceSettingsEl {
    pub fn build(self) -> AppstreamStackStreamingExperienceSettingsEl {
        AppstreamStackStreamingExperienceSettingsEl {
            preferred_protocol: core::default::Default::default(),
        }
    }
}
...
impl AppstreamStackStreamingExperienceSettingsElRef {
    ...
    pub fn preferred_protocol(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.preferred_protocol", self.base),
        )
    }
}
...
struct AppstreamStackDynamic {
    ...
    streaming_experience_settings:
        Option<DynamicBlock<AppstreamStackStreamingExperienceSettingsEl>>,
