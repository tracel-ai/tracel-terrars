...
struct DxPublicVirtualInterfaceData {
    ...
    vlan: PrimField<f64>,
    #[serde(skip_serializing_if = "Option::is_none")]
    timeouts: Option<DxPublicVirtualInterfaceTimeoutsEl>,
}
struct DxPublicVirtualInterface_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<DxPublicVirtualInterfaceData>,
}
#[derive(Clone)]
pub struct DxPublicVirtualInterface(Rc<DxPublicVirtualInterface_>);
impl DxPublicVirtualInterface {
    ...
    pub fn set_timeouts(self, v: impl Into<DxPublicVirtualInterfaceTimeoutsEl>) -> Self {
...
impl Resource_ for DxPublicVirtualInterface_ {
    fn extract_resource_type(&self) -> String {
        "aws_dx_public_virtual_interface".into()
    }
...
pub struct BuildDxPublicVirtualInterface {
    pub tf_id: String,
    #[doc = ""]
...
impl BuildDxPublicVirtualInterface {
    pub fn build(self, stack: &mut Stack) -> DxPublicVirtualInterface {
        let out = DxPublicVirtualInterface(Rc::new(DxPublicVirtualInterface_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(DxPublicVirtualInterfaceData {
...
pub struct DxPublicVirtualInterfaceRef {
    shared: StackShared,
    base: String,
}
...
impl DxPublicVirtualInterfaceRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
    fn shared(&self) -> &StackShared {
...
#[derive(Serialize)]
pub struct DxPublicVirtualInterfaceTimeoutsEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    create: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    delete: Option<PrimField<String>>,
}
impl DxPublicVirtualInterfaceTimeoutsEl {
...
impl ToListMappable for DxPublicVirtualInterfaceTimeoutsEl {
    type O = BlockAssignable<DxPublicVirtualInterfaceTimeoutsEl>;
    fn do_map(self, base: String) -> Self::O {
...
pub struct BuildDxPublicVirtualInterfaceTimeoutsEl {}
impl BuildDxPublicVirtualInterfaceTimeoutsEl {
    pub fn build(self) -> DxPublicVirtualInterfaceTimeoutsEl {
        DxPublicVirtualInterfaceTimeoutsEl {
            create: core::default::Default::default(),
            delete: core::default::Default::default(),
        }
    }
}
pub struct DxPublicVirtualInterfaceTimeoutsElRef {
    shared: StackShared,
    base: String,
}
impl Ref for DxPublicVirtualInterfaceTimeoutsElRef {
    fn new(shared: StackShared, base: String) -> DxPublicVirtualInterfaceTimeoutsElRef {
        DxPublicVirtualInterfaceTimeoutsElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
}
impl DxPublicVirtualInterfaceTimeoutsElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
