...
impl DataTimestreamwriteTableMagneticStoreWritePropertiesElMagneticStoreRejectedDataLocationEl {
    ...
    pub fn set_s3_configuration(
        mut self,
        v : impl Into < ListField < DataTimestreamwriteTableMagneticStoreWritePropertiesElMagneticStoreRejectedDataLocationElS3ConfigurationEl > >,
    ) -> Self {
    ...
    for DataTimestreamwriteTableMagneticStoreWritePropertiesElMagneticStoreRejectedDataLocationElRef
{
    ...
    {
        DataTimestreamwriteTableMagneticStoreWritePropertiesElMagneticStoreRejectedDataLocationElRef { shared : shared , base : base . to_string () , }
    }
}
impl DataTimestreamwriteTableMagneticStoreWritePropertiesElMagneticStoreRejectedDataLocationElRef {
    ...
    #[doc = "Get a reference to the value of field `s3_configuration` after provisioning.\n"]    pub fn s3_configuration (& self) -> ListRef < DataTimestreamwriteTableMagneticStoreWritePropertiesElMagneticStoreRejectedDataLocationElS3ConfigurationElRef >{
        ListRef::new(
            self.shared().clone(),
...
#[derive(Serialize)]
pub struct DataTimestreamwriteTableMagneticStoreWritePropertiesEl { # [serde (skip_serializing_if = "Option::is_none")] enable_magnetic_store_writes : Option < PrimField < bool > > , # [serde (skip_serializing_if = "Option::is_none")] magnetic_store_rejected_data_location : Option < ListField < DataTimestreamwriteTableMagneticStoreWritePropertiesElMagneticStoreRejectedDataLocationEl > > , }
impl DataTimestreamwriteTableMagneticStoreWritePropertiesEl {
    ...
    pub fn set_magnetic_store_rejected_data_location(
        mut self,
        v : impl Into < ListField < DataTimestreamwriteTableMagneticStoreWritePropertiesElMagneticStoreRejectedDataLocationEl > >,
    ) -> Self {
...
impl DataTimestreamwriteTableMagneticStoreWritePropertiesElRef {
    ...
    #[doc = "Get a reference to the value of field `magnetic_store_rejected_data_location` after provisioning.\n"]    pub fn magnetic_store_rejected_data_location (& self) -> ListRef < DataTimestreamwriteTableMagneticStoreWritePropertiesElMagneticStoreRejectedDataLocationElRef >{
        ListRef::new(
            self.shared().clone(),
