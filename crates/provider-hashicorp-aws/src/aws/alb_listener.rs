...
struct AlbListenerData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    routing_http_request_x_amzn_mtls_clientcert_header_name: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    routing_http_request_x_amzn_mtls_clientcert_issuer_header_name: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    routing_http_request_x_amzn_mtls_clientcert_validity_header_name: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    routing_http_request_x_amzn_tls_cipher_suite_header_name: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    routing_http_request_x_amzn_tls_version_header_name: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    routing_http_response_access_control_allow_credentials_header_value: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    routing_http_response_access_control_allow_headers_header_value: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    routing_http_response_access_control_allow_methods_header_value: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    routing_http_response_access_control_allow_origin_header_value: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    routing_http_response_access_control_expose_headers_header_value: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    routing_http_response_access_control_max_age_header_value: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    routing_http_response_content_security_policy_header_value: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    routing_http_response_server_enabled: Option<PrimField<bool>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    routing_http_response_strict_transport_security_header_value: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    routing_http_response_x_content_type_options_header_value: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    routing_http_response_x_frame_options_header_value: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    mutual_authentication: Option<Vec<AlbListenerMutualAuthenticationEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl AlbListener {
    ...
    pub fn set_default_action(
        self,
        v: impl Into<BlockAssignable<AlbListenerDefaultActionEl>>,
    ) -> Self {
        match v.into() {
    ...
    pub fn set_mutual_authentication(
        self,
        v: impl Into<BlockAssignable<AlbListenerMutualAuthenticationEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn mutual_authentication(&self) -> ListRef<AlbListenerMutualAuthenticationElRef> {
        ListRef::new(
            self.shared().clone(),
...
impl Referable for AlbListener {
    ...
    pub fn build(self, stack: &mut Stack) -> AlbListener {
        let out = AlbListener(Rc::new(AlbListener_ {
            ...
            data: RefCell::new(AlbListenerData {
                ...
                mutual_authentication: core::default::Default::default(),
...
#[derive(Serialize)]
pub struct AlbListenerDefaultActionElJwtValidationElAdditionalClaimEl {
    format: PrimField<String>,
    name: PrimField<String>,
    values: SetField<PrimField<String>>,
}

impl AlbListenerDefaultActionElJwtValidationElAdditionalClaimEl {}

impl ToListMappable for AlbListenerDefaultActionElJwtValidationElAdditionalClaimEl {
    type O = BlockAssignable<AlbListenerDefaultActionElJwtValidationElAdditionalClaimEl>;
...
pub struct BuildAlbListenerDefaultActionElJwtValidationElAdditionalClaimEl {
    #[doc = ""]
...
impl BuildAlbListenerDefaultActionElJwtValidationElAdditionalClaimEl {
    pub fn build(self) -> AlbListenerDefaultActionElJwtValidationElAdditionalClaimEl {
        AlbListenerDefaultActionElJwtValidationElAdditionalClaimEl {
            format: self.format,
            name: self.name,
            values: self.values,
        }
...
pub struct AlbListenerDefaultActionElJwtValidationElAdditionalClaimElRef {
    shared: StackShared,
    base: String,
}

impl Ref for AlbListenerDefaultActionElJwtValidationElAdditionalClaimElRef {
    fn new(
        shared: StackShared,
        base: String,
    ) -> AlbListenerDefaultActionElJwtValidationElAdditionalClaimElRef {
        AlbListenerDefaultActionElJwtValidationElAdditionalClaimElRef {
            shared: shared,
            base: base.to_string(),
        }
...
impl AlbListenerDefaultActionElJwtValidationElAdditionalClaimElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize, Default)]
struct AlbListenerDefaultActionElJwtValidationElDynamic {
    additional_claim:
        Option<DynamicBlock<AlbListenerDefaultActionElJwtValidationElAdditionalClaimEl>>,
}

#[derive(Serialize)]
pub struct AlbListenerDefaultActionElJwtValidationEl {
    issuer: PrimField<String>,
    jwks_endpoint: PrimField<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    additional_claim: Option<Vec<AlbListenerDefaultActionElJwtValidationElAdditionalClaimEl>>,
    dynamic: AlbListenerDefaultActionElJwtValidationElDynamic,
}

impl AlbListenerDefaultActionElJwtValidationEl {
    #[doc = "Set the field `additional_claim`.\n"]
    pub fn set_additional_claim(
        mut self,
        v: impl Into<BlockAssignable<AlbListenerDefaultActionElJwtValidationElAdditionalClaimEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl ToListMappable for AlbListenerDefaultActionElJwtValidationEl {
    type O = BlockAssignable<AlbListenerDefaultActionElJwtValidationEl>;
...
pub struct BuildAlbListenerDefaultActionElJwtValidationEl {
    #[doc = ""]
    pub issuer: PrimField<String>,
    #[doc = ""]
...
impl BuildAlbListenerDefaultActionElJwtValidationEl {
    pub fn build(self) -> AlbListenerDefaultActionElJwtValidationEl {
        AlbListenerDefaultActionElJwtValidationEl {
            issuer: self.issuer,
...
pub struct AlbListenerDefaultActionElJwtValidationElRef {
    shared: StackShared,
    base: String,
}

impl Ref for AlbListenerDefaultActionElJwtValidationElRef {
    fn new(shared: StackShared, base: String) -> AlbListenerDefaultActionElJwtValidationElRef {
        AlbListenerDefaultActionElJwtValidationElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl AlbListenerDefaultActionElJwtValidationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
struct AlbListenerDefaultActionElDynamic {
    ...
    jwt_validation: Option<DynamicBlock<AlbListenerDefaultActionElJwtValidationEl>>,
...
pub struct AlbListenerDefaultActionEl {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    jwt_validation: Option<Vec<AlbListenerDefaultActionElJwtValidationEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl AlbListenerDefaultActionEl {
    ...
    pub fn set_forward(
        mut self,
        v: impl Into<BlockAssignable<AlbListenerDefaultActionElForwardEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.forward = Some(v);
    ...
    pub fn set_jwt_validation(
        mut self,
        v: impl Into<BlockAssignable<AlbListenerDefaultActionElJwtValidationEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_redirect(
        mut self,
        v: impl Into<BlockAssignable<AlbListenerDefaultActionElRedirectEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl AlbListenerDefaultActionElRef {
    ...
    pub fn authenticate_cognito(
        &self,
    ) -> ListRef<AlbListenerDefaultActionElAuthenticateCognitoElRef> {
        ListRef::new(
            self.shared().clone(),
    ...
    pub fn jwt_validation(&self) -> ListRef<AlbListenerDefaultActionElJwtValidationElRef> {
        ListRef::new(
            self.shared().clone(),
...
#[derive(Serialize)]
pub struct AlbListenerMutualAuthenticationEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    advertise_trust_store_ca_names: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ignore_client_certificate_expiry: Option<PrimField<bool>>,
    mode: PrimField<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    trust_store_arn: Option<PrimField<String>>,
}

impl AlbListenerMutualAuthenticationEl {
...
impl ToListMappable for AlbListenerMutualAuthenticationEl {
    type O = BlockAssignable<AlbListenerMutualAuthenticationEl>;
...
pub struct BuildAlbListenerMutualAuthenticationEl {
    #[doc = ""]
    pub mode: PrimField<String>,
}

impl BuildAlbListenerMutualAuthenticationEl {
    pub fn build(self) -> AlbListenerMutualAuthenticationEl {
        AlbListenerMutualAuthenticationEl {
            advertise_trust_store_ca_names: core::default::Default::default(),
            ignore_client_certificate_expiry: core::default::Default::default(),
            mode: self.mode,
            trust_store_arn: core::default::Default::default(),
        }
    }
}

pub struct AlbListenerMutualAuthenticationElRef {
    shared: StackShared,
    base: String,
}

impl Ref for AlbListenerMutualAuthenticationElRef {
    fn new(shared: StackShared, base: String) -> AlbListenerMutualAuthenticationElRef {
        AlbListenerMutualAuthenticationElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl AlbListenerMutualAuthenticationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
struct AlbListenerDynamic {
    ...
    mutual_authentication: Option<DynamicBlock<AlbListenerMutualAuthenticationEl>>,
}
