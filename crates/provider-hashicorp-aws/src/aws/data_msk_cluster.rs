...
impl DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationElSaslEl { # [doc = "Set the field `iam`.\n"] pub fn set_iam (mut self , v : impl Into < PrimField < bool > >) -> Self { self . iam = Some (v . into ()) ; self } # [doc = "Set the field `scram`.\n"] pub fn set_scram (mut self , v : impl Into < PrimField < bool > >) -> Self { self . scram = Some (v . into ()) ; self } }
impl ToListMappable for DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationElSaslEl { type O = BlockAssignable < DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationElSaslEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildDataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationElSaslEl
{}
impl BuildDataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationElSaslEl { pub fn build (self) -> DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationElSaslEl { DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationElSaslEl { iam : core :: default :: Default :: default () , scram : core :: default :: Default :: default () , } } }
pub struct DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationElSaslElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationElSaslElRef { fn new (shared : StackShared , base : String) -> DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationElSaslElRef { DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationElSaslElRef { shared : shared , base : base . to_string () , } } }
impl DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationElSaslElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `iam` after provisioning.\n"] pub fn iam (& self) -> PrimExpr < bool > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.iam" , self . base)) } # [doc = "Get a reference to the value of field `scram` after provisioning.\n"] pub fn scram (& self) -> PrimExpr < bool > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.scram" , self . base)) } }
#[derive(Serialize)]
pub struct DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationEl { # [serde (skip_serializing_if = "Option::is_none")] sasl : Option < ListField < DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationElSaslEl > > , # [serde (skip_serializing_if = "Option::is_none")] tls : Option < PrimField < bool > > , }
impl DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationEl {
    #[doc = "Set the field `sasl`.\n"]
    pub fn set_sasl(
        mut self,
        v : impl Into < ListField < DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationElSaslEl > >,
    ) -> Self {
...
impl ToListMappable
    for DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationEl
{
    type O = BlockAssignable < DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationEl > ;
    fn do_map(self, base: String) -> Self::O {
        BlockAssignable::Dynamic(DynamicBlock {
            for_each: format!("${{{}}}", base),
            iterator: "each".into(),
    ...
    DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationElRef
{
    ...
    #[doc = "Get a reference to the value of field `sasl` after provisioning.\n"]    pub fn sasl (& self) -> ListRef < DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationElSaslElRef >{
...
#[derive(Serialize)]
pub struct DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityEl { # [serde (skip_serializing_if = "Option::is_none")] client_authentication : Option < ListField < DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationEl > > , }
impl DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityEl {
    ...
    pub fn set_client_authentication(
        mut self,
        v : impl Into < ListField < DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationEl > >,
    ) -> Self {
...
impl ToListMappable for DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityEl {
    type O =
        BlockAssignable<DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityEl>;
    fn do_map(self, base: String) -> Self::O {
        BlockAssignable::Dynamic(DynamicBlock {
            for_each: format!("${{{}}}", base),
            iterator: "each".into(),
...
impl DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElRef {
    ...
    #[doc = "Get a reference to the value of field `client_authentication` after provisioning.\n"]    pub fn client_authentication (& self) -> ListRef < DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElClientAuthenticationElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.client_authentication", self.base),
        )
    }
}
#[derive(Serialize)]
pub struct DataMskClusterBrokerNodeGroupInfoElConnectivityInfoEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    public_access:
        Option<ListField<DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElPublicAccessEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    vpc_connectivity:
        Option<ListField<DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityEl>>,
}
...
impl DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElRef {
    ...
    pub fn public_access(
        &self,
    ) -> ListRef<DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElPublicAccessElRef> {
        ListRef::new(
            self.shared().clone(),
    ...
    pub fn vpc_connectivity(
        &self,
    ) -> ListRef<DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElVpcConnectivityElRef> {
        ListRef::new(
            self.shared().clone(),
            format!("{}.vpc_connectivity", self.base),
        )
    }
}
#[derive(Serialize)]
...
impl ToListMappable
    for DataMskClusterBrokerNodeGroupInfoElStorageInfoElEbsStorageInfoElProvisionedThroughputEl
{
...
impl Ref
    for DataMskClusterBrokerNodeGroupInfoElStorageInfoElEbsStorageInfoElProvisionedThroughputElRef
{
    fn new(
        shared: StackShared,
        base: String,
...
impl DataMskClusterBrokerNodeGroupInfoElStorageInfoElEbsStorageInfoElProvisionedThroughputElRef {
    ...
    pub fn volume_throughput(&self) -> PrimExpr<f64> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.volume_throughput", self.base),
        )
    }
}
#[derive(Serialize)]
...
impl DataMskClusterBrokerNodeGroupInfoElStorageInfoElEbsStorageInfoEl {
    ...
    pub fn set_provisioned_throughput(
        mut self,
        v : impl Into < ListField < DataMskClusterBrokerNodeGroupInfoElStorageInfoElEbsStorageInfoElProvisionedThroughputEl > >,
    ) -> Self {
...
pub struct DataMskClusterBrokerNodeGroupInfoElStorageInfoEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    ebs_storage_info:
        Option<ListField<DataMskClusterBrokerNodeGroupInfoElStorageInfoElEbsStorageInfoEl>>,
}
...
impl BuildDataMskClusterBrokerNodeGroupInfoElStorageInfoEl {
    pub fn build(self) -> DataMskClusterBrokerNodeGroupInfoElStorageInfoEl {
        DataMskClusterBrokerNodeGroupInfoElStorageInfoEl {
...
impl DataMskClusterBrokerNodeGroupInfoElStorageInfoElRef {
    ...
    pub fn ebs_storage_info(
        &self,
    ) -> ListRef<DataMskClusterBrokerNodeGroupInfoElStorageInfoElEbsStorageInfoElRef> {
        ListRef::new(
            self.shared().clone(),
            format!("{}.ebs_storage_info", self.base),
        )
    }
}
#[derive(Serialize)]
...
impl DataMskClusterBrokerNodeGroupInfoElRef {
    ...
    pub fn connectivity_info(
        &self,
    ) -> ListRef<DataMskClusterBrokerNodeGroupInfoElConnectivityInfoElRef> {
        ListRef::new(
            self.shared().clone(),
