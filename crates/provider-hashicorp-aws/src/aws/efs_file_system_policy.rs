...
#[derive(Serialize)]
struct EfsFileSystemPolicyData {
...
struct EfsFileSystemPolicy_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<EfsFileSystemPolicyData>,
}

#[derive(Clone)]
pub struct EfsFileSystemPolicy(Rc<EfsFileSystemPolicy_>);

impl EfsFileSystemPolicy {
...
impl Referable for EfsFileSystemPolicy {
...
impl Resource for EfsFileSystemPolicy {}

impl ToListMappable for EfsFileSystemPolicy {
    type O = ListRef<EfsFileSystemPolicyRef>;
...
impl Resource_ for EfsFileSystemPolicy_ {
    fn extract_resource_type(&self) -> String {
        "aws_efs_file_system_policy".into()
    }
...
pub struct BuildEfsFileSystemPolicy {
    pub tf_id: String,
    #[doc = ""]
...
impl BuildEfsFileSystemPolicy {
    pub fn build(self, stack: &mut Stack) -> EfsFileSystemPolicy {
        let out = EfsFileSystemPolicy(Rc::new(EfsFileSystemPolicy_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(EfsFileSystemPolicyData {
...
pub struct EfsFileSystemPolicyRef {
    shared: StackShared,
    base: String,
}

impl Ref for EfsFileSystemPolicyRef {
    fn new(shared: StackShared, base: String) -> Self {
        Self { shared, base }
    }
}

impl EfsFileSystemPolicyRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
