...
impl Sesv2ContactList {
    ...
    pub fn contact_list_name(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.contact_list_name", self.extract_ref()))
    }
    ...
    pub fn last_updated_timestamp(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.last_updated_timestamp", self.extract_ref()))
    }
...
impl Sesv2ContactListTopicElRef {
    ...
    pub fn default_subscription_status(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.default_subscription_status", self.base))
    }
