...
impl StoragegatewayStoredIscsiVolume {
    ...
    pub fn preserve_existing_data(&self) -> PrimExpr<bool> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.preserve_existing_data", self.extract_ref()),
        )
    }
    ...
    pub fn volume_attachment_status(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.volume_attachment_status", self.extract_ref()),
        )
    }
    ...
    pub fn volume_size_in_bytes(&self) -> PrimExpr<f64> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.volume_size_in_bytes", self.extract_ref()),
        )
    }
    ...
    pub fn volume_status(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.volume_status", self.extract_ref()),
        )
    }
...
impl Referable for StoragegatewayStoredIscsiVolume {
