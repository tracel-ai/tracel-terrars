...
#[derive(Clone)]
pub struct WorkspaceswebUserAccessLoggingSettingsAssociation(Rc<WorkspaceswebUserAccessLoggingSettingsAssociation_>);
    ...
    pub fn build(self, stack: &mut Stack) -> WorkspaceswebUserAccessLoggingSettingsAssociation {
        let out =
            WorkspaceswebUserAccessLoggingSettingsAssociation(
                Rc::new(WorkspaceswebUserAccessLoggingSettingsAssociation_ {
                    shared: stack.shared.clone(),
                    tf_id: self.tf_id,
                    data: RefCell::new(WorkspaceswebUserAccessLoggingSettingsAssociationData {
