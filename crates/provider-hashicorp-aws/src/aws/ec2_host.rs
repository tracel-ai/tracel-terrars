...
struct Ec2HostData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    asset_id: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    auto_placement: Option<PrimField<String>>,
    availability_zone: PrimField<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    host_recovery: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    id: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    instance_family: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl Ec2Host {
    ...
    pub fn timeouts(&self) -> Ec2HostTimeoutsElRef {
        Ec2HostTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
}
...
impl BuildEc2Host {
    pub fn build(self, stack: &mut Stack) -> Ec2Host {
        let out = Ec2Host(Rc::new(Ec2Host_ {
            ...
            tf_id: self.tf_id,
            data: RefCell::new(Ec2HostData {
                depends_on: core::default::Default::default(),
                provider: None,
                lifecycle: core::default::Default::default(),
                for_each: None,
                asset_id: core::default::Default::default(),
                auto_placement: core::default::Default::default(),
                availability_zone: self.availability_zone,
                host_recovery: core::default::Default::default(),
                id: core::default::Default::default(),
                instance_family: core::default::Default::default(),
