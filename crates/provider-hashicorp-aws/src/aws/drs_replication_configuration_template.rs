...
impl DrsReplicationConfigurationTemplate {
    ...
    pub fn set_pit_policy(
        self,
        v: impl Into<BlockAssignable<DrsReplicationConfigurationTemplatePitPolicyEl>>,
    ) -> Self {
        match v.into() {
...
impl BuildDrsReplicationConfigurationTemplate {
    pub fn build(self, stack: &mut Stack) -> DrsReplicationConfigurationTemplate {
        let out =
            DrsReplicationConfigurationTemplate(Rc::new(DrsReplicationConfigurationTemplate_ {
                ...
                data: RefCell::new(DrsReplicationConfigurationTemplateData {
                    ...
                    replication_servers_security_groups_ids: self
                        .replication_servers_security_groups_ids,
