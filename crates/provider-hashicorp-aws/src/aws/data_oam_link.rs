...
impl DataOamLink {
    ...
    pub fn link_identifier(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.link_identifier", self.extract_ref()))
    }
...
impl BuildDataOamLinkLinkConfigurationElLogGroupConfigurationEl {
    pub fn build(self) -> DataOamLinkLinkConfigurationElLogGroupConfigurationEl {
        DataOamLinkLinkConfigurationElLogGroupConfigurationEl { filter: core::default::Default::default() }
    }
}
...
impl Ref for DataOamLinkLinkConfigurationElLogGroupConfigurationElRef {
    fn new(shared: StackShared, base: String) -> DataOamLinkLinkConfigurationElLogGroupConfigurationElRef {
...
impl BuildDataOamLinkLinkConfigurationElMetricConfigurationEl {
    pub fn build(self) -> DataOamLinkLinkConfigurationElMetricConfigurationEl {
        DataOamLinkLinkConfigurationElMetricConfigurationEl { filter: core::default::Default::default() }
    }
}
...
impl Ref for DataOamLinkLinkConfigurationElMetricConfigurationElRef {
    fn new(shared: StackShared, base: String) -> DataOamLinkLinkConfigurationElMetricConfigurationElRef {
...
pub struct DataOamLinkLinkConfigurationEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    log_group_configuration: Option<ListField<DataOamLinkLinkConfigurationElLogGroupConfigurationEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl DataOamLinkLinkConfigurationElRef {
    ...
    pub fn log_group_configuration(&self) -> ListRef<DataOamLinkLinkConfigurationElLogGroupConfigurationElRef> {
    ...
    pub fn metric_configuration(&self) -> ListRef<DataOamLinkLinkConfigurationElMetricConfigurationElRef> {
