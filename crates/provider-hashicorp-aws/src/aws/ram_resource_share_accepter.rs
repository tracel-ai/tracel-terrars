...
impl RamResourceShareAccepter {
    ...
    pub fn invitation_arn(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.invitation_arn", self.extract_ref()),
        )
    }
    ...
    pub fn receiver_account_id(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.receiver_account_id", self.extract_ref()),
        )
    }
    ...
    pub fn sender_account_id(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.sender_account_id", self.extract_ref()),
        )
    }
    ...
    pub fn share_arn(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.share_arn", self.extract_ref()),
        )
    }
    ...
    pub fn share_id(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.share_id", self.extract_ref()),
        )
    }
    ...
    pub fn timeouts(&self) -> RamResourceShareAccepterTimeoutsElRef {
        RamResourceShareAccepterTimeoutsElRef::new(
            self.shared().clone(),
...
impl Referable for RamResourceShareAccepter {
