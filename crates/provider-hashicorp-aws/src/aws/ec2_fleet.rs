...
struct Ec2FleetLaunchTemplateConfigElOverrideElInstanceRequirementsElDynamic {
    ...
    network_bandwidth_gbps: Option<
        DynamicBlock<Ec2FleetLaunchTemplateConfigElOverrideElInstanceRequirementsElNetworkBandwidthGbpsEl>,
    >,
...
pub struct Ec2FleetLaunchTemplateConfigElOverrideElInstanceRequirementsEl {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    network_bandwidth_gbps: Option<
        Vec<Ec2FleetLaunchTemplateConfigElOverrideElInstanceRequirementsElNetworkBandwidthGbpsEl>,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    network_interface_count: Option<
