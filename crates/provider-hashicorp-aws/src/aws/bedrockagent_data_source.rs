...
impl BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersEl { # [doc = "Set the field `exclusion_filters`.\n"] pub fn set_exclusion_filters (mut self , v : impl Into < SetField < PrimField < String > > >) -> Self { self . exclusion_filters = Some (v . into ()) ; self } # [doc = "Set the field `inclusion_filters`.\n"] pub fn set_inclusion_filters (mut self , v : impl Into < SetField < PrimField < String > > >) -> Self { self . inclusion_filters = Some (v . into ()) ; self } }
impl ToListMappable for BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersEl { type O = BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersElRef { BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `exclusion_filters` after provisioning.\n"] pub fn exclusion_filters (& self) -> SetRef < PrimExpr < String > > { SetRef :: new (self . shared () . clone () , format ! ("{}.exclusion_filters" , self . base)) } # [doc = "Get a reference to the value of field `inclusion_filters` after provisioning.\n"] pub fn inclusion_filters (& self) -> SetRef < PrimExpr < String > > { SetRef :: new (self . shared () . clone () , format ! ("{}.inclusion_filters" , self . base)) } # [doc = "Get a reference to the value of field `object_type` after provisioning.\n"] pub fn object_type (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.object_type" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElDynamic { filters : Option < DynamicBlock < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl { # [serde (skip_serializing_if = "Option::is_none")] filters : Option < Vec < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersEl > > , dynamic : BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElDynamic , }
impl BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl { # [doc = "Set the field `filters`.\n"] pub fn set_filters (mut self , v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . filters = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . filters = Some (d) ; } } self } }
impl ToListMappable for BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl { type O = BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElRef { BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `filters` after provisioning.\n"] pub fn filters (& self) -> ListRef < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.filters" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElDynamic { pattern_object_filter : Option < DynamicBlock < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationEl { # [serde (rename = "type")] type_ : PrimField < String > , # [serde (skip_serializing_if = "Option::is_none")] pattern_object_filter : Option < Vec < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl > > , dynamic : BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElDynamic , }
impl BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationEl { # [doc = "Set the field `pattern_object_filter`.\n"] pub fn set_pattern_object_filter (mut self , v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . pattern_object_filter = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . pattern_object_filter = Some (d) ; } } self } }
impl ToListMappable for BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationEl { type O = BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElRef { BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `type_` after provisioning.\n"] pub fn type_ (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.type" , self . base)) } # [doc = "Get a reference to the value of field `pattern_object_filter` after provisioning.\n"] pub fn pattern_object_filter (& self) -> ListRef < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.pattern_object_filter" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElDynamic { filter_configuration : Option < DynamicBlock < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationEl { # [serde (skip_serializing_if = "Option::is_none")] filter_configuration : Option < Vec < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationEl > > , dynamic : BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElDynamic , }
impl
    BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationEl
{
    ...
    pub fn set_filter_configuration(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl ToListMappable for BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationEl { type O = BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildBedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationEl
{}
impl BuildBedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationEl { pub fn build (self) -> BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationEl { BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationEl { filter_configuration : core :: default :: Default :: default () , dynamic : Default :: default () , } } }
pub struct BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElRef { BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `filter_configuration` after provisioning.\n"] pub fn filter_configuration (& self) -> ListRef < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElFilterConfigurationElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.filter_configuration" , self . base)) } }
#[derive(Serialize)]
...
impl BuildBedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElSourceConfigurationEl { pub fn build (self) -> BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElSourceConfigurationEl { BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElSourceConfigurationEl { auth_type : self . auth_type , credentials_secret_arn : self . credentials_secret_arn , host_type : self . host_type , host_url : self . host_url , } } }
pub struct BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElSourceConfigurationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElSourceConfigurationElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElSourceConfigurationElRef { BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElSourceConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl
...
#[derive(Serialize, Default)]
struct BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElDynamic { crawler_configuration : Option < DynamicBlock < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationEl >> , source_configuration : Option < DynamicBlock < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElSourceConfigurationEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationEl { # [serde (skip_serializing_if = "Option::is_none")] crawler_configuration : Option < Vec < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationEl > > , # [serde (skip_serializing_if = "Option::is_none")] source_configuration : Option < Vec < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElSourceConfigurationEl > > , dynamic : BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElDynamic , }
impl BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationEl {
    ...
    pub fn set_crawler_configuration(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_source_configuration(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElSourceConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElRef {
    ...
    #[doc = "Get a reference to the value of field `crawler_configuration` after provisioning.\n"]    pub fn crawler_configuration (& self) -> ListRef < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElCrawlerConfigurationElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.crawler_configuration", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `source_configuration` after provisioning.\n"]    pub fn source_configuration (& self) -> ListRef < BedrockagentDataSourceDataSourceConfigurationElConfluenceConfigurationElSourceConfigurationElRef >{
        ListRef::new(
            self.shared().clone(),
...
impl BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersEl { # [doc = "Set the field `exclusion_filters`.\n"] pub fn set_exclusion_filters (mut self , v : impl Into < SetField < PrimField < String > > >) -> Self { self . exclusion_filters = Some (v . into ()) ; self } # [doc = "Set the field `inclusion_filters`.\n"] pub fn set_inclusion_filters (mut self , v : impl Into < SetField < PrimField < String > > >) -> Self { self . inclusion_filters = Some (v . into ()) ; self } }
impl ToListMappable for BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersEl { type O = BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersElRef { BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `exclusion_filters` after provisioning.\n"] pub fn exclusion_filters (& self) -> SetRef < PrimExpr < String > > { SetRef :: new (self . shared () . clone () , format ! ("{}.exclusion_filters" , self . base)) } # [doc = "Get a reference to the value of field `inclusion_filters` after provisioning.\n"] pub fn inclusion_filters (& self) -> SetRef < PrimExpr < String > > { SetRef :: new (self . shared () . clone () , format ! ("{}.inclusion_filters" , self . base)) } # [doc = "Get a reference to the value of field `object_type` after provisioning.\n"] pub fn object_type (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.object_type" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElDynamic { filters : Option < DynamicBlock < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl { # [serde (skip_serializing_if = "Option::is_none")] filters : Option < Vec < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersEl > > , dynamic : BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElDynamic , }
impl BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl { # [doc = "Set the field `filters`.\n"] pub fn set_filters (mut self , v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . filters = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . filters = Some (d) ; } } self } }
impl ToListMappable for BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl { type O = BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElRef { BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `filters` after provisioning.\n"] pub fn filters (& self) -> ListRef < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.filters" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElDynamic { pattern_object_filter : Option < DynamicBlock < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationEl { # [serde (rename = "type")] type_ : PrimField < String > , # [serde (skip_serializing_if = "Option::is_none")] pattern_object_filter : Option < Vec < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl > > , dynamic : BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElDynamic , }
impl BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationEl { # [doc = "Set the field `pattern_object_filter`.\n"] pub fn set_pattern_object_filter (mut self , v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . pattern_object_filter = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . pattern_object_filter = Some (d) ; } } self } }
impl ToListMappable for BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationEl { type O = BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElRef { BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `type_` after provisioning.\n"] pub fn type_ (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.type" , self . base)) } # [doc = "Get a reference to the value of field `pattern_object_filter` after provisioning.\n"] pub fn pattern_object_filter (& self) -> ListRef < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.pattern_object_filter" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElDynamic { filter_configuration : Option < DynamicBlock < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationEl { # [serde (skip_serializing_if = "Option::is_none")] filter_configuration : Option < Vec < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationEl > > , dynamic : BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElDynamic , }
impl
    BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationEl
{
    ...
    pub fn set_filter_configuration(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.filter_configuration = Some(v);
...
impl ToListMappable for BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationEl { type O = BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildBedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationEl
{}
impl BuildBedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationEl { pub fn build (self) -> BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationEl { BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationEl { filter_configuration : core :: default :: Default :: default () , dynamic : Default :: default () , } } }
pub struct BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElRef { BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `filter_configuration` after provisioning.\n"] pub fn filter_configuration (& self) -> ListRef < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElFilterConfigurationElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.filter_configuration" , self . base)) } }
#[derive(Serialize)]
...
impl BuildBedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElSourceConfigurationEl { pub fn build (self) -> BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElSourceConfigurationEl { BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElSourceConfigurationEl { auth_type : self . auth_type , credentials_secret_arn : self . credentials_secret_arn , host_url : self . host_url , } } }
pub struct BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElSourceConfigurationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElSourceConfigurationElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElSourceConfigurationElRef { BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElSourceConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl
...
#[derive(Serialize, Default)]
struct BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElDynamic { crawler_configuration : Option < DynamicBlock < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationEl >> , source_configuration : Option < DynamicBlock < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElSourceConfigurationEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationEl { # [serde (skip_serializing_if = "Option::is_none")] crawler_configuration : Option < Vec < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationEl > > , # [serde (skip_serializing_if = "Option::is_none")] source_configuration : Option < Vec < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElSourceConfigurationEl > > , dynamic : BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElDynamic , }
impl BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationEl {
    #[doc = "Set the field `crawler_configuration`.\n"]
    pub fn set_crawler_configuration(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.crawler_configuration = Some(v);
    ...
    pub fn set_source_configuration(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElSourceConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.source_configuration = Some(v);
...
impl BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElRef {
    ...
    #[doc = "Get a reference to the value of field `crawler_configuration` after provisioning.\n"]    pub fn crawler_configuration (& self) -> ListRef < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElCrawlerConfigurationElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.crawler_configuration", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `source_configuration` after provisioning.\n"]    pub fn source_configuration (& self) -> ListRef < BedrockagentDataSourceDataSourceConfigurationElSalesforceConfigurationElSourceConfigurationElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.source_configuration", self.base),
        )
...
impl BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersEl { # [doc = "Set the field `exclusion_filters`.\n"] pub fn set_exclusion_filters (mut self , v : impl Into < SetField < PrimField < String > > >) -> Self { self . exclusion_filters = Some (v . into ()) ; self } # [doc = "Set the field `inclusion_filters`.\n"] pub fn set_inclusion_filters (mut self , v : impl Into < SetField < PrimField < String > > >) -> Self { self . inclusion_filters = Some (v . into ()) ; self } }
impl ToListMappable for BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersEl { type O = BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersElRef { BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `exclusion_filters` after provisioning.\n"] pub fn exclusion_filters (& self) -> SetRef < PrimExpr < String > > { SetRef :: new (self . shared () . clone () , format ! ("{}.exclusion_filters" , self . base)) } # [doc = "Get a reference to the value of field `inclusion_filters` after provisioning.\n"] pub fn inclusion_filters (& self) -> SetRef < PrimExpr < String > > { SetRef :: new (self . shared () . clone () , format ! ("{}.inclusion_filters" , self . base)) } # [doc = "Get a reference to the value of field `object_type` after provisioning.\n"] pub fn object_type (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.object_type" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElDynamic { filters : Option < DynamicBlock < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl { # [serde (skip_serializing_if = "Option::is_none")] filters : Option < Vec < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersEl > > , dynamic : BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElDynamic , }
impl BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl { # [doc = "Set the field `filters`.\n"] pub fn set_filters (mut self , v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . filters = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . filters = Some (d) ; } } self } }
impl ToListMappable for BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl { type O = BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElRef { BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `filters` after provisioning.\n"] pub fn filters (& self) -> ListRef < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElFiltersElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.filters" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElDynamic { pattern_object_filter : Option < DynamicBlock < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationEl { # [serde (rename = "type")] type_ : PrimField < String > , # [serde (skip_serializing_if = "Option::is_none")] pattern_object_filter : Option < Vec < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl > > , dynamic : BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElDynamic , }
impl BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationEl { # [doc = "Set the field `pattern_object_filter`.\n"] pub fn set_pattern_object_filter (mut self , v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . pattern_object_filter = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . pattern_object_filter = Some (d) ; } } self } }
impl ToListMappable for BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationEl { type O = BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElRef { BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `type_` after provisioning.\n"] pub fn type_ (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.type" , self . base)) } # [doc = "Get a reference to the value of field `pattern_object_filter` after provisioning.\n"] pub fn pattern_object_filter (& self) -> ListRef < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElPatternObjectFilterElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.pattern_object_filter" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElDynamic { filter_configuration : Option < DynamicBlock < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationEl { # [serde (skip_serializing_if = "Option::is_none")] filter_configuration : Option < Vec < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationEl > > , dynamic : BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElDynamic , }
impl
    BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationEl
{
    ...
    pub fn set_filter_configuration(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.filter_configuration = Some(v);
...
impl ToListMappable for BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationEl { type O = BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildBedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationEl
{}
impl BuildBedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationEl { pub fn build (self) -> BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationEl { BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationEl { filter_configuration : core :: default :: Default :: default () , dynamic : Default :: default () , } } }
pub struct BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElRef { BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `filter_configuration` after provisioning.\n"] pub fn filter_configuration (& self) -> ListRef < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElFilterConfigurationElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.filter_configuration" , self . base)) } }
#[derive(Serialize)]
...
impl BuildBedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElSourceConfigurationEl { pub fn build (self) -> BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElSourceConfigurationEl { BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElSourceConfigurationEl { auth_type : self . auth_type , credentials_secret_arn : self . credentials_secret_arn , domain : self . domain , host_type : self . host_type , site_urls : self . site_urls , tenant_id : core :: default :: Default :: default () , } } }
pub struct BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElSourceConfigurationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElSourceConfigurationElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElSourceConfigurationElRef { BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElSourceConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl
    BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElSourceConfigurationElRef
{
    fn shared(&self) -> &StackShared {
...
#[derive(Serialize, Default)]
struct BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElDynamic { crawler_configuration : Option < DynamicBlock < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationEl >> , source_configuration : Option < DynamicBlock < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElSourceConfigurationEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationEl { # [serde (skip_serializing_if = "Option::is_none")] crawler_configuration : Option < Vec < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationEl > > , # [serde (skip_serializing_if = "Option::is_none")] source_configuration : Option < Vec < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElSourceConfigurationEl > > , dynamic : BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElDynamic , }
impl BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationEl {
    #[doc = "Set the field `crawler_configuration`.\n"]
    pub fn set_crawler_configuration(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.crawler_configuration = Some(v);
    ...
    pub fn set_source_configuration(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElSourceConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.source_configuration = Some(v);
...
impl BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElRef {
    ...
    #[doc = "Get a reference to the value of field `crawler_configuration` after provisioning.\n"]    pub fn crawler_configuration (& self) -> ListRef < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElCrawlerConfigurationElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.crawler_configuration", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `source_configuration` after provisioning.\n"]    pub fn source_configuration (& self) -> ListRef < BedrockagentDataSourceDataSourceConfigurationElSharePointConfigurationElSourceConfigurationElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.source_configuration", self.base),
        )
...
impl BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationElCrawlerLimitsEl { # [doc = "Set the field `max_pages`.\n"] pub fn set_max_pages (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . max_pages = Some (v . into ()) ; self } # [doc = "Set the field `rate_limit`.\n"] pub fn set_rate_limit (mut self , v : impl Into < PrimField < f64 > >) -> Self { self . rate_limit = Some (v . into ()) ; self } }
impl ToListMappable for BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationElCrawlerLimitsEl { type O = BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationElCrawlerLimitsEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildBedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationElCrawlerLimitsEl
{}
impl BuildBedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationElCrawlerLimitsEl { pub fn build (self) -> BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationElCrawlerLimitsEl { BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationElCrawlerLimitsEl { max_pages : core :: default :: Default :: default () , rate_limit : core :: default :: Default :: default () , } } }
pub struct BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationElCrawlerLimitsElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationElCrawlerLimitsElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationElCrawlerLimitsElRef { BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationElCrawlerLimitsElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationElCrawlerLimitsElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `max_pages` after provisioning.\n"] pub fn max_pages (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.max_pages" , self . base)) } # [doc = "Get a reference to the value of field `rate_limit` after provisioning.\n"] pub fn rate_limit (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.rate_limit" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationElDynamic { crawler_limits : Option < DynamicBlock < BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationElCrawlerLimitsEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationEl { # [serde (skip_serializing_if = "Option::is_none")] exclusion_filters : Option < SetField < PrimField < String > > > , # [serde (skip_serializing_if = "Option::is_none")] inclusion_filters : Option < SetField < PrimField < String > > > , # [serde (skip_serializing_if = "Option::is_none")] scope : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] user_agent : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] crawler_limits : Option < Vec < BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationElCrawlerLimitsEl > > , dynamic : BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationElDynamic , }
impl BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationEl {
    ...
    pub fn set_crawler_limits(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationElCrawlerLimitsEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationElRef {
    ...
    #[doc = "Get a reference to the value of field `crawler_limits` after provisioning.\n"]    pub fn crawler_limits (& self) -> ListRef < BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationElCrawlerLimitsElRef >{
        ListRef::new(
            self.shared().clone(),
...
impl BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElSeedUrlsEl { # [doc = "Set the field `url`.\n"] pub fn set_url (mut self , v : impl Into < PrimField < String > >) -> Self { self . url = Some (v . into ()) ; self } }
impl ToListMappable for BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElSeedUrlsEl { type O = BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElSeedUrlsEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
{}
impl BuildBedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElSeedUrlsEl { pub fn build (self) -> BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElSeedUrlsEl { BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElSeedUrlsEl { url : core :: default :: Default :: default () , } } }
...
impl Ref for BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElSeedUrlsElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElSeedUrlsElRef { BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElSeedUrlsElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElSeedUrlsElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `url` after provisioning.\n"] pub fn url (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.url" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElDynamic { seed_urls : Option < DynamicBlock < BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElSeedUrlsEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationEl { # [serde (skip_serializing_if = "Option::is_none")] seed_urls : Option < Vec < BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElSeedUrlsEl > > , dynamic : BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElDynamic , }
impl BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationEl { # [doc = "Set the field `seed_urls`.\n"] pub fn set_seed_urls (mut self , v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElSeedUrlsEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . seed_urls = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . seed_urls = Some (d) ; } } self } }
impl ToListMappable for BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationEl { type O = BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildBedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationEl
{}
impl BuildBedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationEl { pub fn build (self) -> BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationEl { BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationEl { seed_urls : core :: default :: Default :: default () , dynamic : Default :: default () , } } }
pub struct BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElRef { BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `seed_urls` after provisioning.\n"] pub fn seed_urls (& self) -> ListRef < BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElSeedUrlsElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.seed_urls" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElDynamic { url_configuration : Option < DynamicBlock < BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationEl { # [serde (skip_serializing_if = "Option::is_none")] url_configuration : Option < Vec < BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationEl > > , dynamic : BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElDynamic , }
impl BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationEl {
    ...
    pub fn set_url_configuration(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElRef {
    ...
    #[doc = "Get a reference to the value of field `url_configuration` after provisioning.\n"]    pub fn url_configuration (& self) -> ListRef < BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationElUrlConfigurationElRef >{
        ListRef::new(
            self.shared().clone(),
...
impl BedrockagentDataSourceDataSourceConfigurationElWebConfigurationEl {
    ...
    pub fn set_crawler_configuration(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElCrawlerConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.crawler_configuration = Some(v);
    ...
    pub fn set_source_configuration(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceDataSourceConfigurationElWebConfigurationElSourceConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.source_configuration = Some(v);
...
impl Ref for BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElFixedSizeChunkingConfigurationElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElFixedSizeChunkingConfigurationElRef { BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElFixedSizeChunkingConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElFixedSizeChunkingConfigurationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `max_tokens` after provisioning.\n"] pub fn max_tokens (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.max_tokens" , self . base)) } # [doc = "Get a reference to the value of field `overlap_percentage` after provisioning.\n"] pub fn overlap_percentage (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.overlap_percentage" , self . base)) } }
#[derive(Serialize)]
...
impl Ref for BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationElLevelConfigurationElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationElLevelConfigurationElRef { BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationElLevelConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationElLevelConfigurationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `max_tokens` after provisioning.\n"] pub fn max_tokens (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.max_tokens" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationElDynamic { level_configuration : Option < DynamicBlock < BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationElLevelConfigurationEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationEl { overlap_tokens : PrimField < f64 > , # [serde (skip_serializing_if = "Option::is_none")] level_configuration : Option < Vec < BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationElLevelConfigurationEl > > , dynamic : BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationElDynamic , }
impl BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationEl { # [doc = "Set the field `level_configuration`.\n"] pub fn set_level_configuration (mut self , v : impl Into < BlockAssignable < BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationElLevelConfigurationEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . level_configuration = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . level_configuration = Some (d) ; } } self } }
impl ToListMappable for BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationEl { type O = BlockAssignable < BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl BuildBedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationEl { pub fn build (self) -> BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationEl { BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationEl { overlap_tokens : self . overlap_tokens , level_configuration : core :: default :: Default :: default () , dynamic : Default :: default () , } } }
...
impl Ref for BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationElRef { BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `overlap_tokens` after provisioning.\n"] pub fn overlap_tokens (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.overlap_tokens" , self . base)) } # [doc = "Get a reference to the value of field `level_configuration` after provisioning.\n"] pub fn level_configuration (& self) -> ListRef < BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationElLevelConfigurationElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.level_configuration" , self . base)) } }
#[derive(Serialize)]
...
impl BuildBedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElSemanticChunkingConfigurationEl { pub fn build (self) -> BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElSemanticChunkingConfigurationEl { BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElSemanticChunkingConfigurationEl { breakpoint_percentile_threshold : self . breakpoint_percentile_threshold , buffer_size : self . buffer_size , max_token : self . max_token , } } }
pub struct BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElSemanticChunkingConfigurationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElSemanticChunkingConfigurationElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElSemanticChunkingConfigurationElRef { BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElSemanticChunkingConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElSemanticChunkingConfigurationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `breakpoint_percentile_threshold` after provisioning.\n"] pub fn breakpoint_percentile_threshold (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.breakpoint_percentile_threshold" , self . base)) } # [doc = "Get a reference to the value of field `buffer_size` after provisioning.\n"] pub fn buffer_size (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.buffer_size" , self . base)) } # [doc = "Get a reference to the value of field `max_token` after provisioning.\n"] pub fn max_token (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.max_token" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElDynamic { fixed_size_chunking_configuration : Option < DynamicBlock < BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElFixedSizeChunkingConfigurationEl >> , hierarchical_chunking_configuration : Option < DynamicBlock < BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationEl >> , semantic_chunking_configuration : Option < DynamicBlock < BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElSemanticChunkingConfigurationEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationEl { chunking_strategy : PrimField < String > , # [serde (skip_serializing_if = "Option::is_none")] fixed_size_chunking_configuration : Option < Vec < BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElFixedSizeChunkingConfigurationEl > > , # [serde (skip_serializing_if = "Option::is_none")] hierarchical_chunking_configuration : Option < Vec < BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationEl > > , # [serde (skip_serializing_if = "Option::is_none")] semantic_chunking_configuration : Option < Vec < BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElSemanticChunkingConfigurationEl > > , dynamic : BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElDynamic , }
impl BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationEl {
    ...
    pub fn set_fixed_size_chunking_configuration(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElFixedSizeChunkingConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_hierarchical_chunking_configuration(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_semantic_chunking_configuration(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElSemanticChunkingConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElRef {
    ...
    #[doc = "Get a reference to the value of field `fixed_size_chunking_configuration` after provisioning.\n"]    pub fn fixed_size_chunking_configuration (& self) -> ListRef < BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElFixedSizeChunkingConfigurationElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.fixed_size_chunking_configuration", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `hierarchical_chunking_configuration` after provisioning.\n"]    pub fn hierarchical_chunking_configuration (& self) -> ListRef < BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElHierarchicalChunkingConfigurationElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.hierarchical_chunking_configuration", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `semantic_chunking_configuration` after provisioning.\n"]    pub fn semantic_chunking_configuration (& self) -> ListRef < BedrockagentDataSourceVectorIngestionConfigurationElChunkingConfigurationElSemanticChunkingConfigurationElRef >{
        ListRef::new(
            self.shared().clone(),
...
impl ToListMappable for BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageElS3LocationEl { type O = BlockAssignable < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageElS3LocationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageElS3LocationElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageElS3LocationElRef { BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageElS3LocationElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageElS3LocationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `uri` after provisioning.\n"] pub fn uri (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.uri" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageElDynamic { s3_location : Option < DynamicBlock < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageElS3LocationEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageEl { # [serde (skip_serializing_if = "Option::is_none")] s3_location : Option < Vec < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageElS3LocationEl > > , dynamic : BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageElDynamic , }
impl BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageEl { # [doc = "Set the field `s3_location`.\n"] pub fn set_s3_location (mut self , v : impl Into < BlockAssignable < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageElS3LocationEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . s3_location = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . s3_location = Some (d) ; } } self } }
impl ToListMappable for BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageEl { type O = BlockAssignable < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
{}
impl BuildBedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageEl { pub fn build (self) -> BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageEl { BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageEl { s3_location : core :: default :: Default :: default () , dynamic : Default :: default () , } } }
...
impl Ref for BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageElRef { BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `s3_location` after provisioning.\n"] pub fn s3_location (& self) -> ListRef < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageElS3LocationElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.s3_location" , self . base)) } }
#[derive(Serialize)]
...
impl Ref for BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionElTransformationLambdaConfigurationElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionElTransformationLambdaConfigurationElRef { BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionElTransformationLambdaConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionElTransformationLambdaConfigurationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `lambda_arn` after provisioning.\n"] pub fn lambda_arn (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.lambda_arn" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionElDynamic { transformation_lambda_configuration : Option < DynamicBlock < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionElTransformationLambdaConfigurationEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionEl { # [serde (skip_serializing_if = "Option::is_none")] transformation_lambda_configuration : Option < Vec < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionElTransformationLambdaConfigurationEl > > , dynamic : BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionElDynamic , }
impl BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionEl { # [doc = "Set the field `transformation_lambda_configuration`.\n"] pub fn set_transformation_lambda_configuration (mut self , v : impl Into < BlockAssignable < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionElTransformationLambdaConfigurationEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . transformation_lambda_configuration = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . transformation_lambda_configuration = Some (d) ; } } self } }
impl ToListMappable for BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionEl { type O = BlockAssignable < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionElRef { BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `transformation_lambda_configuration` after provisioning.\n"] pub fn transformation_lambda_configuration (& self) -> ListRef < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionElTransformationLambdaConfigurationElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.transformation_lambda_configuration" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElDynamic { transformation_function : Option < DynamicBlock < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationEl { step_to_apply : PrimField < String > , # [serde (skip_serializing_if = "Option::is_none")] transformation_function : Option < Vec < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionEl > > , dynamic : BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElDynamic , }
impl BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationEl { # [doc = "Set the field `transformation_function`.\n"] pub fn set_transformation_function (mut self , v : impl Into < BlockAssignable < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . transformation_function = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . transformation_function = Some (d) ; } } self } }
impl ToListMappable for BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationEl { type O = BlockAssignable < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl BuildBedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationEl { pub fn build (self) -> BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationEl { BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationEl { step_to_apply : self . step_to_apply , transformation_function : core :: default :: Default :: default () , dynamic : Default :: default () , } } }
pub struct BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElRef { BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `step_to_apply` after provisioning.\n"] pub fn step_to_apply (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.step_to_apply" , self . base)) } # [doc = "Get a reference to the value of field `transformation_function` after provisioning.\n"] pub fn transformation_function (& self) -> ListRef < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElTransformationFunctionElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.transformation_function" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElDynamic { intermediate_storage : Option < DynamicBlock < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageEl >> , transformation : Option < DynamicBlock < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationEl { # [serde (skip_serializing_if = "Option::is_none")] intermediate_storage : Option < Vec < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageEl > > , # [serde (skip_serializing_if = "Option::is_none")] transformation : Option < Vec < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationEl > > , dynamic : BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElDynamic , }
impl BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationEl {
    ...
    pub fn set_intermediate_storage(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_transformation(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElRef {
    ...
    #[doc = "Get a reference to the value of field `intermediate_storage` after provisioning.\n"]    pub fn intermediate_storage (& self) -> ListRef < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElIntermediateStorageElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.intermediate_storage", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `transformation` after provisioning.\n"]    pub fn transformation (& self) -> ListRef < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationElTransformationElRef >{
        ListRef::new(
            self.shared().clone(),
...
impl Ref for BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationElParsingPromptElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationElParsingPromptElRef { BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationElParsingPromptElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationElParsingPromptElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `parsing_prompt_string` after provisioning.\n"] pub fn parsing_prompt_string (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.parsing_prompt_string" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationElDynamic { parsing_prompt : Option < DynamicBlock < BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationElParsingPromptEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationEl { model_arn : PrimField < String > , # [serde (skip_serializing_if = "Option::is_none")] parsing_prompt : Option < Vec < BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationElParsingPromptEl > > , dynamic : BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationElDynamic , }
impl BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationEl { # [doc = "Set the field `parsing_prompt`.\n"] pub fn set_parsing_prompt (mut self , v : impl Into < BlockAssignable < BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationElParsingPromptEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . parsing_prompt = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . parsing_prompt = Some (d) ; } } self } }
impl ToListMappable for BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationEl { type O = BlockAssignable < BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationElRef { fn new (shared : StackShared , base : String) -> BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationElRef { BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `model_arn` after provisioning.\n"] pub fn model_arn (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.model_arn" , self . base)) } # [doc = "Get a reference to the value of field `parsing_prompt` after provisioning.\n"] pub fn parsing_prompt (& self) -> ListRef < BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationElParsingPromptElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.parsing_prompt" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElDynamic { bedrock_foundation_model_configuration : Option < DynamicBlock < BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationEl >> , }
#[derive(Serialize)]
pub struct BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationEl { parsing_strategy : PrimField < String > , # [serde (skip_serializing_if = "Option::is_none")] bedrock_foundation_model_configuration : Option < Vec < BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationEl > > , dynamic : BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElDynamic , }
impl BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationEl {
    ...
    pub fn set_bedrock_foundation_model_configuration(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElRef {
    ...
    #[doc = "Get a reference to the value of field `bedrock_foundation_model_configuration` after provisioning.\n"]    pub fn bedrock_foundation_model_configuration (& self) -> ListRef < BedrockagentDataSourceVectorIngestionConfigurationElParsingConfigurationElBedrockFoundationModelConfigurationElRef >{
        ListRef::new(
            self.shared().clone(),
...
impl BedrockagentDataSourceVectorIngestionConfigurationEl {
    ...
    pub fn set_custom_transformation_configuration(
        mut self,
        v : impl Into < BlockAssignable < BedrockagentDataSourceVectorIngestionConfigurationElCustomTransformationConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
