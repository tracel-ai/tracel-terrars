...
#[derive(Serialize)]
struct DocdbEventSubscriptionData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    timeouts: Option<DocdbEventSubscriptionTimeoutsEl>,
}

struct DocdbEventSubscription_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<DocdbEventSubscriptionData>,
}

#[derive(Clone)]
pub struct DocdbEventSubscription(Rc<DocdbEventSubscription_>);

impl DocdbEventSubscription {
    ...
    pub fn set_timeouts(self, v: impl Into<DocdbEventSubscriptionTimeoutsEl>) -> Self {
    ...
    pub fn timeouts(&self) -> DocdbEventSubscriptionTimeoutsElRef {
        DocdbEventSubscriptionTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
}

impl Referable for DocdbEventSubscription {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for DocdbEventSubscription { }

impl ToListMappable for DocdbEventSubscription {
    type O = ListRef<DocdbEventSubscriptionRef>;
...
impl Resource_ for DocdbEventSubscription_ {
    fn extract_resource_type(&self) -> String {
        "aws_docdb_event_subscription".into()
    }
...
pub struct BuildDocdbEventSubscription {
    pub tf_id: String,
    #[doc = ""]
    pub sns_topic_arn: PrimField<String>,
}

impl BuildDocdbEventSubscription {
    pub fn build(self, stack: &mut Stack) -> DocdbEventSubscription {
        let out = DocdbEventSubscription(Rc::new(DocdbEventSubscription_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(DocdbEventSubscriptionData {
...
pub struct DocdbEventSubscriptionRef {
    shared: StackShared,
    base: String,
}

impl Ref for DocdbEventSubscriptionRef {
...
impl DocdbEventSubscriptionRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
...
#[derive(Serialize)]
pub struct DocdbEventSubscriptionTimeoutsEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl DocdbEventSubscriptionTimeoutsEl {
...
impl ToListMappable for DocdbEventSubscriptionTimeoutsEl {
    type O = BlockAssignable<DocdbEventSubscriptionTimeoutsEl>;
...
pub struct BuildDocdbEventSubscriptionTimeoutsEl {}

impl BuildDocdbEventSubscriptionTimeoutsEl {
    pub fn build(self) -> DocdbEventSubscriptionTimeoutsEl {
        DocdbEventSubscriptionTimeoutsEl {
...
pub struct DocdbEventSubscriptionTimeoutsElRef {
    shared: StackShared,
    base: String,
}

impl Ref for DocdbEventSubscriptionTimeoutsElRef {
    fn new(shared: StackShared, base: String) -> DocdbEventSubscriptionTimeoutsElRef {
        DocdbEventSubscriptionTimeoutsElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl DocdbEventSubscriptionTimeoutsElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
