...
impl ToListMappable for TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElEfsFileLocationEl { type O = BlockAssignable < TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElEfsFileLocationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildTransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElEfsFileLocationEl
{}
impl BuildTransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElEfsFileLocationEl { pub fn build (self) -> TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElEfsFileLocationEl { TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElEfsFileLocationEl { file_system_id : core :: default :: Default :: default () , path : core :: default :: Default :: default () , } } }
pub struct TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElEfsFileLocationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElEfsFileLocationElRef { fn new (shared : StackShared , base : String) -> TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElEfsFileLocationElRef { TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElEfsFileLocationElRef { shared : shared , base : base . to_string () , } } }
impl
...
{
    type O = BlockAssignable < TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElS3FileLocationEl > ;
    fn do_map(self, base: String) -> Self::O {
...
{}
impl BuildTransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElS3FileLocationEl { pub fn build (self) -> TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElS3FileLocationEl { TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElS3FileLocationEl { bucket : core :: default :: Default :: default () , key : core :: default :: Default :: default () , } } }
pub struct TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElS3FileLocationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElS3FileLocationElRef { fn new (shared : StackShared , base : String) -> TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElS3FileLocationElRef { TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElS3FileLocationElRef { shared : shared , base : base . to_string () , } } }
impl
    TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElS3FileLocationElRef
{
    fn shared(&self) -> &StackShared {
...
struct TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElDynamic { efs_file_location : Option < DynamicBlock < TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElEfsFileLocationEl >> , s3_file_location : Option < DynamicBlock < TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElS3FileLocationEl >> , }
#[derive(Serialize)]
pub struct TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationEl { # [serde (skip_serializing_if = "Option::is_none")] efs_file_location : Option < Vec < TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElEfsFileLocationEl > > , # [serde (skip_serializing_if = "Option::is_none")] s3_file_location : Option < Vec < TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElS3FileLocationEl > > , dynamic : TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElDynamic , }
impl TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationEl {
    ...
    pub fn set_efs_file_location(
        mut self,
        v : impl Into < BlockAssignable < TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElEfsFileLocationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_s3_file_location(
        mut self,
        v : impl Into < BlockAssignable < TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElS3FileLocationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElRef {
    ...
    #[doc = "Get a reference to the value of field `efs_file_location` after provisioning.\n"]    pub fn efs_file_location (& self) -> ListRef < TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElEfsFileLocationElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.efs_file_location", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `s3_file_location` after provisioning.\n"]    pub fn s3_file_location (& self) -> ListRef < TransferWorkflowOnExceptionStepsElCopyStepDetailsElDestinationFileLocationElS3FileLocationElRef >{
        ListRef::new(
            self.shared().clone(),
...
impl ToListMappable for TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElEfsFileLocationEl { type O = BlockAssignable < TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElEfsFileLocationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildTransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElEfsFileLocationEl
{}
impl BuildTransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElEfsFileLocationEl { pub fn build (self) -> TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElEfsFileLocationEl { TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElEfsFileLocationEl { file_system_id : core :: default :: Default :: default () , path : core :: default :: Default :: default () , } } }
pub struct TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElEfsFileLocationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElEfsFileLocationElRef { fn new (shared : StackShared , base : String) -> TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElEfsFileLocationElRef { TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElEfsFileLocationElRef { shared : shared , base : base . to_string () , } } }
impl TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElEfsFileLocationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `file_system_id` after provisioning.\n"] pub fn file_system_id (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.file_system_id" , self . base)) } # [doc = "Get a reference to the value of field `path` after provisioning.\n"] pub fn path (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.path" , self . base)) } }
#[derive(Serialize)]
...
impl ToListMappable for TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationEl { type O = BlockAssignable < TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildTransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationEl
{}
impl BuildTransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationEl { pub fn build (self) -> TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationEl { TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationEl { bucket : core :: default :: Default :: default () , key : core :: default :: Default :: default () , } } }
pub struct TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationElRef { fn new (shared : StackShared , base : String) -> TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationElRef { TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationElRef { shared : shared , base : base . to_string () , } } }
impl TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `bucket` after provisioning.\n"] pub fn bucket (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.bucket" , self . base)) } # [doc = "Get a reference to the value of field `key` after provisioning.\n"] pub fn key (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.key" , self . base)) } }
#[derive(Serialize, Default)]
struct TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElDynamic { efs_file_location : Option < DynamicBlock < TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElEfsFileLocationEl >> , s3_file_location : Option < DynamicBlock < TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationEl >> , }
#[derive(Serialize)]
pub struct TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationEl { # [serde (skip_serializing_if = "Option::is_none")] efs_file_location : Option < Vec < TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElEfsFileLocationEl > > , # [serde (skip_serializing_if = "Option::is_none")] s3_file_location : Option < Vec < TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationEl > > , dynamic : TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElDynamic , }
impl TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationEl {
    #[doc = "Set the field `efs_file_location`.\n"]
    pub fn set_efs_file_location(
        mut self,
        v : impl Into < BlockAssignable < TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElEfsFileLocationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.efs_file_location = Some(v);
    ...
    pub fn set_s3_file_location(
        mut self,
        v : impl Into < BlockAssignable < TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.s3_file_location = Some(v);
...
pub struct TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElRef {
    shared: StackShared,
    base: String,
}
impl Ref for TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElRef {
    fn new(
        shared: StackShared,
        base: String,
    ) -> TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElRef {
        TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElRef {
            shared: shared,
            base: base.to_string(),
        }
...
impl TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    #[doc = "Get a reference to the value of field `efs_file_location` after provisioning.\n"]    pub fn efs_file_location (& self) -> ListRef < TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElEfsFileLocationElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.efs_file_location", self.base),
        )
    }
    #[doc = "Get a reference to the value of field `s3_file_location` after provisioning.\n"]    pub fn s3_file_location (& self) -> ListRef < TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.s3_file_location", self.base),
        )
...
#[derive(Serialize)]
pub struct TransferWorkflowOnExceptionStepsElDecryptStepDetailsEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    name: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    overwrite_existing: Option<PrimField<String>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    destination_file_location: Option<
        Vec<TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDestinationFileLocationEl>,
    >,
    dynamic: TransferWorkflowOnExceptionStepsElDecryptStepDetailsElDynamic,
}
impl TransferWorkflowOnExceptionStepsElDecryptStepDetailsEl {
    #[doc = "Set the field `name`.\n"]
    pub fn set_name(mut self, v: impl Into<PrimField<String>>) -> Self {
        self.name = Some(v.into());
        self
...
impl ToListMappable for TransferWorkflowOnExceptionStepsElDecryptStepDetailsEl {
    type O = BlockAssignable<TransferWorkflowOnExceptionStepsElDecryptStepDetailsEl>;
    fn do_map(self, base: String) -> Self::O {
        BlockAssignable::Dynamic(DynamicBlock {
            for_each: format!("${{{}}}", base),
            iterator: "each".into(),
...
pub struct BuildTransferWorkflowOnExceptionStepsElDecryptStepDetailsEl {
    #[doc = ""]
    pub type_: PrimField<String>,
}
impl BuildTransferWorkflowOnExceptionStepsElDecryptStepDetailsEl {
    pub fn build(self) -> TransferWorkflowOnExceptionStepsElDecryptStepDetailsEl {
        TransferWorkflowOnExceptionStepsElDecryptStepDetailsEl {
            name: core::default::Default::default(),
            overwrite_existing: core::default::Default::default(),
            source_file_location: core::default::Default::default(),
            type_: self.type_,
...
pub struct TransferWorkflowOnExceptionStepsElDecryptStepDetailsElRef {
    shared: StackShared,
    base: String,
}
...
impl TransferWorkflowOnExceptionStepsElDecryptStepDetailsElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    #[doc = "Get a reference to the value of field `name` after provisioning.\n"]
...
pub struct TransferWorkflowOnExceptionStepsEl {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    decrypt_step_details: Option<Vec<TransferWorkflowOnExceptionStepsElDecryptStepDetailsEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl TransferWorkflowOnExceptionStepsEl {
    ...
    #[doc = "Set the field `decrypt_step_details`.\n"]
    pub fn set_decrypt_step_details(
        mut self,
        v: impl Into<BlockAssignable<TransferWorkflowOnExceptionStepsElDecryptStepDetailsEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl BuildTransferWorkflowOnExceptionStepsEl {
    pub fn build(self) -> TransferWorkflowOnExceptionStepsEl {
        TransferWorkflowOnExceptionStepsEl {
            ...
            decrypt_step_details: core::default::Default::default(),
...
#[derive(Serialize)]
pub struct TransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationElEfsFileLocationEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    file_system_id: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    path: Option<PrimField<String>>,
}
impl TransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationElEfsFileLocationEl {
    #[doc = "Set the field `file_system_id`.\n"]
    pub fn set_file_system_id(mut self, v: impl Into<PrimField<String>>) -> Self {
        self.file_system_id = Some(v.into());
        self
...
impl TransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationElEfsFileLocationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    #[doc = "Get a reference to the value of field `file_system_id` after provisioning.\n"]
...
#[derive(Serialize)]
pub struct TransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    bucket: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    key: Option<PrimField<String>>,
}
impl TransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationEl {
    #[doc = "Set the field `bucket`.\n"]
    pub fn set_bucket(mut self, v: impl Into<PrimField<String>>) -> Self {
        self.bucket = Some(v.into());
        self
...
pub struct TransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationElRef {
    shared: StackShared,
    base: String,
}
impl Ref
...
impl TransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    #[doc = "Get a reference to the value of field `bucket` after provisioning.\n"]
...
impl TransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationEl {
    #[doc = "Set the field `efs_file_location`.\n"]
    pub fn set_efs_file_location(
        mut self,
        v : impl Into < BlockAssignable < TransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationElEfsFileLocationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.efs_file_location = Some(v);
    ...
    pub fn set_s3_file_location(
        mut self,
        v : impl Into < BlockAssignable < TransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationElS3FileLocationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.s3_file_location = Some(v);
...
impl ToListMappable for TransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationEl {
    type O = BlockAssignable<TransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationEl>;
    fn do_map(self, base: String) -> Self::O {
        BlockAssignable::Dynamic(DynamicBlock {
            for_each: format!("${{{}}}", base),
            iterator: "each".into(),
...
pub struct BuildTransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationEl {}
impl BuildTransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationEl {
    pub fn build(self) -> TransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationEl {
        TransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationEl {
            efs_file_location: core::default::Default::default(),
            s3_file_location: core::default::Default::default(),
            dynamic: Default::default(),
        }
...
pub struct TransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationElRef {
    shared: StackShared,
    base: String,
}
impl Ref for TransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationElRef {
    fn new(
        shared: StackShared,
        base: String,
    ) -> TransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationElRef {
        TransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationElRef {
            shared: shared,
            base: base.to_string(),
        }
...
impl TransferWorkflowStepsElDecryptStepDetailsElDestinationFileLocationElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    #[doc = "Get a reference to the value of field `efs_file_location` after provisioning.\n"]
...
#[derive(Serialize)]
pub struct TransferWorkflowStepsElDecryptStepDetailsEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    name: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    overwrite_existing: Option<PrimField<String>>,
...
impl TransferWorkflowStepsElDecryptStepDetailsEl {
    #[doc = "Set the field `name`.\n"]
    pub fn set_name(mut self, v: impl Into<PrimField<String>>) -> Self {
        self.name = Some(v.into());
        self
...
impl ToListMappable for TransferWorkflowStepsElDecryptStepDetailsEl {
    type O = BlockAssignable<TransferWorkflowStepsElDecryptStepDetailsEl>;
    fn do_map(self, base: String) -> Self::O {
        BlockAssignable::Dynamic(DynamicBlock {
            for_each: format!("${{{}}}", base),
            iterator: "each".into(),
...
pub struct BuildTransferWorkflowStepsElDecryptStepDetailsEl {
    #[doc = ""]
    pub type_: PrimField<String>,
}
impl BuildTransferWorkflowStepsElDecryptStepDetailsEl {
    pub fn build(self) -> TransferWorkflowStepsElDecryptStepDetailsEl {
        TransferWorkflowStepsElDecryptStepDetailsEl {
            name: core::default::Default::default(),
            overwrite_existing: core::default::Default::default(),
            source_file_location: core::default::Default::default(),
            type_: self.type_,
...
pub struct TransferWorkflowStepsElDecryptStepDetailsElRef {
    shared: StackShared,
    base: String,
}
impl Ref for TransferWorkflowStepsElDecryptStepDetailsElRef {
    fn new(shared: StackShared, base: String) -> TransferWorkflowStepsElDecryptStepDetailsElRef {
        TransferWorkflowStepsElDecryptStepDetailsElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
}
impl TransferWorkflowStepsElDecryptStepDetailsElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    #[doc = "Get a reference to the value of field `name` after provisioning.\n"]
...
struct TransferWorkflowStepsElDynamic {
    ...
    decrypt_step_details: Option<DynamicBlock<TransferWorkflowStepsElDecryptStepDetailsEl>>,
...
pub struct TransferWorkflowStepsEl {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    decrypt_step_details: Option<Vec<TransferWorkflowStepsElDecryptStepDetailsEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl TransferWorkflowStepsEl {
    ...
    pub fn set_decrypt_step_details(
        mut self,
        v: impl Into<BlockAssignable<TransferWorkflowStepsElDecryptStepDetailsEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.decrypt_step_details = Some(v);
