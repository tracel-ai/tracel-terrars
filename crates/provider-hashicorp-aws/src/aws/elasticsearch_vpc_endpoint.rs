...
struct ElasticsearchVpcEndpointData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    timeouts: Option<ElasticsearchVpcEndpointTimeoutsEl>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl ElasticsearchVpcEndpoint {
    ...
    pub fn set_vpc_options(self, v: impl Into<BlockAssignable<ElasticsearchVpcEndpointVpcOptionsEl>>) -> Self {
        match v.into() {
    ...
    pub fn domain_arn(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.domain_arn", self.extract_ref()))
    }
    ...
    pub fn timeouts(&self) -> ElasticsearchVpcEndpointTimeoutsElRef {
        ElasticsearchVpcEndpointTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
...
impl BuildElasticsearchVpcEndpoint {
    pub fn build(self, stack: &mut Stack) -> ElasticsearchVpcEndpoint {
        let out = ElasticsearchVpcEndpoint(Rc::new(ElasticsearchVpcEndpoint_ {
            ...
            tf_id: self.tf_id,
            data: RefCell::new(ElasticsearchVpcEndpointData {
