...
impl Wafv2RegexPatternSet {
    ...
    pub fn set_regular_expression(
        self,
        v: impl Into<BlockAssignable<Wafv2RegexPatternSetRegularExpressionEl>>,
    ) -> Self {
        match v.into() {
...
impl Referable for Wafv2RegexPatternSet {
...
impl BuildWafv2RegexPatternSetRegularExpressionEl {
    pub fn build(self) -> Wafv2RegexPatternSetRegularExpressionEl {
        Wafv2RegexPatternSetRegularExpressionEl {
