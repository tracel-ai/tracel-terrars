...
#[derive(Clone)]
pub struct SecurityhubConfigurationPolicyAssociation(Rc<SecurityhubConfigurationPolicyAssociation_>);
...
impl SecurityhubConfigurationPolicyAssociation {
    ...
    pub fn set_timeouts(self, v: impl Into<SecurityhubConfigurationPolicyAssociationTimeoutsEl>) -> Self {
    ...
    #[doc =
        "Get a reference to the value of field `policy_id` after provisioning.\nThe universally unique identifier (UUID) of the configuration policy."]
    ...
    #[doc =
        "Get a reference to the value of field `target_id` after provisioning.\nThe identifier of the target account, organizational unit, or the root to associate with the specified configuration."]
...
impl BuildSecurityhubConfigurationPolicyAssociation {
    pub fn build(self, stack: &mut Stack) -> SecurityhubConfigurationPolicyAssociation {
        let out = SecurityhubConfigurationPolicyAssociation(Rc::new(SecurityhubConfigurationPolicyAssociation_ {
...
impl Ref for SecurityhubConfigurationPolicyAssociationTimeoutsElRef {
    fn new(shared: StackShared, base: String) -> SecurityhubConfigurationPolicyAssociationTimeoutsElRef {
