...
impl SagemakerUserProfileUserSettingsElCanvasAppSettingsEl {
    ...
    pub fn set_identity_provider_oauth_settings(
        mut self,
        v : impl Into < BlockAssignable < SagemakerUserProfileUserSettingsElCanvasAppSettingsElIdentityProviderOauthSettingsEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_time_series_forecasting_settings(
        mut self,
        v : impl Into < BlockAssignable < SagemakerUserProfileUserSettingsElCanvasAppSettingsElTimeSeriesForecastingSettingsEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl SagemakerUserProfileUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementEl {
    ...
    pub fn set_idle_settings(
        mut self,
        v : impl Into < BlockAssignable < SagemakerUserProfileUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElIdleSettingsEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl SagemakerUserProfileUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElRef {
    ...
    #[doc = "Get a reference to the value of field `idle_settings` after provisioning.\n"]    pub fn idle_settings (& self) -> ListRef < SagemakerUserProfileUserSettingsElCodeEditorAppSettingsElAppLifecycleManagementElIdleSettingsElRef >{
        ListRef::new(
            self.shared().clone(),
...
impl ToListMappable for SagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl { type O = BlockAssignable < SagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildSagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl
{}
impl BuildSagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl { pub fn build (self) -> SagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl { SagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl { idle_timeout_in_minutes : core :: default :: Default :: default () , lifecycle_management : core :: default :: Default :: default () , max_idle_timeout_in_minutes : core :: default :: Default :: default () , min_idle_timeout_in_minutes : core :: default :: Default :: default () , } } }
pub struct SagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for SagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsElRef { fn new (shared : StackShared , base : String) -> SagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsElRef { SagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsElRef { shared : shared , base : base . to_string () , } } }
impl SagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `idle_timeout_in_minutes` after provisioning.\n"] pub fn idle_timeout_in_minutes (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.idle_timeout_in_minutes" , self . base)) } # [doc = "Get a reference to the value of field `lifecycle_management` after provisioning.\n"] pub fn lifecycle_management (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.lifecycle_management" , self . base)) } # [doc = "Get a reference to the value of field `max_idle_timeout_in_minutes` after provisioning.\n"] pub fn max_idle_timeout_in_minutes (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.max_idle_timeout_in_minutes" , self . base)) } # [doc = "Get a reference to the value of field `min_idle_timeout_in_minutes` after provisioning.\n"] pub fn min_idle_timeout_in_minutes (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.min_idle_timeout_in_minutes" , self . base)) } }
#[derive(Serialize, Default)]
struct SagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElDynamic { idle_settings : Option < DynamicBlock < SagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl >> , }
#[derive(Serialize)]
pub struct SagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementEl { # [serde (skip_serializing_if = "Option::is_none")] idle_settings : Option < Vec < SagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl > > , dynamic : SagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElDynamic , }
impl SagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementEl {
    #[doc = "Set the field `idle_settings`.\n"]
    pub fn set_idle_settings(
        mut self,
        v : impl Into < BlockAssignable < SagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.idle_settings = Some(v);
...
impl SagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElRef {
    ...
    #[doc = "Get a reference to the value of field `idle_settings` after provisioning.\n"]    pub fn idle_settings (& self) -> ListRef < SagemakerUserProfileUserSettingsElJupyterLabAppSettingsElAppLifecycleManagementElIdleSettingsElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.idle_settings", self.base),
        )
