...
impl WafregionalWebAcl {
    ...
    pub fn set_default_action(
        self,
        v: impl Into<BlockAssignable<WafregionalWebAclDefaultActionEl>>,
    ) -> Self {
        match v.into() {
...
impl WafregionalWebAclLoggingConfigurationElRedactedFieldsEl {
    ...
    pub fn set_field_to_match(
        mut self,
        v: impl Into<
            BlockAssignable<WafregionalWebAclLoggingConfigurationElRedactedFieldsElFieldToMatchEl>,
        >,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl WafregionalWebAclLoggingConfigurationElRef {
    ...
    pub fn redacted_fields(
        &self,
    ) -> ListRef<WafregionalWebAclLoggingConfigurationElRedactedFieldsElRef> {
        ListRef::new(
            self.shared().clone(),
...
impl WafregionalWebAclRuleEl {
    ...
    pub fn set_action(
        mut self,
        v: impl Into<BlockAssignable<WafregionalWebAclRuleElActionEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.action = Some(v);
