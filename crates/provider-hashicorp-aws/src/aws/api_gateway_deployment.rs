...
#[derive(Serialize)]
struct ApiGatewayDeploymentData {
...
struct ApiGatewayDeployment_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<ApiGatewayDeploymentData>,
}

#[derive(Clone)]
pub struct ApiGatewayDeployment(Rc<ApiGatewayDeployment_>);

impl ApiGatewayDeployment {
...
impl Referable for ApiGatewayDeployment {
...
impl Resource for ApiGatewayDeployment {}

impl ToListMappable for ApiGatewayDeployment {
    type O = ListRef<ApiGatewayDeploymentRef>;
...
impl Resource_ for ApiGatewayDeployment_ {
    fn extract_resource_type(&self) -> String {
        "aws_api_gateway_deployment".into()
    }
...
pub struct BuildApiGatewayDeployment {
    pub tf_id: String,
    #[doc = ""]
    pub rest_api_id: PrimField<String>,
}

impl BuildApiGatewayDeployment {
    pub fn build(self, stack: &mut Stack) -> ApiGatewayDeployment {
        let out = ApiGatewayDeployment(Rc::new(ApiGatewayDeployment_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(ApiGatewayDeploymentData {
...
pub struct ApiGatewayDeploymentRef {
    shared: StackShared,
    base: String,
}

impl Ref for ApiGatewayDeploymentRef {
    fn new(shared: StackShared, base: String) -> Self {
        Self { shared, base }
    }
}

impl ApiGatewayDeploymentRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
