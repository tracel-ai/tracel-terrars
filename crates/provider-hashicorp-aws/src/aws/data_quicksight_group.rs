...
use terrars::*;
#[derive(Serialize)]
struct DataQuicksightGroupData {
...
struct DataQuicksightGroup_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<DataQuicksightGroupData>,
}
#[derive(Clone)]
pub struct DataQuicksightGroup(Rc<DataQuicksightGroup_>);
impl DataQuicksightGroup {
...
impl Referable for DataQuicksightGroup {
...
impl Datasource for DataQuicksightGroup {}
impl ToListMappable for DataQuicksightGroup {
    type O = ListRef<DataQuicksightGroupRef>;
    fn do_map(self, base: String) -> Self::O {
        self.0.data.borrow_mut().for_each = Some(format!("${{{}}}", base));
        ListRef::new(self.0.shared.clone(), self.extract_ref())
    }
}
impl Datasource_ for DataQuicksightGroup_ {
...
pub struct BuildDataQuicksightGroup {
    pub tf_id: String,
    #[doc = ""]
    pub group_name: PrimField<String>,
}
impl BuildDataQuicksightGroup {
    pub fn build(self, stack: &mut Stack) -> DataQuicksightGroup {
        let out = DataQuicksightGroup(Rc::new(DataQuicksightGroup_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(DataQuicksightGroupData {
...
pub struct DataQuicksightGroupRef {
    shared: StackShared,
    base: String,
}
impl Ref for DataQuicksightGroupRef {
    fn new(shared: StackShared, base: String) -> Self {
        Self { shared, base }
    }
}
impl DataQuicksightGroupRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    fn extract_ref(&self) -> String {
