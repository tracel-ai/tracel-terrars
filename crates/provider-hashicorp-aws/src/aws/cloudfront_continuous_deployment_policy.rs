...
impl ToListMappable for CloudfrontContinuousDeploymentPolicyTrafficConfigElSingleWeightConfigElSessionStickinessConfigEl { type O = BlockAssignable < CloudfrontContinuousDeploymentPolicyTrafficConfigElSingleWeightConfigElSessionStickinessConfigEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl BuildCloudfrontContinuousDeploymentPolicyTrafficConfigElSingleWeightConfigElSessionStickinessConfigEl { pub fn build (self) -> CloudfrontContinuousDeploymentPolicyTrafficConfigElSingleWeightConfigElSessionStickinessConfigEl { CloudfrontContinuousDeploymentPolicyTrafficConfigElSingleWeightConfigElSessionStickinessConfigEl { idle_ttl : self . idle_ttl , maximum_ttl : self . maximum_ttl , } } }
pub struct CloudfrontContinuousDeploymentPolicyTrafficConfigElSingleWeightConfigElSessionStickinessConfigElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for CloudfrontContinuousDeploymentPolicyTrafficConfigElSingleWeightConfigElSessionStickinessConfigElRef { fn new (shared : StackShared , base : String) -> CloudfrontContinuousDeploymentPolicyTrafficConfigElSingleWeightConfigElSessionStickinessConfigElRef { CloudfrontContinuousDeploymentPolicyTrafficConfigElSingleWeightConfigElSessionStickinessConfigElRef { shared : shared , base : base . to_string () , } } }
impl CloudfrontContinuousDeploymentPolicyTrafficConfigElSingleWeightConfigElSessionStickinessConfigElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `idle_ttl` after provisioning.\n"] pub fn idle_ttl (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.idle_ttl" , self . base)) } # [doc = "Get a reference to the value of field `maximum_ttl` after provisioning.\n"] pub fn maximum_ttl (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.maximum_ttl" , self . base)) } }
#[derive(Serialize, Default)]
struct CloudfrontContinuousDeploymentPolicyTrafficConfigElSingleWeightConfigElDynamic { session_stickiness_config : Option < DynamicBlock < CloudfrontContinuousDeploymentPolicyTrafficConfigElSingleWeightConfigElSessionStickinessConfigEl >> , }
#[derive(Serialize)]
pub struct CloudfrontContinuousDeploymentPolicyTrafficConfigElSingleWeightConfigEl { weight : PrimField < f64 > , # [serde (skip_serializing_if = "Option::is_none")] session_stickiness_config : Option < Vec < CloudfrontContinuousDeploymentPolicyTrafficConfigElSingleWeightConfigElSessionStickinessConfigEl > > , dynamic : CloudfrontContinuousDeploymentPolicyTrafficConfigElSingleWeightConfigElDynamic , }
impl CloudfrontContinuousDeploymentPolicyTrafficConfigElSingleWeightConfigEl {
    ...
    pub fn set_session_stickiness_config(
        mut self,
        v : impl Into < BlockAssignable < CloudfrontContinuousDeploymentPolicyTrafficConfigElSingleWeightConfigElSessionStickinessConfigEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl CloudfrontContinuousDeploymentPolicyTrafficConfigElSingleWeightConfigElRef {
    ...
    #[doc = "Get a reference to the value of field `session_stickiness_config` after provisioning.\n"]    pub fn session_stickiness_config (& self) -> ListRef < CloudfrontContinuousDeploymentPolicyTrafficConfigElSingleWeightConfigElSessionStickinessConfigElRef >{
        ListRef::new(
            self.shared().clone(),
