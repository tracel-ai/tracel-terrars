...
use terrars::*;
#[derive(Serialize)]
struct QuicksightUserCustomPermissionData {
...
struct QuicksightUserCustomPermission_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<QuicksightUserCustomPermissionData>,
}
#[derive(Clone)]
pub struct QuicksightUserCustomPermission(Rc<QuicksightUserCustomPermission_>);
impl QuicksightUserCustomPermission {
...
impl Referable for QuicksightUserCustomPermission {
...
impl Resource for QuicksightUserCustomPermission {}
impl ToListMappable for QuicksightUserCustomPermission {
    type O = ListRef<QuicksightUserCustomPermissionRef>;
    fn do_map(self, base: String) -> Self::O {
        self.0.data.borrow_mut().for_each = Some(format!("${{{}}}", base));
        ListRef::new(self.0.shared.clone(), self.extract_ref())
    }
}
impl Resource_ for QuicksightUserCustomPermission_ {
    fn extract_resource_type(&self) -> String {
        "aws_quicksight_user_custom_permission".into()
    }
...
pub struct BuildQuicksightUserCustomPermission {
    pub tf_id: String,
    #[doc = ""]
...
impl BuildQuicksightUserCustomPermission {
    pub fn build(self, stack: &mut Stack) -> QuicksightUserCustomPermission {
        let out = QuicksightUserCustomPermission(Rc::new(QuicksightUserCustomPermission_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(QuicksightUserCustomPermissionData {
...
pub struct QuicksightUserCustomPermissionRef {
    shared: StackShared,
    base: String,
}
impl Ref for QuicksightUserCustomPermissionRef {
    fn new(shared: StackShared, base: String) -> Self {
        Self { shared, base }
    }
}
impl QuicksightUserCustomPermissionRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
    fn shared(&self) -> &StackShared {
