...
impl LbTargetGroup {
    ...
    pub fn set_health_check(
        self,
        v: impl Into<BlockAssignable<LbTargetGroupHealthCheckEl>>,
    ) -> Self {
        match v.into() {
    ...
    pub fn set_target_failover(
        self,
        v: impl Into<BlockAssignable<LbTargetGroupTargetFailoverEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_target_group_health(
        self,
        v: impl Into<BlockAssignable<LbTargetGroupTargetGroupHealthEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn set_target_health_state(
        self,
        v: impl Into<BlockAssignable<LbTargetGroupTargetHealthStateEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn target_health_state(&self) -> ListRef<LbTargetGroupTargetHealthStateElRef> {
        ListRef::new(
            self.shared().clone(),
            format!("{}.target_health_state", self.extract_ref()),
        )
    }
}
...
impl LbTargetGroupTargetGroupHealthElDnsFailoverElRef {
    ...
    pub fn minimum_healthy_targets_percentage(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.minimum_healthy_targets_percentage", self.base),
        )
    }
}
...
impl LbTargetGroupTargetGroupHealthElRef {
    ...
    pub fn unhealthy_state_routing(
        &self,
    ) -> ListRef<LbTargetGroupTargetGroupHealthElUnhealthyStateRoutingElRef> {
        ListRef::new(
            self.shared().clone(),
            format!("{}.unhealthy_state_routing", self.base),
        )
    }
}
...
impl LbTargetGroupTargetHealthStateElRef {
    ...
    pub fn unhealthy_draining_interval(&self) -> PrimExpr<f64> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.unhealthy_draining_interval", self.base),
        )
    }
}
