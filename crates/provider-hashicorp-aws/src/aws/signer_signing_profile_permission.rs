...
struct SignerSigningProfilePermissionData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    profile_version: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
struct SignerSigningProfilePermission_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<SignerSigningProfilePermissionData>,
}
#[derive(Clone)]
pub struct SignerSigningProfilePermission(Rc<SignerSigningProfilePermission_>);
impl SignerSigningProfilePermission {
    ...
    #[doc = "Set the field `profile_version`.\n"]
    pub fn set_profile_version(self, v: impl Into<PrimField<String>>) -> Self {
        self.0.data.borrow_mut().profile_version = Some(v.into());
        self
    }
...
impl Resource_ for SignerSigningProfilePermission_ {
    fn extract_resource_type(&self) -> String {
        "aws_signer_signing_profile_permission".into()
    }
...
pub struct BuildSignerSigningProfilePermission {
    pub tf_id: String,
    #[doc = ""]
...
impl BuildSignerSigningProfilePermission {
    pub fn build(self, stack: &mut Stack) -> SignerSigningProfilePermission {
        let out = SignerSigningProfilePermission(Rc::new(SignerSigningProfilePermission_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(SignerSigningProfilePermissionData {
                ...
                profile_version: core::default::Default::default(),
...
pub struct SignerSigningProfilePermissionRef {
    shared: StackShared,
    base: String,
}
...
impl SignerSigningProfilePermissionRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
    fn shared(&self) -> &StackShared {
