...
#[derive(Serialize)]
struct PinpointApnsSandboxChannelData {
...
struct PinpointApnsSandboxChannel_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<PinpointApnsSandboxChannelData>,
}

#[derive(Clone)]
pub struct PinpointApnsSandboxChannel(Rc<PinpointApnsSandboxChannel_>);

impl PinpointApnsSandboxChannel {
    ...
    pub fn token_key_id(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.token_key_id", self.extract_ref()),
        )
    }
}

impl Referable for PinpointApnsSandboxChannel {
...
impl Resource for PinpointApnsSandboxChannel {}

impl ToListMappable for PinpointApnsSandboxChannel {
    type O = ListRef<PinpointApnsSandboxChannelRef>;
...
impl Resource_ for PinpointApnsSandboxChannel_ {
    fn extract_resource_type(&self) -> String {
        "aws_pinpoint_apns_sandbox_channel".into()
    }
...
pub struct BuildPinpointApnsSandboxChannel {
    pub tf_id: String,
    #[doc = ""]
    pub application_id: PrimField<String>,
}

impl BuildPinpointApnsSandboxChannel {
    pub fn build(self, stack: &mut Stack) -> PinpointApnsSandboxChannel {
        let out = PinpointApnsSandboxChannel(Rc::new(PinpointApnsSandboxChannel_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(PinpointApnsSandboxChannelData {
...
pub struct PinpointApnsSandboxChannelRef {
    shared: StackShared,
    base: String,
}

impl Ref for PinpointApnsSandboxChannelRef {
    fn new(shared: StackShared, base: String) -> Self {
        Self { shared, base }
    }
}

impl PinpointApnsSandboxChannelRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
