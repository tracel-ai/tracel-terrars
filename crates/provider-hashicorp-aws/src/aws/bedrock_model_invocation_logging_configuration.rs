...
impl BedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigElLargeDataDeliveryS3ConfigEl { # [doc = "Set the field `bucket_name`.\n"] pub fn set_bucket_name (mut self , v : impl Into < PrimField < String > >) -> Self { self . bucket_name = Some (v . into ()) ; self } # [doc = "Set the field `key_prefix`.\n"] pub fn set_key_prefix (mut self , v : impl Into < PrimField < String > >) -> Self { self . key_prefix = Some (v . into ()) ; self } }
impl ToListMappable for BedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigElLargeDataDeliveryS3ConfigEl { type O = BlockAssignable < BedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigElLargeDataDeliveryS3ConfigEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildBedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigElLargeDataDeliveryS3ConfigEl
{}
impl BuildBedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigElLargeDataDeliveryS3ConfigEl { pub fn build (self) -> BedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigElLargeDataDeliveryS3ConfigEl { BedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigElLargeDataDeliveryS3ConfigEl { bucket_name : core :: default :: Default :: default () , key_prefix : core :: default :: Default :: default () , } } }
pub struct BedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigElLargeDataDeliveryS3ConfigElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for BedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigElLargeDataDeliveryS3ConfigElRef { fn new (shared : StackShared , base : String) -> BedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigElLargeDataDeliveryS3ConfigElRef { BedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigElLargeDataDeliveryS3ConfigElRef { shared : shared , base : base . to_string () , } } }
impl BedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigElLargeDataDeliveryS3ConfigElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `bucket_name` after provisioning.\n"] pub fn bucket_name (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.bucket_name" , self . base)) } # [doc = "Get a reference to the value of field `key_prefix` after provisioning.\n"] pub fn key_prefix (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.key_prefix" , self . base)) } }
#[derive(Serialize, Default)]
struct BedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigElDynamic { large_data_delivery_s3_config : Option < DynamicBlock < BedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigElLargeDataDeliveryS3ConfigEl >> , }
#[derive(Serialize)]
pub struct BedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigEl { # [serde (skip_serializing_if = "Option::is_none")] log_group_name : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] role_arn : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] large_data_delivery_s3_config : Option < Vec < BedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigElLargeDataDeliveryS3ConfigEl > > , dynamic : BedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigElDynamic , }
impl BedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigEl {
    ...
    pub fn set_large_data_delivery_s3_config(
        mut self,
        v : impl Into < BlockAssignable < BedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigElLargeDataDeliveryS3ConfigEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl BedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigElRef {
    ...
    #[doc = "Get a reference to the value of field `large_data_delivery_s3_config` after provisioning.\n"]    pub fn large_data_delivery_s3_config (& self) -> ListRef < BedrockModelInvocationLoggingConfigurationLoggingConfigElCloudwatchConfigElLargeDataDeliveryS3ConfigElRef >{
        ListRef::new(
            self.shared().clone(),
