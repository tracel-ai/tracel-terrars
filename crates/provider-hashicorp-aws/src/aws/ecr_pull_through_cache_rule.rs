...
struct EcrPullThroughCacheRuleData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    credential_arn: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl EcrPullThroughCacheRule {
    ...
    pub fn credential_arn(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.credential_arn", self.extract_ref()))
    }
    ...
    pub fn upstream_repository_prefix(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.upstream_repository_prefix", self.extract_ref()))
    }
}
    ...
    pub fn build(self, stack: &mut Stack) -> EcrPullThroughCacheRule {
        let out = EcrPullThroughCacheRule(Rc::new(EcrPullThroughCacheRule_ {
            ...
            data: RefCell::new(EcrPullThroughCacheRuleData {
                ...
                for_each: None,
                credential_arn: core::default::Default::default(),
                ...
                upstream_repository_prefix: core::default::Default::default(),
            }),
        }));
