...
struct DataIamUser_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<DataIamUserData>,
}
#[derive(Clone)]
pub struct DataIamUser(Rc<DataIamUser_>);
impl DataIamUser {
...
impl Referable for DataIamUser {
...
impl Datasource for DataIamUser {}
impl ToListMappable for DataIamUser {
    type O = ListRef<DataIamUserRef>;
    fn do_map(self, base: String) -> Self::O {
        self.0.data.borrow_mut().for_each = Some(format!("${{{}}}", base));
        ListRef::new(self.0.shared.clone(), self.extract_ref())
    }
}
impl Datasource_ for DataIamUser_ {
...
pub struct BuildDataIamUser {
    pub tf_id: String,
    #[doc = ""]
    pub user_name: PrimField<String>,
}
impl BuildDataIamUser {
    pub fn build(self, stack: &mut Stack) -> DataIamUser {
        let out = DataIamUser(Rc::new(DataIamUser_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(DataIamUserData {
...
pub struct DataIamUserRef {
    shared: StackShared,
    base: String,
}
impl Ref for DataIamUserRef {
