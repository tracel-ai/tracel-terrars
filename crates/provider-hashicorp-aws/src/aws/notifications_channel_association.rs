...
struct NotificationsChannelAssociation_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<NotificationsChannelAssociationData>,
}
#[derive(Clone)]
pub struct NotificationsChannelAssociation(Rc<NotificationsChannelAssociation_>);
impl NotificationsChannelAssociation {
...
impl Resource_ for NotificationsChannelAssociation_ {
    fn extract_resource_type(&self) -> String {
        "aws_notifications_channel_association".into()
    }
...
pub struct BuildNotificationsChannelAssociation {
    pub tf_id: String,
    #[doc = ""]
...
impl BuildNotificationsChannelAssociation {
    pub fn build(self, stack: &mut Stack) -> NotificationsChannelAssociation {
        let out = NotificationsChannelAssociation(Rc::new(NotificationsChannelAssociation_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(NotificationsChannelAssociationData {
...
pub struct NotificationsChannelAssociationRef {
    shared: StackShared,
    base: String,
}
...
impl NotificationsChannelAssociationRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
    fn shared(&self) -> &StackShared {
