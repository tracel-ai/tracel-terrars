...
struct ApiGatewayApiKey_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<ApiGatewayApiKeyData>,
}

#[derive(Clone)]
pub struct ApiGatewayApiKey(Rc<ApiGatewayApiKey_>);

impl ApiGatewayApiKey {
    ...
    pub fn customer_id(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.customer_id", self.extract_ref()))
    }
...
impl Referable for ApiGatewayApiKey {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for ApiGatewayApiKey { }

impl ToListMappable for ApiGatewayApiKey {
    type O = ListRef<ApiGatewayApiKeyRef>;
...
impl Resource_ for ApiGatewayApiKey_ {
    fn extract_resource_type(&self) -> String {
        "aws_api_gateway_api_key".into()
    }
...
pub struct BuildApiGatewayApiKey {
    pub tf_id: String,
    #[doc = ""]
    pub name: PrimField<String>,
}

impl BuildApiGatewayApiKey {
    pub fn build(self, stack: &mut Stack) -> ApiGatewayApiKey {
        let out = ApiGatewayApiKey(Rc::new(ApiGatewayApiKey_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(ApiGatewayApiKeyData {
...
pub struct ApiGatewayApiKeyRef {
    shared: StackShared,
    base: String,
}

impl Ref for ApiGatewayApiKeyRef {
