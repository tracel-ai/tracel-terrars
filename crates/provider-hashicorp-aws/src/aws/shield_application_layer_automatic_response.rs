...
impl ShieldApplicationLayerAutomaticResponse {
    ...
    pub fn set_timeouts(self, v: impl Into<ShieldApplicationLayerAutomaticResponseTimeoutsEl>) -> Self {
...
impl BuildShieldApplicationLayerAutomaticResponse {
    pub fn build(self, stack: &mut Stack) -> ShieldApplicationLayerAutomaticResponse {
        let out = ShieldApplicationLayerAutomaticResponse(Rc::new(ShieldApplicationLayerAutomaticResponse_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(ShieldApplicationLayerAutomaticResponseData {
...
impl Ref for ShieldApplicationLayerAutomaticResponseTimeoutsElRef {
    fn new(shared: StackShared, base: String) -> ShieldApplicationLayerAutomaticResponseTimeoutsElRef {
        ShieldApplicationLayerAutomaticResponseTimeoutsElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
