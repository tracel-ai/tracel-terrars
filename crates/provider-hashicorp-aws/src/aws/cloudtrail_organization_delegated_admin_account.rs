...
struct CloudtrailOrganizationDelegatedAdminAccount_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<CloudtrailOrganizationDelegatedAdminAccountData>,
}
#[derive(Clone)]
...
impl Resource_ for CloudtrailOrganizationDelegatedAdminAccount_ {
    fn extract_resource_type(&self) -> String {
        "aws_cloudtrail_organization_delegated_admin_account".into()
    }
...
pub struct BuildCloudtrailOrganizationDelegatedAdminAccount {
    pub tf_id: String,
    #[doc = ""]
...
pub struct CloudtrailOrganizationDelegatedAdminAccountRef {
    shared: StackShared,
    base: String,
}
...
impl CloudtrailOrganizationDelegatedAdminAccountRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
    fn shared(&self) -> &StackShared {
