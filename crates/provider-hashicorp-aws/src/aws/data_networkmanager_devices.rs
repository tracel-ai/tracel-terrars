...
struct DataNetworkmanagerDevices_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<DataNetworkmanagerDevicesData>,
}
#[derive(Clone)]
pub struct DataNetworkmanagerDevices(Rc<DataNetworkmanagerDevices_>);
impl DataNetworkmanagerDevices {
...
impl Datasource_ for DataNetworkmanagerDevices_ {
    fn extract_datasource_type(&self) -> String {
        "aws_networkmanager_devices".into()
    }
...
pub struct BuildDataNetworkmanagerDevices {
    pub tf_id: String,
    #[doc = ""]
    pub global_network_id: PrimField<String>,
}
impl BuildDataNetworkmanagerDevices {
    pub fn build(self, stack: &mut Stack) -> DataNetworkmanagerDevices {
        let out = DataNetworkmanagerDevices(Rc::new(DataNetworkmanagerDevices_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(DataNetworkmanagerDevicesData {
...
pub struct DataNetworkmanagerDevicesRef {
    shared: StackShared,
    base: String,
}
...
impl DataNetworkmanagerDevicesRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    fn extract_ref(&self) -> String {
