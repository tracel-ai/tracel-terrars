...
use terrars::*;
#[derive(Serialize)]
struct PinpointApnsVoipChannelData {
...
struct PinpointApnsVoipChannel_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<PinpointApnsVoipChannelData>,
}
#[derive(Clone)]
pub struct PinpointApnsVoipChannel(Rc<PinpointApnsVoipChannel_>);
impl PinpointApnsVoipChannel {
...
impl Referable for PinpointApnsVoipChannel {
...
impl Resource for PinpointApnsVoipChannel {}
impl ToListMappable for PinpointApnsVoipChannel {
    type O = ListRef<PinpointApnsVoipChannelRef>;
    fn do_map(self, base: String) -> Self::O {
        self.0.data.borrow_mut().for_each = Some(format!("${{{}}}", base));
        ListRef::new(self.0.shared.clone(), self.extract_ref())
    }
}
impl Resource_ for PinpointApnsVoipChannel_ {
    fn extract_resource_type(&self) -> String {
        "aws_pinpoint_apns_voip_channel".into()
    }
...
pub struct BuildPinpointApnsVoipChannel {
    pub tf_id: String,
    #[doc = ""]
    pub application_id: PrimField<String>,
}
impl BuildPinpointApnsVoipChannel {
    pub fn build(self, stack: &mut Stack) -> PinpointApnsVoipChannel {
        let out = PinpointApnsVoipChannel(Rc::new(PinpointApnsVoipChannel_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(PinpointApnsVoipChannelData {
...
pub struct PinpointApnsVoipChannelRef {
    shared: StackShared,
    base: String,
}
impl Ref for PinpointApnsVoipChannelRef {
    fn new(shared: StackShared, base: String) -> Self {
        Self { shared, base }
    }
}
impl PinpointApnsVoipChannelRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
    fn shared(&self) -> &StackShared {
