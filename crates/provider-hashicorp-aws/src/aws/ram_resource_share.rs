...
struct RamResourceShareData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    allow_external_principals: Option<PrimField<bool>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    id: Option<PrimField<String>>,
    name: PrimField<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    permission_arns: Option<SetField<PrimField<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl RamResourceShare {
    ...
    pub fn allow_external_principals(&self) -> PrimExpr<bool> {
        PrimExpr::new(self.shared().clone(), format!("{}.allow_external_principals", self.extract_ref()))
    }
    ...
    pub fn permission_arns(&self) -> SetRef<PrimExpr<String>> {
        SetRef::new(self.shared().clone(), format!("{}.permission_arns", self.extract_ref()))
    }
    ...
    pub fn timeouts(&self) -> RamResourceShareTimeoutsElRef {
        RamResourceShareTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
}
...
impl BuildRamResourceShare {
    pub fn build(self, stack: &mut Stack) -> RamResourceShare {
        let out = RamResourceShare(Rc::new(RamResourceShare_ {
            ...
            tf_id: self.tf_id,
            data: RefCell::new(RamResourceShareData {
                depends_on: core::default::Default::default(),
                provider: None,
                lifecycle: core::default::Default::default(),
                for_each: None,
                allow_external_principals: core::default::Default::default(),
                id: core::default::Default::default(),
                name: self.name,
                permission_arns: core::default::Default::default(),
