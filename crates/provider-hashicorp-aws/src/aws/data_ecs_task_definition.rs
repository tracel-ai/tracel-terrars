    ...
    BuildDataEcsTaskDefinitionVolumeElFsxWindowsFileServerVolumeConfigurationElAuthorizationConfigEl
{
    ...
    {
        DataEcsTaskDefinitionVolumeElFsxWindowsFileServerVolumeConfigurationElAuthorizationConfigEl { credentials_parameter : core :: default :: Default :: default () , domain : core :: default :: Default :: default () , }
    }
}
...
impl Ref for DataEcsTaskDefinitionVolumeElFsxWindowsFileServerVolumeConfigurationElAuthorizationConfigElRef { fn new (shared : StackShared , base : String) -> DataEcsTaskDefinitionVolumeElFsxWindowsFileServerVolumeConfigurationElAuthorizationConfigElRef { DataEcsTaskDefinitionVolumeElFsxWindowsFileServerVolumeConfigurationElAuthorizationConfigElRef { shared : shared , base : base . to_string () , } } }
impl
    DataEcsTaskDefinitionVolumeElFsxWindowsFileServerVolumeConfigurationElAuthorizationConfigElRef
{
    fn shared(&self) -> &StackShared {
...
#[derive(Serialize)]
pub struct DataEcsTaskDefinitionVolumeElFsxWindowsFileServerVolumeConfigurationEl { # [serde (skip_serializing_if = "Option::is_none")] authorization_config : Option < ListField < DataEcsTaskDefinitionVolumeElFsxWindowsFileServerVolumeConfigurationElAuthorizationConfigEl > > , # [serde (skip_serializing_if = "Option::is_none")] file_system_id : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] root_directory : Option < PrimField < String > > , }
impl DataEcsTaskDefinitionVolumeElFsxWindowsFileServerVolumeConfigurationEl {
    #[doc = "Set the field `authorization_config`.\n"]
    pub fn set_authorization_config(
        mut self,
        v : impl Into < ListField < DataEcsTaskDefinitionVolumeElFsxWindowsFileServerVolumeConfigurationElAuthorizationConfigEl > >,
    ) -> Self {
        self.authorization_config = Some(v.into());
        self
    }
...
impl DataEcsTaskDefinitionVolumeElFsxWindowsFileServerVolumeConfigurationElRef {
    ...
    #[doc = "Get a reference to the value of field `authorization_config` after provisioning.\n"]    pub fn authorization_config (& self) -> ListRef < DataEcsTaskDefinitionVolumeElFsxWindowsFileServerVolumeConfigurationElAuthorizationConfigElRef >{
        ListRef::new(
            self.shared().clone(),
            format!("{}.authorization_config", self.base),
        )
