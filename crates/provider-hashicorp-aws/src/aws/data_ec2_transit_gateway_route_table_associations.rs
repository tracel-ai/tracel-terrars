...
struct DataEc2TransitGatewayRouteTableAssociationsData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    filter: Option<Vec<DataEc2TransitGatewayRouteTableAssociationsFilterEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    timeouts: Option<DataEc2TransitGatewayRouteTableAssociationsTimeoutsEl>,
    dynamic: DataEc2TransitGatewayRouteTableAssociationsDynamic,
}

struct DataEc2TransitGatewayRouteTableAssociations_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<DataEc2TransitGatewayRouteTableAssociationsData>,
}
...
impl DataEc2TransitGatewayRouteTableAssociations {
    ...
    pub fn timeouts(&self) -> DataEc2TransitGatewayRouteTableAssociationsTimeoutsElRef {
        DataEc2TransitGatewayRouteTableAssociationsTimeoutsElRef::new(
            self.shared().clone(),
...
impl Datasource_ for DataEc2TransitGatewayRouteTableAssociations_ {
    fn extract_datasource_type(&self) -> String {
        "aws_ec2_transit_gateway_route_table_associations".into()
    }
...
pub struct BuildDataEc2TransitGatewayRouteTableAssociations {
    pub tf_id: String,
    #[doc = ""]
...
pub struct DataEc2TransitGatewayRouteTableAssociationsRef {
    shared: StackShared,
    base: String,
}
...
impl DataEc2TransitGatewayRouteTableAssociationsRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize)]
pub struct DataEc2TransitGatewayRouteTableAssociationsFilterEl {
...
pub struct BuildDataEc2TransitGatewayRouteTableAssociationsFilterEl {
    #[doc = ""]
...
impl BuildDataEc2TransitGatewayRouteTableAssociationsFilterEl {
    pub fn build(self) -> DataEc2TransitGatewayRouteTableAssociationsFilterEl {
        DataEc2TransitGatewayRouteTableAssociationsFilterEl {
            name: self.name,
            values: self.values,
        }
    }
...
pub struct DataEc2TransitGatewayRouteTableAssociationsFilterElRef {
    shared: StackShared,
    base: String,
}
...
impl DataEc2TransitGatewayRouteTableAssociationsFilterElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize)]
pub struct DataEc2TransitGatewayRouteTableAssociationsTimeoutsEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    read: Option<PrimField<String>>,
}

impl DataEc2TransitGatewayRouteTableAssociationsTimeoutsEl {
...
impl ToListMappable for DataEc2TransitGatewayRouteTableAssociationsTimeoutsEl {
    type O = BlockAssignable<DataEc2TransitGatewayRouteTableAssociationsTimeoutsEl>;
...
pub struct BuildDataEc2TransitGatewayRouteTableAssociationsTimeoutsEl {}
...
pub struct DataEc2TransitGatewayRouteTableAssociationsTimeoutsElRef {
    shared: StackShared,
    base: String,
}
...
impl DataEc2TransitGatewayRouteTableAssociationsTimeoutsElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
struct DataEc2TransitGatewayRouteTableAssociationsDynamic {
    filter: Option<DynamicBlock<DataEc2TransitGatewayRouteTableAssociationsFilterEl>>,
}
