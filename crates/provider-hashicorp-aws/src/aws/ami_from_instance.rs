...
impl AmiFromInstance {
    ...
    pub fn set_ebs_block_device(
        self,
        v: impl Into<BlockAssignable<AmiFromInstanceEbsBlockDeviceEl>>,
    ) -> Self {
        match v.into() {
    ...
    pub fn snapshot_without_reboot(&self) -> PrimExpr<bool> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.snapshot_without_reboot", self.extract_ref()),
        )
    }
    ...
    pub fn source_instance_id(&self) -> PrimExpr<String> {
        PrimExpr::new(
            self.shared().clone(),
            format!("{}.source_instance_id", self.extract_ref()),
        )
    }
    ...
    pub fn timeouts(&self) -> AmiFromInstanceTimeoutsElRef {
        AmiFromInstanceTimeoutsElRef::new(
            self.shared().clone(),
            format!("{}.timeouts", self.extract_ref()),
        )
    }
}
impl Referable for AmiFromInstance {
