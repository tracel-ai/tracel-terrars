...
impl ApprunnerVpcIngressConnection {
    ...
    pub fn ingress_vpc_configuration(
        &self,
    ) -> ListRef<ApprunnerVpcIngressConnectionIngressVpcConfigurationElRef> {
        ListRef::new(
            self.shared().clone(),
            format!("{}.ingress_vpc_configuration", self.extract_ref()),
        )
    }
}
...
struct ApprunnerVpcIngressConnectionDynamic {
    ingress_vpc_configuration:
        Option<DynamicBlock<ApprunnerVpcIngressConnectionIngressVpcConfigurationEl>>,
}
