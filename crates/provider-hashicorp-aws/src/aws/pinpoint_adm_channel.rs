...
struct PinpointAdmChannel_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<PinpointAdmChannelData>,
}

#[derive(Clone)]
pub struct PinpointAdmChannel(Rc<PinpointAdmChannel_>);

impl PinpointAdmChannel {
...
impl Referable for PinpointAdmChannel {
...
impl Resource for PinpointAdmChannel {}

impl ToListMappable for PinpointAdmChannel {
    type O = ListRef<PinpointAdmChannelRef>;
...
impl Resource_ for PinpointAdmChannel_ {
    fn extract_resource_type(&self) -> String {
        "aws_pinpoint_adm_channel".into()
    }
...
pub struct BuildPinpointAdmChannel {
    pub tf_id: String,
    #[doc = ""]
...
impl BuildPinpointAdmChannel {
    pub fn build(self, stack: &mut Stack) -> PinpointAdmChannel {
        let out = PinpointAdmChannel(Rc::new(PinpointAdmChannel_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(PinpointAdmChannelData {
...
pub struct PinpointAdmChannelRef {
    shared: StackShared,
    base: String,
}

impl Ref for PinpointAdmChannelRef {
    fn new(shared: StackShared, base: String) -> Self {
        Self { shared, base }
    }
}

impl PinpointAdmChannelRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
