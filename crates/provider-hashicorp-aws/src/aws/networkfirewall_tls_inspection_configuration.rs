...
impl NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElCheckCertificateRevocationStatusEl { # [doc = "Set the field `revoked_status_action`.\n"] pub fn set_revoked_status_action (mut self , v : impl Into < PrimField < String > >) -> Self { self . revoked_status_action = Some (v . into ()) ; self } # [doc = "Set the field `unknown_status_action`.\n"] pub fn set_unknown_status_action (mut self , v : impl Into < PrimField < String > >) -> Self { self . unknown_status_action = Some (v . into ()) ; self } }
impl ToListMappable for NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElCheckCertificateRevocationStatusEl { type O = BlockAssignable < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElCheckCertificateRevocationStatusEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElCheckCertificateRevocationStatusElRef { fn new (shared : StackShared , base : String) -> NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElCheckCertificateRevocationStatusElRef { NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElCheckCertificateRevocationStatusElRef { shared : shared , base : base . to_string () , } } }
impl NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElCheckCertificateRevocationStatusElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `revoked_status_action` after provisioning.\n"] pub fn revoked_status_action (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.revoked_status_action" , self . base)) } # [doc = "Get a reference to the value of field `unknown_status_action` after provisioning.\n"] pub fn unknown_status_action (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.unknown_status_action" , self . base)) } }
#[derive(Serialize)]
...
impl ToListMappable for NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElDestinationEl { type O = BlockAssignable < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElDestinationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl BuildNetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElDestinationEl { pub fn build (self) -> NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElDestinationEl { NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElDestinationEl { address_definition : self . address_definition , } } }
...
impl Ref for NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElDestinationElRef { fn new (shared : StackShared , base : String) -> NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElDestinationElRef { NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElDestinationElRef { shared : shared , base : base . to_string () , } } }
impl NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElDestinationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `address_definition` after provisioning.\n"] pub fn address_definition (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.address_definition" , self . base)) } }
#[derive(Serialize)]
...
impl Ref for NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElSourceElRef { fn new (shared : StackShared , base : String) -> NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElSourceElRef { NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElSourceElRef { shared : shared , base : base . to_string () , } } }
impl NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElSourceElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `address_definition` after provisioning.\n"] pub fn address_definition (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.address_definition" , self . base)) } }
#[derive(Serialize)]
...
impl Ref for NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElSourcePortsElRef { fn new (shared : StackShared , base : String) -> NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElSourcePortsElRef { NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElSourcePortsElRef { shared : shared , base : base . to_string () , } } }
impl NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElSourcePortsElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `from_port` after provisioning.\n"] pub fn from_port (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.from_port" , self . base)) } # [doc = "Get a reference to the value of field `to_port` after provisioning.\n"] pub fn to_port (& self) -> PrimExpr < f64 > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.to_port" , self . base)) } }
#[derive(Serialize, Default)]
struct NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElDynamic { destination : Option < DynamicBlock < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElDestinationEl >> , destination_ports : Option < DynamicBlock < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElDestinationPortsEl >> , source : Option < DynamicBlock < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElSourceEl >> , source_ports : Option < DynamicBlock < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElSourcePortsEl >> , }
#[derive(Serialize)]
pub struct NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeEl { protocols : SetField < PrimField < f64 > > , # [serde (skip_serializing_if = "Option::is_none")] destination : Option < Vec < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElDestinationEl > > , # [serde (skip_serializing_if = "Option::is_none")] destination_ports : Option < Vec < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElDestinationPortsEl > > , # [serde (skip_serializing_if = "Option::is_none")] source : Option < Vec < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElSourceEl > > , # [serde (skip_serializing_if = "Option::is_none")] source_ports : Option < Vec < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElSourcePortsEl > > , dynamic : NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElDynamic , }
impl NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeEl { # [doc = "Set the field `destination`.\n"] pub fn set_destination (mut self , v : impl Into < BlockAssignable < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElDestinationEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . destination = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . destination = Some (d) ; } } self } # [doc = "Set the field `destination_ports`.\n"] pub fn set_destination_ports (mut self , v : impl Into < BlockAssignable < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElDestinationPortsEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . destination_ports = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . destination_ports = Some (d) ; } } self } # [doc = "Set the field `source`.\n"] pub fn set_source (mut self , v : impl Into < BlockAssignable < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElSourceEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . source = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . source = Some (d) ; } } self } # [doc = "Set the field `source_ports`.\n"] pub fn set_source_ports (mut self , v : impl Into < BlockAssignable < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElSourcePortsEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . source_ports = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . source_ports = Some (d) ; } } self } }
impl ToListMappable for NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeEl { type O = BlockAssignable < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl BuildNetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeEl { pub fn build (self) -> NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeEl { NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeEl { protocols : self . protocols , destination : core :: default :: Default :: default () , destination_ports : core :: default :: Default :: default () , source : core :: default :: Default :: default () , source_ports : core :: default :: Default :: default () , dynamic : Default :: default () , } } }
...
impl Ref for NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElRef { fn new (shared : StackShared , base : String) -> NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElRef { NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElRef { shared : shared , base : base . to_string () , } } }
impl NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `protocols` after provisioning.\n"] pub fn protocols (& self) -> SetRef < PrimExpr < f64 > > { SetRef :: new (self . shared () . clone () , format ! ("{}.protocols" , self . base)) } # [doc = "Get a reference to the value of field `destination` after provisioning.\n"] pub fn destination (& self) -> ListRef < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElDestinationElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.destination" , self . base)) } # [doc = "Get a reference to the value of field `destination_ports` after provisioning.\n"] pub fn destination_ports (& self) -> ListRef < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElDestinationPortsElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.destination_ports" , self . base)) } # [doc = "Get a reference to the value of field `source` after provisioning.\n"] pub fn source (& self) -> ListRef < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElSourceElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.source" , self . base)) } # [doc = "Get a reference to the value of field `source_ports` after provisioning.\n"] pub fn source_ports (& self) -> ListRef < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElSourcePortsElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.source_ports" , self . base)) } }
#[derive(Serialize)]
...
impl NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElServerCertificateEl { # [doc = "Set the field `resource_arn`.\n"] pub fn set_resource_arn (mut self , v : impl Into < PrimField < String > >) -> Self { self . resource_arn = Some (v . into ()) ; self } }
impl ToListMappable for NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElServerCertificateEl { type O = BlockAssignable < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElServerCertificateEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
...
impl Ref for NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElServerCertificateElRef { fn new (shared : StackShared , base : String) -> NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElServerCertificateElRef { NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElServerCertificateElRef { shared : shared , base : base . to_string () , } } }
impl NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElServerCertificateElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `resource_arn` after provisioning.\n"] pub fn resource_arn (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.resource_arn" , self . base)) } }
#[derive(Serialize, Default)]
struct NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElDynamic { check_certificate_revocation_status : Option < DynamicBlock < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElCheckCertificateRevocationStatusEl >> , scope : Option < DynamicBlock < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeEl >> , server_certificate : Option < DynamicBlock < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElServerCertificateEl >> , }
#[derive(Serialize)]
pub struct NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationEl { # [serde (skip_serializing_if = "Option::is_none")] certificate_authority_arn : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] check_certificate_revocation_status : Option < Vec < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElCheckCertificateRevocationStatusEl > > , # [serde (skip_serializing_if = "Option::is_none")] scope : Option < Vec < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeEl > > , # [serde (skip_serializing_if = "Option::is_none")] server_certificate : Option < Vec < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElServerCertificateEl > > , dynamic : NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElDynamic , }
impl NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationEl { # [doc = "Set the field `certificate_authority_arn`.\n"] pub fn set_certificate_authority_arn (mut self , v : impl Into < PrimField < String > >) -> Self { self . certificate_authority_arn = Some (v . into ()) ; self } # [doc = "Set the field `check_certificate_revocation_status`.\n"] pub fn set_check_certificate_revocation_status (mut self , v : impl Into < BlockAssignable < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElCheckCertificateRevocationStatusEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . check_certificate_revocation_status = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . check_certificate_revocation_status = Some (d) ; } } self } # [doc = "Set the field `scope`.\n"] pub fn set_scope (mut self , v : impl Into < BlockAssignable < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . scope = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . scope = Some (d) ; } } self } # [doc = "Set the field `server_certificate`.\n"] pub fn set_server_certificate (mut self , v : impl Into < BlockAssignable < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElServerCertificateEl >>) -> Self { match v . into () { BlockAssignable :: Literal (v) => { self . server_certificate = Some (v) ; } , BlockAssignable :: Dynamic (d) => { self . dynamic . server_certificate = Some (d) ; } } self } }
impl ToListMappable for NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationEl { type O = BlockAssignable < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildNetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationEl
{}
impl BuildNetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationEl { pub fn build (self) -> NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationEl { NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationEl { certificate_authority_arn : core :: default :: Default :: default () , check_certificate_revocation_status : core :: default :: Default :: default () , scope : core :: default :: Default :: default () , server_certificate : core :: default :: Default :: default () , dynamic : Default :: default () , } } }
pub struct NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElRef { fn new (shared : StackShared , base : String) -> NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElRef { NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `certificate_authority_arn` after provisioning.\n"] pub fn certificate_authority_arn (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.certificate_authority_arn" , self . base)) } # [doc = "Get a reference to the value of field `check_certificate_revocation_status` after provisioning.\n"] pub fn check_certificate_revocation_status (& self) -> ListRef < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElCheckCertificateRevocationStatusElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.check_certificate_revocation_status" , self . base)) } # [doc = "Get a reference to the value of field `scope` after provisioning.\n"] pub fn scope (& self) -> ListRef < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElScopeElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.scope" , self . base)) } # [doc = "Get a reference to the value of field `server_certificate` after provisioning.\n"] pub fn server_certificate (& self) -> ListRef < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElServerCertificateElRef > { ListRef :: new (self . shared () . clone () , format ! ("{}.server_certificate" , self . base)) } }
#[derive(Serialize, Default)]
struct NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElDynamic { server_certificate_configuration : Option < DynamicBlock < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationEl >> , }
#[derive(Serialize)]
pub struct NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationEl { # [serde (skip_serializing_if = "Option::is_none")] server_certificate_configuration : Option < Vec < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationEl > > , dynamic : NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElDynamic , }
impl NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationEl {
    ...
    pub fn set_server_certificate_configuration(
        mut self,
        v : impl Into < BlockAssignable < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationEl >>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElRef {
    ...
    #[doc = "Get a reference to the value of field `server_certificate_configuration` after provisioning.\n"]    pub fn server_certificate_configuration (& self) -> ListRef < NetworkfirewallTlsInspectionConfigurationTlsInspectionConfigurationElServerCertificateConfigurationElRef >{
        ListRef::new(
            self.shared().clone(),
