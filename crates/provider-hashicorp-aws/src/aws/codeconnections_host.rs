...
impl CodeconnectionsHost {
    ...
    pub fn set_vpc_configuration(self, v: impl Into<BlockAssignable<CodeconnectionsHostVpcConfigurationEl>>) -> Self {
        match v.into() {
    ...
    pub fn timeouts(&self) -> CodeconnectionsHostTimeoutsElRef {
        CodeconnectionsHostTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
