...
struct S3controlAccessGrantsInstanceResourcePolicy_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<S3controlAccessGrantsInstanceResourcePolicyData>,
}
#[derive(Clone)]
...
impl Resource_ for S3controlAccessGrantsInstanceResourcePolicy_ {
    fn extract_resource_type(&self) -> String {
        "aws_s3control_access_grants_instance_resource_policy".into()
    }
...
pub struct BuildS3controlAccessGrantsInstanceResourcePolicy {
    pub tf_id: String,
    #[doc = ""]
...
pub struct S3controlAccessGrantsInstanceResourcePolicyRef {
    shared: StackShared,
    base: String,
}
...
impl S3controlAccessGrantsInstanceResourcePolicyRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
    fn shared(&self) -> &StackShared {
