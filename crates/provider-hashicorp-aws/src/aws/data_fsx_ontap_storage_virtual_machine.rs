...
impl DataFsxOntapStorageVirtualMachine {
    ...
    pub fn set_filter(
        self,
        v: impl Into<BlockAssignable<DataFsxOntapStorageVirtualMachineFilterEl>>,
    ) -> Self {
        match v.into() {
    ...
    pub fn lifecycle_transition_reason(
        &self,
    ) -> SetRef<DataFsxOntapStorageVirtualMachineLifecycleTransitionReasonElRef> {
        SetRef::new(
            self.shared().clone(),
            format!("{}.lifecycle_transition_reason", self.extract_ref()),
        )
    }
...
impl DataFsxOntapStorageVirtualMachineActiveDirectoryConfigurationElSelfManagedActiveDirectoryConfigurationEl { # [doc = "Set the field `dns_ips`.\n"] pub fn set_dns_ips (mut self , v : impl Into < SetField < PrimField < String > > >) -> Self { self . dns_ips = Some (v . into ()) ; self } # [doc = "Set the field `domain_name`.\n"] pub fn set_domain_name (mut self , v : impl Into < PrimField < String > >) -> Self { self . domain_name = Some (v . into ()) ; self } # [doc = "Set the field `file_system_administrators_group`.\n"] pub fn set_file_system_administrators_group (mut self , v : impl Into < PrimField < String > >) -> Self { self . file_system_administrators_group = Some (v . into ()) ; self } # [doc = "Set the field `organizational_unit_distinguished_name`.\n"] pub fn set_organizational_unit_distinguished_name (mut self , v : impl Into < PrimField < String > >) -> Self { self . organizational_unit_distinguished_name = Some (v . into ()) ; self } # [doc = "Set the field `username`.\n"] pub fn set_username (mut self , v : impl Into < PrimField < String > >) -> Self { self . username = Some (v . into ()) ; self } }
impl ToListMappable for DataFsxOntapStorageVirtualMachineActiveDirectoryConfigurationElSelfManagedActiveDirectoryConfigurationEl { type O = BlockAssignable < DataFsxOntapStorageVirtualMachineActiveDirectoryConfigurationElSelfManagedActiveDirectoryConfigurationEl > ; fn do_map (self , base : String) -> Self :: O { BlockAssignable :: Dynamic (DynamicBlock { for_each : format ! ("${{{}}}" , base) , iterator : "each" . into () , content : self , }) } }
pub struct BuildDataFsxOntapStorageVirtualMachineActiveDirectoryConfigurationElSelfManagedActiveDirectoryConfigurationEl
{}
impl BuildDataFsxOntapStorageVirtualMachineActiveDirectoryConfigurationElSelfManagedActiveDirectoryConfigurationEl { pub fn build (self) -> DataFsxOntapStorageVirtualMachineActiveDirectoryConfigurationElSelfManagedActiveDirectoryConfigurationEl { DataFsxOntapStorageVirtualMachineActiveDirectoryConfigurationElSelfManagedActiveDirectoryConfigurationEl { dns_ips : core :: default :: Default :: default () , domain_name : core :: default :: Default :: default () , file_system_administrators_group : core :: default :: Default :: default () , organizational_unit_distinguished_name : core :: default :: Default :: default () , username : core :: default :: Default :: default () , } } }
pub struct DataFsxOntapStorageVirtualMachineActiveDirectoryConfigurationElSelfManagedActiveDirectoryConfigurationElRef
{
    shared: StackShared,
    base: String,
}
impl Ref for DataFsxOntapStorageVirtualMachineActiveDirectoryConfigurationElSelfManagedActiveDirectoryConfigurationElRef { fn new (shared : StackShared , base : String) -> DataFsxOntapStorageVirtualMachineActiveDirectoryConfigurationElSelfManagedActiveDirectoryConfigurationElRef { DataFsxOntapStorageVirtualMachineActiveDirectoryConfigurationElSelfManagedActiveDirectoryConfigurationElRef { shared : shared , base : base . to_string () , } } }
impl DataFsxOntapStorageVirtualMachineActiveDirectoryConfigurationElSelfManagedActiveDirectoryConfigurationElRef { fn shared (& self) -> & StackShared { & self . shared } # [doc = "Get a reference to the value of field `dns_ips` after provisioning.\n"] pub fn dns_ips (& self) -> SetRef < PrimExpr < String > > { SetRef :: new (self . shared () . clone () , format ! ("{}.dns_ips" , self . base)) } # [doc = "Get a reference to the value of field `domain_name` after provisioning.\n"] pub fn domain_name (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.domain_name" , self . base)) } # [doc = "Get a reference to the value of field `file_system_administrators_group` after provisioning.\n"] pub fn file_system_administrators_group (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.file_system_administrators_group" , self . base)) } # [doc = "Get a reference to the value of field `organizational_unit_distinguished_name` after provisioning.\n"] pub fn organizational_unit_distinguished_name (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.organizational_unit_distinguished_name" , self . base)) } # [doc = "Get a reference to the value of field `username` after provisioning.\n"] pub fn username (& self) -> PrimExpr < String > { PrimExpr :: new (self . shared () . clone () , format ! ("{}.username" , self . base)) } }
#[derive(Serialize)]
pub struct DataFsxOntapStorageVirtualMachineActiveDirectoryConfigurationEl { # [serde (skip_serializing_if = "Option::is_none")] netbios_name : Option < PrimField < String > > , # [serde (skip_serializing_if = "Option::is_none")] self_managed_active_directory_configuration : Option < ListField < DataFsxOntapStorageVirtualMachineActiveDirectoryConfigurationElSelfManagedActiveDirectoryConfigurationEl > > , }
impl DataFsxOntapStorageVirtualMachineActiveDirectoryConfigurationEl {
    ...
    pub fn set_self_managed_active_directory_configuration(
        mut self,
        v : impl Into < ListField < DataFsxOntapStorageVirtualMachineActiveDirectoryConfigurationElSelfManagedActiveDirectoryConfigurationEl > >,
    ) -> Self {
...
impl DataFsxOntapStorageVirtualMachineActiveDirectoryConfigurationElRef {
    ...
    #[doc = "Get a reference to the value of field `self_managed_active_directory_configuration` after provisioning.\n"]    pub fn self_managed_active_directory_configuration (& self) -> ListRef < DataFsxOntapStorageVirtualMachineActiveDirectoryConfigurationElSelfManagedActiveDirectoryConfigurationElRef >{
        ListRef::new(
            self.shared().clone(),
...
impl DataFsxOntapStorageVirtualMachineEndpointsEl {
    ...
    pub fn set_iscsi(
        mut self,
        v: impl Into<ListField<DataFsxOntapStorageVirtualMachineEndpointsElIscsiEl>>,
    ) -> Self {
    ...
    pub fn set_nfs(
        mut self,
        v: impl Into<ListField<DataFsxOntapStorageVirtualMachineEndpointsElNfsEl>>,
    ) -> Self {
    ...
    pub fn set_smb(
        mut self,
        v: impl Into<ListField<DataFsxOntapStorageVirtualMachineEndpointsElSmbEl>>,
    ) -> Self {
...
impl DataFsxOntapStorageVirtualMachineEndpointsElRef {
    ...
    pub fn management(
        &self,
    ) -> ListRef<DataFsxOntapStorageVirtualMachineEndpointsElManagementElRef> {
...
impl BuildDataFsxOntapStorageVirtualMachineLifecycleTransitionReasonEl {
    pub fn build(self) -> DataFsxOntapStorageVirtualMachineLifecycleTransitionReasonEl {
        DataFsxOntapStorageVirtualMachineLifecycleTransitionReasonEl {
