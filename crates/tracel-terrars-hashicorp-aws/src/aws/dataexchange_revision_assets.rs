...
impl DataexchangeRevisionAssets {
    ...
    pub fn set_asset(self, v: impl Into<BlockAssignable<DataexchangeRevisionAssetsAssetEl>>) -> Self {
        match v.into() {
    ...
    pub fn data_set_id(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.data_set_id", self.extract_ref()))
    }

    #[doc = "Get a reference to the value of field `finalized` after provisioning.\n"]
    pub fn finalized(&self) -> PrimExpr<bool> {
        PrimExpr::new(self.shared().clone(), format!("{}.finalized", self.extract_ref()))
    }
...
impl DataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketElAssetSourceElKmsKeysToGrantEl { }
...
impl DataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketElAssetSourceElKmsKeysToGrantElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
struct DataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketElAssetSourceElDynamic {
    kms_keys_to_grant: Option<
        DynamicBlock<DataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketElAssetSourceElKmsKeysToGrantEl>,
    >,
}

#[derive(Serialize)]
pub struct DataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketElAssetSourceEl {
    bucket: PrimField<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    key_prefixes: Option<SetField<PrimField<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    keys: Option<SetField<PrimField<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    kms_keys_to_grant: Option<
        Vec<DataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketElAssetSourceElKmsKeysToGrantEl>,
    >,
    dynamic: DataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketElAssetSourceElDynamic,
}
...
impl ToListMappable for DataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketElAssetSourceEl {
    type O = BlockAssignable<DataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketElAssetSourceEl>;
...
impl BuildDataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketElAssetSourceEl {
    pub fn build(self) -> DataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketElAssetSourceEl {
...
impl DataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketElAssetSourceElRef {
    ...
    pub fn kms_keys_to_grant(
        &self,
    ) -> ListRef<DataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketElAssetSourceElKmsKeysToGrantElRef> {
        ListRef::new(self.shared().clone(), format!("{}.kms_keys_to_grant", self.base))
    }
}
...
struct DataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketElDynamic {
    asset_source: Option<
        DynamicBlock<DataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketElAssetSourceEl>,
    >,
}
...
pub struct DataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    asset_source: Option<Vec<DataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketElAssetSourceEl>>,
...
impl DataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketElRef {
    ...
    pub fn access_point_alias(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.access_point_alias", self.base))
    }
    ...
    pub fn access_point_arn(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.access_point_arn", self.base))
    }
...
struct DataexchangeRevisionAssetsAssetElImportAssetsFromS3ElDynamic {
    asset_source: Option<DynamicBlock<DataexchangeRevisionAssetsAssetElImportAssetsFromS3ElAssetSourceEl>>,
}
...
impl DataexchangeRevisionAssetsAssetElImportAssetsFromS3El {
    ...
    pub fn set_asset_source(
        mut self,
        v: impl Into<BlockAssignable<DataexchangeRevisionAssetsAssetElImportAssetsFromS3ElAssetSourceEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.asset_source = Some(v);
...
impl Ref for DataexchangeRevisionAssetsAssetElImportAssetsFromS3ElRef {
    fn new(shared: StackShared, base: String) -> DataexchangeRevisionAssetsAssetElImportAssetsFromS3ElRef {
...
impl DataexchangeRevisionAssetsAssetElImportAssetsFromS3ElRef {
    ...
    #[doc = "Get a reference to the value of field `asset_source` after provisioning.\n"]
    pub fn asset_source(&self) -> ListRef<DataexchangeRevisionAssetsAssetElImportAssetsFromS3ElAssetSourceElRef> {
        ListRef::new(self.shared().clone(), format!("{}.asset_source", self.base))
    }
}
...
impl BuildDataexchangeRevisionAssetsAssetElImportAssetsFromSignedUrlEl {
    pub fn build(self) -> DataexchangeRevisionAssetsAssetElImportAssetsFromSignedUrlEl {
        DataexchangeRevisionAssetsAssetElImportAssetsFromSignedUrlEl { filename: self.filename }
    }
}
...
impl Ref for DataexchangeRevisionAssetsAssetElImportAssetsFromSignedUrlElRef {
    fn new(shared: StackShared, base: String) -> DataexchangeRevisionAssetsAssetElImportAssetsFromSignedUrlElRef {
...
struct DataexchangeRevisionAssetsAssetElDynamic {
    create_s3_data_access_from_s3_bucket: Option<
        DynamicBlock<DataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketEl>,
    >,
    import_assets_from_s3: Option<DynamicBlock<DataexchangeRevisionAssetsAssetElImportAssetsFromS3El>>,
    import_assets_from_signed_url: Option<
        DynamicBlock<DataexchangeRevisionAssetsAssetElImportAssetsFromSignedUrlEl>,
    >,
}
...
pub struct DataexchangeRevisionAssetsAssetEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    create_s3_data_access_from_s3_bucket: Option<Vec<DataexchangeRevisionAssetsAssetElCreateS3DataAccessFromS3BucketEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    import_assets_from_s3: Option<Vec<DataexchangeRevisionAssetsAssetElImportAssetsFromS3El>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    import_assets_from_signed_url: Option<Vec<DataexchangeRevisionAssetsAssetElImportAssetsFromSignedUrlEl>>,
...
impl DataexchangeRevisionAssetsAssetElRef {
    ...
    pub fn create_s3_data_access_from_s3_bucket(
        ...
        ListRef::new(self.shared().clone(), format!("{}.create_s3_data_access_from_s3_bucket", self.base))
    }

    #[doc = "Get a reference to the value of field `import_assets_from_s3` after provisioning.\n"]
    pub fn import_assets_from_s3(&self) -> ListRef<DataexchangeRevisionAssetsAssetElImportAssetsFromS3ElRef> {
        ListRef::new(self.shared().clone(), format!("{}.import_assets_from_s3", self.base))
    }
    ...
    pub fn import_assets_from_signed_url(
        ...
        ListRef::new(self.shared().clone(), format!("{}.import_assets_from_signed_url", self.base))
    }
}
...
impl BuildDataexchangeRevisionAssetsTimeoutsEl {
    pub fn build(self) -> DataexchangeRevisionAssetsTimeoutsEl {
        DataexchangeRevisionAssetsTimeoutsEl { create: core::default::Default::default() }
    }
}
