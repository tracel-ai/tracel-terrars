...
#[derive(Serialize)]
struct DataApiGatewayApiKeyData {
...
struct DataApiGatewayApiKey_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<DataApiGatewayApiKeyData>,
}

#[derive(Clone)]
pub struct DataApiGatewayApiKey(Rc<DataApiGatewayApiKey_>);

impl DataApiGatewayApiKey {
...
impl Datasource_ for DataApiGatewayApiKey_ {
...
pub struct BuildDataApiGatewayApiKey {
    pub tf_id: String,
    #[doc = ""]
    pub id: PrimField<String>,
}

impl BuildDataApiGatewayApiKey {
    pub fn build(self, stack: &mut Stack) -> DataApiGatewayApiKey {
        let out = DataApiGatewayApiKey(Rc::new(DataApiGatewayApiKey_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(DataApiGatewayApiKeyData {
...
pub struct DataApiGatewayApiKeyRef {
    shared: StackShared,
    base: String,
}

impl Ref for DataApiGatewayApiKeyRef {
