...
impl ElasticacheUser {
    ...
    pub fn set_authentication_mode(self, v: impl Into<BlockAssignable<ElasticacheUserAuthenticationModeEl>>) -> Self {
        match v.into() {
    ...
    pub fn timeouts(&self) -> ElasticacheUserTimeoutsElRef {
        ElasticacheUserTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
}
