...
struct EcrRepositoryCreationTemplateData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    image_tag_mutability_exclusion_filter: Option<Vec<EcrRepositoryCreationTemplateImageTagMutabilityExclusionFilterEl>>,
...
impl EcrRepositoryCreationTemplate {
    ...
    pub fn applied_for(&self) -> SetRef<PrimExpr<String>> {
        SetRef::new(self.shared().clone(), format!("{}.applied_for", self.extract_ref()))
    }

    #[doc = "Get a reference to the value of field `custom_role_arn` after provisioning.\n"]
    pub fn custom_role_arn(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.custom_role_arn", self.extract_ref()))
    }
    ...
    pub fn lifecycle_policy(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.lifecycle_policy", self.extract_ref()))
    }
    ...
    pub fn repository_policy(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.repository_policy", self.extract_ref()))
    }
    ...
    pub fn encryption_configuration(&self) -> ListRef<EcrRepositoryCreationTemplateEncryptionConfigurationElRef> {
...
impl Ref for EcrRepositoryCreationTemplateEncryptionConfigurationElRef {
    fn new(shared: StackShared, base: String) -> EcrRepositoryCreationTemplateEncryptionConfigurationElRef {
...
impl Ref for EcrRepositoryCreationTemplateImageTagMutabilityExclusionFilterElRef {
    fn new(shared: StackShared, base: String) -> EcrRepositoryCreationTemplateImageTagMutabilityExclusionFilterElRef {
...
struct EcrRepositoryCreationTemplateDynamic {
    encryption_configuration: Option<DynamicBlock<EcrRepositoryCreationTemplateEncryptionConfigurationEl>>,
    image_tag_mutability_exclusion_filter: Option<
        DynamicBlock<EcrRepositoryCreationTemplateImageTagMutabilityExclusionFilterEl>,
    >,
}
