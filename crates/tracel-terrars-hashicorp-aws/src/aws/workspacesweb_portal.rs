...
struct WorkspaceswebPortalData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    browser_settings_arn: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    max_concurrent_sessions: Option<PrimField<f64>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl WorkspaceswebPortal {
    ...
    pub fn browser_type(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.browser_type", self.extract_ref()))
    }
    ...
    pub fn max_concurrent_sessions(&self) -> PrimExpr<f64> {
        PrimExpr::new(self.shared().clone(), format!("{}.max_concurrent_sessions", self.extract_ref()))
    }
    ...
    pub fn portal_endpoint(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.portal_endpoint", self.extract_ref()))
    }

    #[doc = "Get a reference to the value of field `portal_status` after provisioning.\n"]
    pub fn portal_status(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.portal_status", self.extract_ref()))
    }
    ...
    pub fn renderer_type(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.renderer_type", self.extract_ref()))
    }
    ...
    pub fn user_access_logging_settings_arn(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.user_access_logging_settings_arn", self.extract_ref()))
    }
    ...
    pub fn timeouts(&self) -> WorkspaceswebPortalTimeoutsElRef {
        WorkspaceswebPortalTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
}
...
impl BuildWorkspaceswebPortal {
    pub fn build(self, stack: &mut Stack) -> WorkspaceswebPortal {
        let out = WorkspaceswebPortal(Rc::new(WorkspaceswebPortal_ {
            ...
            tf_id: self.tf_id,
            data: RefCell::new(WorkspaceswebPortalData {
                ...
                browser_settings_arn: core::default::Default::default(),
                customer_managed_key: core::default::Default::default(),
                display_name: core::default::Default::default(),
                instance_type: core::default::Default::default(),
                max_concurrent_sessions: core::default::Default::default(),
