...
#[derive(Serialize)]
struct DbEventSubscriptionData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    timeouts: Option<DbEventSubscriptionTimeoutsEl>,
}

struct DbEventSubscription_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<DbEventSubscriptionData>,
}

#[derive(Clone)]
pub struct DbEventSubscription(Rc<DbEventSubscription_>);

impl DbEventSubscription {
    ...
    pub fn set_timeouts(self, v: impl Into<DbEventSubscriptionTimeoutsEl>) -> Self {
    ...
    pub fn sns_topic(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.sns_topic", self.extract_ref()))
    }
    ...
    pub fn timeouts(&self) -> DbEventSubscriptionTimeoutsElRef {
        DbEventSubscriptionTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
}

impl Referable for DbEventSubscription {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for DbEventSubscription { }

impl ToListMappable for DbEventSubscription {
    type O = ListRef<DbEventSubscriptionRef>;
...
impl Resource_ for DbEventSubscription_ {
    fn extract_resource_type(&self) -> String {
        "aws_db_event_subscription".into()
    }
...
pub struct BuildDbEventSubscription {
    pub tf_id: String,
    #[doc = ""]
    pub sns_topic: PrimField<String>,
}

impl BuildDbEventSubscription {
    pub fn build(self, stack: &mut Stack) -> DbEventSubscription {
        let out = DbEventSubscription(Rc::new(DbEventSubscription_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(DbEventSubscriptionData {
...
pub struct DbEventSubscriptionRef {
    shared: StackShared,
    base: String,
}

impl Ref for DbEventSubscriptionRef {
...
#[derive(Serialize)]
pub struct DbEventSubscriptionTimeoutsEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl DbEventSubscriptionTimeoutsEl {
...
impl ToListMappable for DbEventSubscriptionTimeoutsEl {
    type O = BlockAssignable<DbEventSubscriptionTimeoutsEl>;
...
pub struct BuildDbEventSubscriptionTimeoutsEl {}

impl BuildDbEventSubscriptionTimeoutsEl {
    pub fn build(self) -> DbEventSubscriptionTimeoutsEl {
        DbEventSubscriptionTimeoutsEl {
...
pub struct DbEventSubscriptionTimeoutsElRef {
    shared: StackShared,
    base: String,
}

impl Ref for DbEventSubscriptionTimeoutsElRef {
    fn new(shared: StackShared, base: String) -> DbEventSubscriptionTimeoutsElRef {
        DbEventSubscriptionTimeoutsElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl DbEventSubscriptionTimeoutsElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
