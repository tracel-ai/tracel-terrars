...
struct ApprunnerDefaultAutoScalingConfigurationVersionData {
    ...
    auto_scaling_configuration_arn: PrimField<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    region: Option<PrimField<String>>,
}

struct ApprunnerDefaultAutoScalingConfigurationVersion_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<ApprunnerDefaultAutoScalingConfigurationVersionData>,
}
...
impl Resource_ for ApprunnerDefaultAutoScalingConfigurationVersion_ {
    fn extract_resource_type(&self) -> String {
        "aws_apprunner_default_auto_scaling_configuration_version".into()
    }
...
pub struct BuildApprunnerDefaultAutoScalingConfigurationVersion {
    pub tf_id: String,
    #[doc = ""]
    pub auto_scaling_configuration_arn: PrimField<String>,
}
...
pub struct ApprunnerDefaultAutoScalingConfigurationVersionRef {
    shared: StackShared,
    base: String,
}
...
impl ApprunnerDefaultAutoScalingConfigurationVersionRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
