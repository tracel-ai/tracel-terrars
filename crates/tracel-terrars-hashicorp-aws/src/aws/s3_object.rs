...
impl S3Object {
    ...
    pub fn set_override_provider(self, v: impl Into<BlockAssignable<S3ObjectOverrideProviderEl>>) -> Self {
        match v.into() {
...
impl BuildS3ObjectOverrideProviderElDefaultTagsEl {
    pub fn build(self) -> S3ObjectOverrideProviderElDefaultTagsEl {
        S3ObjectOverrideProviderElDefaultTagsEl { tags: core::default::Default::default() }
    }
}
...
impl S3ObjectOverrideProviderEl {
    ...
    pub fn set_default_tags(mut self, v: impl Into<BlockAssignable<S3ObjectOverrideProviderElDefaultTagsEl>>) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
