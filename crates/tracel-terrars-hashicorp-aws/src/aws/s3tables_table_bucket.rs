...
impl S3tablesTableBucket {
    ...
    pub fn set_encryption_configuration(self, v: impl Into<S3tablesTableBucketEncryptionConfiguration>) -> Self {
    ...
    pub fn set_maintenance_configuration(self, v: impl Into<S3tablesTableBucketMaintenanceConfiguration>) -> Self {
...
impl ToListMappable for S3tablesTableBucketMaintenanceConfigurationIcebergUnreferencedFileRemovalSettings {
    type O = BlockAssignable<S3tablesTableBucketMaintenanceConfigurationIcebergUnreferencedFileRemovalSettings>;
...
impl BuildS3tablesTableBucketMaintenanceConfigurationIcebergUnreferencedFileRemovalSettings {
    pub fn build(self) -> S3tablesTableBucketMaintenanceConfigurationIcebergUnreferencedFileRemovalSettings {
...
impl S3tablesTableBucketMaintenanceConfigurationIcebergUnreferencedFileRemovalSettingsRef {
    ...
    pub fn non_current_days(&self) -> PrimExpr<f64> {
        PrimExpr::new(self.shared().clone(), format!("{}.non_current_days", self.base))
    }

    #[doc = "Get a reference to the value of field `unreferenced_days` after provisioning.\n"]
    pub fn unreferenced_days(&self) -> PrimExpr<f64> {
        PrimExpr::new(self.shared().clone(), format!("{}.unreferenced_days", self.base))
    }
}
...
pub struct S3tablesTableBucketMaintenanceConfigurationIcebergUnreferencedFileRemoval {
    #[serde(skip_serializing_if = "Option::is_none")]
    settings: Option<S3tablesTableBucketMaintenanceConfigurationIcebergUnreferencedFileRemovalSettings>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl ToListMappable for S3tablesTableBucketMaintenanceConfigurationIcebergUnreferencedFileRemoval {
    type O = BlockAssignable<S3tablesTableBucketMaintenanceConfigurationIcebergUnreferencedFileRemoval>;
...
impl BuildS3tablesTableBucketMaintenanceConfigurationIcebergUnreferencedFileRemoval {
    pub fn build(self) -> S3tablesTableBucketMaintenanceConfigurationIcebergUnreferencedFileRemoval {
...
impl S3tablesTableBucketMaintenanceConfigurationIcebergUnreferencedFileRemovalRef {
    ...
    pub fn settings(&self) -> S3tablesTableBucketMaintenanceConfigurationIcebergUnreferencedFileRemovalSettingsRef {
...
pub struct S3tablesTableBucketMaintenanceConfiguration {
    #[serde(skip_serializing_if = "Option::is_none")]
    iceberg_unreferenced_file_removal: Option<S3tablesTableBucketMaintenanceConfigurationIcebergUnreferencedFileRemoval>,
}
