...
#[derive(Serialize)]
struct DatasyncLocationFsxLustreFileSystemData {
...
struct DatasyncLocationFsxLustreFileSystem_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<DatasyncLocationFsxLustreFileSystemData>,
}

#[derive(Clone)]
pub struct DatasyncLocationFsxLustreFileSystem(Rc<DatasyncLocationFsxLustreFileSystem_>);

impl DatasyncLocationFsxLustreFileSystem {
...
impl Referable for DatasyncLocationFsxLustreFileSystem {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for DatasyncLocationFsxLustreFileSystem { }

impl ToListMappable for DatasyncLocationFsxLustreFileSystem {
    type O = ListRef<DatasyncLocationFsxLustreFileSystemRef>;
...
impl Resource_ for DatasyncLocationFsxLustreFileSystem_ {
    fn extract_resource_type(&self) -> String {
        "aws_datasync_location_fsx_lustre_file_system".into()
    }
...
pub struct BuildDatasyncLocationFsxLustreFileSystem {
    pub tf_id: String,
    #[doc = ""]
...
impl BuildDatasyncLocationFsxLustreFileSystem {
    pub fn build(self, stack: &mut Stack) -> DatasyncLocationFsxLustreFileSystem {
        let out = DatasyncLocationFsxLustreFileSystem(Rc::new(DatasyncLocationFsxLustreFileSystem_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(DatasyncLocationFsxLustreFileSystemData {
...
pub struct DatasyncLocationFsxLustreFileSystemRef {
    shared: StackShared,
    base: String,
}

impl Ref for DatasyncLocationFsxLustreFileSystemRef {
...
impl DatasyncLocationFsxLustreFileSystemRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
