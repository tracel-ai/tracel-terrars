...
impl GuarddutyDetectorFeature {
    ...
    pub fn set_additional_configuration(
        self,
        v: impl Into<BlockAssignable<GuarddutyDetectorFeatureAdditionalConfigurationEl>>,
    ) -> Self {
        match v.into() {
...
impl BuildGuarddutyDetectorFeature {
    pub fn build(self, stack: &mut Stack) -> GuarddutyDetectorFeature {
        let out = GuarddutyDetectorFeature(Rc::new(GuarddutyDetectorFeature_ {
            ...
            tf_id: self.tf_id,
            data: RefCell::new(GuarddutyDetectorFeatureData {
...
impl Ref for GuarddutyDetectorFeatureAdditionalConfigurationElRef {
    fn new(shared: StackShared, base: String) -> GuarddutyDetectorFeatureAdditionalConfigurationElRef {
        GuarddutyDetectorFeatureAdditionalConfigurationElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
struct GuarddutyDetectorFeatureDynamic {
    additional_configuration: Option<DynamicBlock<GuarddutyDetectorFeatureAdditionalConfigurationEl>>,
}
