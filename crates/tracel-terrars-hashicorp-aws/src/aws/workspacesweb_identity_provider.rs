...
struct WorkspaceswebIdentityProviderData {
    ...
    identity_provider_details: RecField<PrimField<String>>,
    identity_provider_name: PrimField<String>,
    identity_provider_type: PrimField<String>,
...
impl WorkspaceswebIdentityProvider {
    ...
    pub fn identity_provider_arn(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.identity_provider_arn", self.extract_ref()))
    }
    ...
    pub fn identity_provider_details(&self) -> RecRef<PrimExpr<String>> {
        RecRef::new(self.shared().clone(), format!("{}.identity_provider_details", self.extract_ref()))
    }
...
pub struct BuildWorkspaceswebIdentityProvider {
    pub tf_id: String,
    #[doc = ""]
    pub identity_provider_details: RecField<PrimField<String>>,
    #[doc = ""]
    pub identity_provider_name: PrimField<String>,
    #[doc = ""]
    pub identity_provider_type: PrimField<String>,
    #[doc = ""]
...
impl BuildWorkspaceswebIdentityProvider {
    pub fn build(self, stack: &mut Stack) -> WorkspaceswebIdentityProvider {
        let out = WorkspaceswebIdentityProvider(Rc::new(WorkspaceswebIdentityProvider_ {
            ...
            tf_id: self.tf_id,
            data: RefCell::new(WorkspaceswebIdentityProviderData {
