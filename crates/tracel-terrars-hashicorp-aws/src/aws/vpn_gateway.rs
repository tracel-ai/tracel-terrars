...
struct VpnGateway_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<VpnGatewayData>,
}

#[derive(Clone)]
pub struct VpnGateway(Rc<VpnGateway_>);
...
impl ToListMappable for VpnGateway {
    type O = ListRef<VpnGatewayRef>;
...
impl Resource_ for VpnGateway_ {
...
pub struct BuildVpnGateway {
    pub tf_id: String,
}

impl BuildVpnGateway {
    pub fn build(self, stack: &mut Stack) -> VpnGateway {
        let out = VpnGateway(Rc::new(VpnGateway_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(VpnGatewayData {
...
pub struct VpnGatewayRef {
    shared: StackShared,
    base: String,
}

impl Ref for VpnGatewayRef {
