...
struct AppsyncSourceApiAssociationData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    source_api_association_config: Option<ListField<AppsyncSourceApiAssociationSourceApiAssociationConfigEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl AppsyncSourceApiAssociation {
    ...
    pub fn merged_api_arn(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.merged_api_arn", self.extract_ref()))
    }

    #[doc = "Get a reference to the value of field `merged_api_id` after provisioning.\n"]
    pub fn merged_api_id(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.merged_api_id", self.extract_ref()))
    }
    ...
    pub fn source_api_arn(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.source_api_arn", self.extract_ref()))
    }

    #[doc = "Get a reference to the value of field `source_api_association_config` after provisioning.\n"]
    pub fn source_api_association_config(&self) -> ListRef<AppsyncSourceApiAssociationSourceApiAssociationConfigElRef> {
        ListRef::new(self.shared().clone(), format!("{}.source_api_association_config", self.extract_ref()))
    }

    #[doc = "Get a reference to the value of field `source_api_id` after provisioning.\n"]
    pub fn source_api_id(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.source_api_id", self.extract_ref()))
    }
...
impl BuildAppsyncSourceApiAssociationSourceApiAssociationConfigEl {
    pub fn build(self) -> AppsyncSourceApiAssociationSourceApiAssociationConfigEl {
        AppsyncSourceApiAssociationSourceApiAssociationConfigEl { merge_type: core::default::Default::default() }
    }
}
...
impl Ref for AppsyncSourceApiAssociationSourceApiAssociationConfigElRef {
    fn new(shared: StackShared, base: String) -> AppsyncSourceApiAssociationSourceApiAssociationConfigElRef {
