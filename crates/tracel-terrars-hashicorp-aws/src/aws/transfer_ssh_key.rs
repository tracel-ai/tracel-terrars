...
impl TransferSshKey {
    ...
    #[doc = "Get a reference to the value of field `ssh_key_id` after provisioning.\n"]
    pub fn ssh_key_id(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.ssh_key_id", self.extract_ref()))
    }
...
impl Referable for TransferSshKey {
