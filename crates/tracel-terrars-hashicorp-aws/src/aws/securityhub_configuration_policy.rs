...
impl SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterElBoolElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
impl SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterElDoubleElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
impl SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterElEnumElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
impl SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterElEnumListElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
impl SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterElIntElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
impl SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterElIntListElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }

    #[doc = "Get a reference to the value of field `value` after provisioning.\n"]
    pub fn value(&self) -> ListRef<PrimExpr<f64>> {
        ListRef::new(self.shared().clone(), format!("{}.value", self.base))
    }
}
...
impl SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterElStringElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
impl SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterElStringListElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize)]
pub struct SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterEl {
    name: PrimField<String>,
...
impl SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterEl {
    #[doc = "Set the field `bool`.\n"]
    pub fn set_bool(
        mut self,
        v:
            impl
        ...
        match v.into() {
            ...
            BlockAssignable::Dynamic(d) => {
                self.dynamic.bool = Some(d);
            },
        }
        self
    }

    #[doc = "Set the field `double`.\n"]
    pub fn set_double(
        mut self,
        v:
            impl
    ...
    pub fn set_enum(
        ...
        match v.into() {
            ...
            BlockAssignable::Dynamic(d) => {
                self.dynamic.enum_ = Some(d);
            },
        }
        self
    }

    #[doc = "Set the field `enum_list`.\n"]
    pub fn set_enum_list(
        mut self,
        v:
            impl
        ...
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.enum_list = Some(v);
            },
            BlockAssignable::Dynamic(d) => {
                self.dynamic.enum_list = Some(d);
            },
        }
        self
    }

    #[doc = "Set the field `int`.\n"]
    pub fn set_int(
        mut self,
        v:
            impl
        ...
        match v.into() {
            ...
            BlockAssignable::Dynamic(d) => {
                self.dynamic.int = Some(d);
            },
        }
        self
    }

    #[doc = "Set the field `int_list`.\n"]
    pub fn set_int_list(
        mut self,
        v:
            impl
        ...
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.int_list = Some(v);
            },
            BlockAssignable::Dynamic(d) => {
                self.dynamic.int_list = Some(d);
            },
        }
        self
    }

    #[doc = "Set the field `string`.\n"]
    pub fn set_string(
        mut self,
        v:
            impl
        ...
        match v.into() {
            ...
            BlockAssignable::Dynamic(d) => {
                self.dynamic.string = Some(d);
            },
        }
        self
    }

    #[doc = "Set the field `string_list`.\n"]
    pub fn set_string_list(
        ...
        match v.into() {
            BlockAssignable::Literal(v) => {
                self.string_list = Some(v);
            },
            BlockAssignable::Dynamic(d) => {
                self.dynamic.string_list = Some(d);
            },
        }
        self
    }
...
impl BuildSecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterEl {
    pub fn build(
        ...
        SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterEl {
            ...
            bool: core::default::Default::default(),
            double: core::default::Default::default(),
            enum_: core::default::Default::default(),
            enum_list: core::default::Default::default(),
            int: core::default::Default::default(),
            int_list: core::default::Default::default(),
            string: core::default::Default::default(),
            string_list: core::default::Default::default(),
            dynamic: Default::default(),
        }
    }
}
...
impl SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
    ...
    #[doc = "Get a reference to the value of field `bool` after provisioning.\n"]
    pub fn bool(
        &self,
    ) -> ListRef<
        SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterElBoolElRef,
    > {
        ListRef::new(self.shared().clone(), format!("{}.bool", self.base))
    }

    #[doc = "Get a reference to the value of field `double` after provisioning.\n"]
    pub fn double(
        &self,
    ) -> ListRef<
        SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterElDoubleElRef,
    > {
        ListRef::new(self.shared().clone(), format!("{}.double", self.base))
    }
    ...
    #[doc = "Get a reference to the value of field `enum_list` after provisioning.\n"]
    pub fn enum_list(
        &self,
    ) -> ListRef<
        SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterElEnumListElRef,
    > {
        ListRef::new(self.shared().clone(), format!("{}.enum_list", self.base))
    }

    #[doc = "Get a reference to the value of field `int` after provisioning.\n"]
    pub fn int(
        &self,
    ) -> ListRef<
        SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterElIntElRef,
    > {
        ListRef::new(self.shared().clone(), format!("{}.int", self.base))
    }

    #[doc = "Get a reference to the value of field `int_list` after provisioning.\n"]
    pub fn int_list(
        &self,
    ) -> ListRef<
        SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterElIntListElRef,
    > {
        ListRef::new(self.shared().clone(), format!("{}.int_list", self.base))
    }

    #[doc = "Get a reference to the value of field `string` after provisioning.\n"]
    pub fn string(
        &self,
    ) -> ListRef<
        SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterElStringElRef,
    > {
        ListRef::new(self.shared().clone(), format!("{}.string", self.base))
    }

    #[doc = "Get a reference to the value of field `string_list` after provisioning.\n"]
    pub fn string_list(
        &self,
    ) -> ListRef<
        SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterElStringListElRef,
    > {
        ListRef::new(self.shared().clone(), format!("{}.string_list", self.base))
    }
}

#[derive(Serialize, Default)]
struct SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElDynamic {
    parameter: Option<
        DynamicBlock<
            SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElParameterEl,
        >,
...
#[derive(Serialize)]
pub struct SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterEl {
...
impl SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterEl {
...
impl SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
...
#[derive(Serialize, Default)]
struct SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElDynamic {
    security_control_custom_parameter: Option<
        DynamicBlock<
            SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterEl,
        >,
    >,
...
#[derive(Serialize)]
pub struct SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    disabled_control_identifiers: Option<SetField<PrimField<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    enabled_control_identifiers: Option<SetField<PrimField<String>>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    security_control_custom_parameter: Option<
        Vec<
            SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterEl,
...
impl SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElRef {
    ...
    pub fn security_control_custom_parameter(
        &self,
    ) -> ListRef<
        SecurityhubConfigurationPolicyConfigurationPolicyElSecurityControlsConfigurationElSecurityControlCustomParameterElRef,
    > {
