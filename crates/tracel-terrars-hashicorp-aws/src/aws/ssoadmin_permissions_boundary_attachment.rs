...
impl SsoadminPermissionsBoundaryAttachment {
    ...
    pub fn set_timeouts(self, v: impl Into<SsoadminPermissionsBoundaryAttachmentTimeoutsEl>) -> Self {
...
impl Ref for SsoadminPermissionsBoundaryAttachmentTimeoutsElRef {
    fn new(shared: StackShared, base: String) -> SsoadminPermissionsBoundaryAttachmentTimeoutsElRef {
