...
struct LightsailKeyPair_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<LightsailKeyPairData>,
}

#[derive(Clone)]
pub struct LightsailKeyPair(Rc<LightsailKeyPair_>);

impl LightsailKeyPair {
    ...
    #[doc = "Get a reference to the value of field `encrypted_fingerprint` after provisioning.\n"]
    pub fn encrypted_fingerprint(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.encrypted_fingerprint", self.extract_ref()))
    }
    ...
    pub fn encrypted_private_key(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.encrypted_private_key", self.extract_ref()))
    }
...
impl Referable for LightsailKeyPair {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for LightsailKeyPair { }

impl ToListMappable for LightsailKeyPair {
    type O = ListRef<LightsailKeyPairRef>;
...
impl Resource_ for LightsailKeyPair_ {
    fn extract_resource_type(&self) -> String {
        "aws_lightsail_key_pair".into()
    }
...
pub struct BuildLightsailKeyPair {
    pub tf_id: String,
}

impl BuildLightsailKeyPair {
    pub fn build(self, stack: &mut Stack) -> LightsailKeyPair {
        let out = LightsailKeyPair(Rc::new(LightsailKeyPair_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(LightsailKeyPairData {
...
pub struct LightsailKeyPairRef {
    shared: StackShared,
    base: String,
}

impl Ref for LightsailKeyPairRef {
