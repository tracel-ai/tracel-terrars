...
struct BedrockagentcoreAgentRuntimeEndpointData {
    ...
    agent_runtime_id: PrimField<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    agent_runtime_version: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl BedrockagentcoreAgentRuntimeEndpoint {
    ...
    pub fn set_timeouts(self, v: impl Into<BedrockagentcoreAgentRuntimeEndpointTimeoutsEl>) -> Self {
    ...
    pub fn agent_runtime_endpoint_arn(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.agent_runtime_endpoint_arn", self.extract_ref()))
    }
...
pub struct BuildBedrockagentcoreAgentRuntimeEndpoint {
    pub tf_id: String,
    #[doc = ""]
    pub agent_runtime_id: PrimField<String>,
    #[doc = ""]
...
impl BuildBedrockagentcoreAgentRuntimeEndpoint {
    pub fn build(self, stack: &mut Stack) -> BedrockagentcoreAgentRuntimeEndpoint {
        let out = BedrockagentcoreAgentRuntimeEndpoint(Rc::new(BedrockagentcoreAgentRuntimeEndpoint_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(BedrockagentcoreAgentRuntimeEndpointData {
                depends_on: core::default::Default::default(),
                provider: None,
                lifecycle: core::default::Default::default(),
                for_each: None,
                agent_runtime_id: self.agent_runtime_id,
                agent_runtime_version: core::default::Default::default(),
