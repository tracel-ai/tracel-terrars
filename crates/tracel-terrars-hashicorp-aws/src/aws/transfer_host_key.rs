...
struct TransferHostKeyData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    host_key_body: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    host_key_body_wo: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl TransferHostKey {
    ...
    pub fn host_key_body(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.host_key_body", self.extract_ref()))
    }
    ...
    pub fn host_key_body_wo(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.host_key_body_wo", self.extract_ref()))
    }
    ...
    pub fn host_key_id(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.host_key_id", self.extract_ref()))
    }
...
impl BuildTransferHostKey {
    pub fn build(self, stack: &mut Stack) -> TransferHostKey {
        let out = TransferHostKey(Rc::new(TransferHostKey_ {
            ...
            tf_id: self.tf_id,
            data: RefCell::new(TransferHostKeyData {
                depends_on: core::default::Default::default(),
                provider: None,
                lifecycle: core::default::Default::default(),
                for_each: None,
                description: core::default::Default::default(),
                host_key_body: core::default::Default::default(),
                host_key_body_wo: core::default::Default::default(),
