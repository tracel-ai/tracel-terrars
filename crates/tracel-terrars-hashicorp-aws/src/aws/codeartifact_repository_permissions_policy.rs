...
#[derive(Serialize)]
struct CodeartifactRepositoryPermissionsPolicyData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    policy_revision: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    region: Option<PrimField<String>>,
    repository: PrimField<String>,
}

struct CodeartifactRepositoryPermissionsPolicy_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<CodeartifactRepositoryPermissionsPolicyData>,
}

#[derive(Clone)]
pub struct CodeartifactRepositoryPermissionsPolicy(Rc<CodeartifactRepositoryPermissionsPolicy_>);

impl CodeartifactRepositoryPermissionsPolicy {
    ...
    pub fn policy_revision(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.policy_revision", self.extract_ref()))
    }
...
impl Referable for CodeartifactRepositoryPermissionsPolicy {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for CodeartifactRepositoryPermissionsPolicy { }

impl ToListMappable for CodeartifactRepositoryPermissionsPolicy {
    type O = ListRef<CodeartifactRepositoryPermissionsPolicyRef>;
...
impl Resource_ for CodeartifactRepositoryPermissionsPolicy_ {
    fn extract_resource_type(&self) -> String {
        "aws_codeartifact_repository_permissions_policy".into()
    }
...
pub struct BuildCodeartifactRepositoryPermissionsPolicy {
    pub tf_id: String,
    #[doc = ""]
...
impl BuildCodeartifactRepositoryPermissionsPolicy {
    pub fn build(self, stack: &mut Stack) -> CodeartifactRepositoryPermissionsPolicy {
        let out = CodeartifactRepositoryPermissionsPolicy(Rc::new(CodeartifactRepositoryPermissionsPolicy_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(CodeartifactRepositoryPermissionsPolicyData {
                ...
                policy_revision: core::default::Default::default(),
...
pub struct CodeartifactRepositoryPermissionsPolicyRef {
    shared: StackShared,
    base: String,
}

impl Ref for CodeartifactRepositoryPermissionsPolicyRef {
...
impl CodeartifactRepositoryPermissionsPolicyRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
