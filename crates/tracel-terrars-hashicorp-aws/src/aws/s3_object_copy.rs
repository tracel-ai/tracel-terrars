...
impl S3ObjectCopy {
    ...
    pub fn set_override_provider(self, v: impl Into<BlockAssignable<S3ObjectCopyOverrideProviderEl>>) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn override_provider(&self) -> ListRef<S3ObjectCopyOverrideProviderElRef> {
        ListRef::new(self.shared().clone(), format!("{}.override_provider", self.extract_ref()))
    }
}
...
impl BuildS3ObjectCopyOverrideProviderElDefaultTagsEl {
    pub fn build(self) -> S3ObjectCopyOverrideProviderElDefaultTagsEl {
        S3ObjectCopyOverrideProviderElDefaultTagsEl { tags: core::default::Default::default() }
    }
}
