...
struct DataIamSessionContext_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<DataIamSessionContextData>,
}

#[derive(Clone)]
pub struct DataIamSessionContext(Rc<DataIamSessionContext_>);

impl DataIamSessionContext {
...
impl Datasource_ for DataIamSessionContext_ {
    fn extract_datasource_type(&self) -> String {
        "aws_iam_session_context".into()
    }
...
pub struct BuildDataIamSessionContext {
    pub tf_id: String,
    #[doc = ""]
    pub arn: PrimField<String>,
}

impl BuildDataIamSessionContext {
    pub fn build(self, stack: &mut Stack) -> DataIamSessionContext {
        let out = DataIamSessionContext(Rc::new(DataIamSessionContext_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(DataIamSessionContextData {
...
pub struct DataIamSessionContextRef {
    shared: StackShared,
    base: String,
}
