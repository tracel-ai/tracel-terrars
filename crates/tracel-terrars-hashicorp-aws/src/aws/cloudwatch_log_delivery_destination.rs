...
struct CloudwatchLogDeliveryDestinationData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    delivery_destination_configuration: Option<Vec<CloudwatchLogDeliveryDestinationDeliveryDestinationConfigurationEl>>,
...
impl CloudwatchLogDeliveryDestination {
    ...
    pub fn set_delivery_destination_configuration(
        self,
        v: impl Into<BlockAssignable<CloudwatchLogDeliveryDestinationDeliveryDestinationConfigurationEl>>,
    ) -> Self {
        match v.into() {
            ...
            BlockAssignable::Dynamic(d) => {
                self.0.data.borrow_mut().dynamic.delivery_destination_configuration = Some(d);
            },
        }
        self
    }
    ...
    pub fn delivery_destination_type(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.delivery_destination_type", self.extract_ref()))
    }
    ...
    pub fn delivery_destination_configuration(
        ...
        ListRef::new(self.shared().clone(), format!("{}.delivery_destination_configuration", self.extract_ref()))
    }
}
...
impl CloudwatchLogDeliveryDestinationDeliveryDestinationConfigurationElRef {
    ...
    pub fn destination_resource_arn(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.destination_resource_arn", self.base))
    }
}

#[derive(Serialize, Default)]
struct CloudwatchLogDeliveryDestinationDynamic {
    delivery_destination_configuration: Option<
        DynamicBlock<CloudwatchLogDeliveryDestinationDeliveryDestinationConfigurationEl>,
    >,
}
