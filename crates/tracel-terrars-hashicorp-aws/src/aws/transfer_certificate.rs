...
impl TransferCertificate {
    ...
    pub fn active_date(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.active_date", self.extract_ref()))
    }
    ...
    pub fn inactive_date(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.inactive_date", self.extract_ref()))
    }
    ...
    pub fn usage(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.usage", self.extract_ref()))
    }
}
