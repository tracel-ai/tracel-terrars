...
impl ApiGatewayDomainNameAccessAssociation {
    ...
    pub fn access_association_source(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.access_association_source", self.extract_ref()))
    }
    ...
    pub fn access_association_source_type(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.access_association_source_type", self.extract_ref()))
    }
    ...
    pub fn domain_name_arn(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.domain_name_arn", self.extract_ref()))
    }
...
impl BuildApiGatewayDomainNameAccessAssociation {
    pub fn build(self, stack: &mut Stack) -> ApiGatewayDomainNameAccessAssociation {
        let out = ApiGatewayDomainNameAccessAssociation(Rc::new(ApiGatewayDomainNameAccessAssociation_ {
