...
impl DevopsguruEventSourcesConfig {
    ...
    pub fn set_event_sources(self, v: impl Into<BlockAssignable<DevopsguruEventSourcesConfigEventSourcesEl>>) -> Self {
        match v.into() {
    ...
    pub fn event_sources(&self) -> ListRef<DevopsguruEventSourcesConfigEventSourcesElRef> {
        ListRef::new(self.shared().clone(), format!("{}.event_sources", self.extract_ref()))
    }
}
...
impl BuildDevopsguruEventSourcesConfigEventSourcesElAmazonCodeGuruProfilerEl {
    pub fn build(self) -> DevopsguruEventSourcesConfigEventSourcesElAmazonCodeGuruProfilerEl {
        DevopsguruEventSourcesConfigEventSourcesElAmazonCodeGuruProfilerEl { status: self.status }
    }
}
...
struct DevopsguruEventSourcesConfigEventSourcesElDynamic {
    amazon_code_guru_profiler: Option<
        DynamicBlock<DevopsguruEventSourcesConfigEventSourcesElAmazonCodeGuruProfilerEl>,
    >,
}
...
pub struct DevopsguruEventSourcesConfigEventSourcesEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    amazon_code_guru_profiler: Option<Vec<DevopsguruEventSourcesConfigEventSourcesElAmazonCodeGuruProfilerEl>>,
...
impl DevopsguruEventSourcesConfigEventSourcesEl {
    ...
    pub fn set_amazon_code_guru_profiler(
        mut self,
        v: impl Into<BlockAssignable<DevopsguruEventSourcesConfigEventSourcesElAmazonCodeGuruProfilerEl>>,
    ) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
...
impl DevopsguruEventSourcesConfigEventSourcesElRef {
    ...
    pub fn amazon_code_guru_profiler(
        ...
        ListRef::new(self.shared().clone(), format!("{}.amazon_code_guru_profiler", self.base))
    }
}
