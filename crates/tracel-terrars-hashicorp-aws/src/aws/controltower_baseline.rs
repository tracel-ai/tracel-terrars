...
impl ControltowerBaseline {
    ...
    pub fn set_parameters(self, v: impl Into<BlockAssignable<ControltowerBaselineParametersEl>>) -> Self {
        match v.into() {
    ...
    pub fn baseline_identifier(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.baseline_identifier", self.extract_ref()))
    }
    ...
    pub fn baseline_version(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.baseline_version", self.extract_ref()))
    }
    ...
    pub fn operation_identifier(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.operation_identifier", self.extract_ref()))
    }
    ...
    pub fn timeouts(&self) -> ControltowerBaselineTimeoutsElRef {
        ControltowerBaselineTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
}
