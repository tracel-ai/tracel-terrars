...
#[derive(Clone)]
pub struct Ec2TransitGatewayDefaultRouteTableAssociation(Rc<Ec2TransitGatewayDefaultRouteTableAssociation_>);
...
impl Ec2TransitGatewayDefaultRouteTableAssociation {
    ...
    pub fn set_timeouts(self, v: impl Into<Ec2TransitGatewayDefaultRouteTableAssociationTimeoutsEl>) -> Self {
    ...
    pub fn original_default_route_table_id(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.original_default_route_table_id", self.extract_ref()))
    }
...
impl BuildEc2TransitGatewayDefaultRouteTableAssociation {
    pub fn build(self, stack: &mut Stack) -> Ec2TransitGatewayDefaultRouteTableAssociation {
        let out =
            Ec2TransitGatewayDefaultRouteTableAssociation(Rc::new(Ec2TransitGatewayDefaultRouteTableAssociation_ {
                shared: stack.shared.clone(),
                tf_id: self.tf_id,
                data: RefCell::new(Ec2TransitGatewayDefaultRouteTableAssociationData {
...
impl Ref for Ec2TransitGatewayDefaultRouteTableAssociationTimeoutsElRef {
    fn new(shared: StackShared, base: String) -> Ec2TransitGatewayDefaultRouteTableAssociationTimeoutsElRef {
        Ec2TransitGatewayDefaultRouteTableAssociationTimeoutsElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
