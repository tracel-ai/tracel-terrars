...
struct BackupVaultPolicy_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<BackupVaultPolicyData>,
}

#[derive(Clone)]
pub struct BackupVaultPolicy(Rc<BackupVaultPolicy_>);

impl BackupVaultPolicy {
...
impl Referable for BackupVaultPolicy {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for BackupVaultPolicy { }

impl ToListMappable for BackupVaultPolicy {
    type O = ListRef<BackupVaultPolicyRef>;
...
impl Resource_ for BackupVaultPolicy_ {
    fn extract_resource_type(&self) -> String {
        "aws_backup_vault_policy".into()
    }
...
pub struct BuildBackupVaultPolicy {
    pub tf_id: String,
    #[doc = ""]
...
impl BuildBackupVaultPolicy {
    pub fn build(self, stack: &mut Stack) -> BackupVaultPolicy {
        let out = BackupVaultPolicy(Rc::new(BackupVaultPolicy_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(BackupVaultPolicyData {
...
pub struct BackupVaultPolicyRef {
    shared: StackShared,
    base: String,
}

impl Ref for BackupVaultPolicyRef {
