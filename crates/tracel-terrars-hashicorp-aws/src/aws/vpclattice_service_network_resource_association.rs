...
#[derive(Clone)]
pub struct VpclatticeServiceNetworkResourceAssociation(Rc<VpclatticeServiceNetworkResourceAssociation_>);
...
impl VpclatticeServiceNetworkResourceAssociation {
    ...
    pub fn set_timeouts(self, v: impl Into<VpclatticeServiceNetworkResourceAssociationTimeoutsEl>) -> Self {
    ...
    pub fn resource_configuration_identifier(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.resource_configuration_identifier", self.extract_ref()))
    }
...
impl BuildVpclatticeServiceNetworkResourceAssociation {
    pub fn build(self, stack: &mut Stack) -> VpclatticeServiceNetworkResourceAssociation {
        let out = VpclatticeServiceNetworkResourceAssociation(Rc::new(VpclatticeServiceNetworkResourceAssociation_ {
...
impl Ref for VpclatticeServiceNetworkResourceAssociationDnsEntryElRef {
    fn new(shared: StackShared, base: String) -> VpclatticeServiceNetworkResourceAssociationDnsEntryElRef {
...
impl Ref for VpclatticeServiceNetworkResourceAssociationTimeoutsElRef {
    fn new(shared: StackShared, base: String) -> VpclatticeServiceNetworkResourceAssociationTimeoutsElRef {
