...
impl CloudwatchEventBus {
    ...
    pub fn set_dead_letter_config(self, v: impl Into<BlockAssignable<CloudwatchEventBusDeadLetterConfigEl>>) -> Self {
        match v.into() {
    ...
    pub fn set_log_config(self, v: impl Into<BlockAssignable<CloudwatchEventBusLogConfigEl>>) -> Self {
        match v.into() {
            BlockAssignable::Literal(v) => {
    ...
    pub fn event_source_name(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.event_source_name", self.extract_ref()))
    }
...
impl BuildCloudwatchEventBusDeadLetterConfigEl {
    pub fn build(self) -> CloudwatchEventBusDeadLetterConfigEl {
        CloudwatchEventBusDeadLetterConfigEl { arn: core::default::Default::default() }
    }
}
