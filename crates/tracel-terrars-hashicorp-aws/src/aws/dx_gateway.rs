...
struct DxGatewayData {
    ...
    amazon_side_asn: PrimField<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl DxGateway {
    ...
    pub fn timeouts(&self) -> DxGatewayTimeoutsElRef {
        DxGatewayTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
}
...
pub struct BuildDxGateway {
    pub tf_id: String,
    #[doc = ""]
    pub amazon_side_asn: PrimField<String>,
    #[doc = ""]
...
impl BuildDxGateway {
    pub fn build(self, stack: &mut Stack) -> DxGateway {
        let out = DxGateway(Rc::new(DxGateway_ {
            ...
            tf_id: self.tf_id,
            data: RefCell::new(DxGatewayData {
