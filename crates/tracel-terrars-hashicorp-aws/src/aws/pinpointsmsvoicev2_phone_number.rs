...
impl Pinpointsmsvoicev2PhoneNumber {
    ...
    pub fn iso_country_code(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.iso_country_code", self.extract_ref()))
    }

    #[doc = "Get a reference to the value of field `message_type` after provisioning.\n"]
    pub fn message_type(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.message_type", self.extract_ref()))
    }
    ...
    pub fn monthly_leasing_price(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.monthly_leasing_price", self.extract_ref()))
    }
    ...
    pub fn number_capabilities(&self) -> SetRef<PrimExpr<String>> {
        SetRef::new(self.shared().clone(), format!("{}.number_capabilities", self.extract_ref()))
    }

    #[doc = "Get a reference to the value of field `number_type` after provisioning.\n"]
    pub fn number_type(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.number_type", self.extract_ref()))
    }
    ...
    pub fn opt_out_list_name(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.opt_out_list_name", self.extract_ref()))
    }
    ...
    pub fn registration_id(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.registration_id", self.extract_ref()))
    }
    ...
    pub fn self_managed_opt_outs_enabled(&self) -> PrimExpr<bool> {
        PrimExpr::new(self.shared().clone(), format!("{}.self_managed_opt_outs_enabled", self.extract_ref()))
    }
    ...
    pub fn two_way_channel_arn(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.two_way_channel_arn", self.extract_ref()))
    }
    ...
    pub fn two_way_channel_enabled(&self) -> PrimExpr<bool> {
        PrimExpr::new(self.shared().clone(), format!("{}.two_way_channel_enabled", self.extract_ref()))
    }
    ...
    pub fn two_way_channel_role(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.two_way_channel_role", self.extract_ref()))
    }
