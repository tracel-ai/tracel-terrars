...
impl BedrockagentcoreCodeInterpreter {
    ...
    pub fn code_interpreter_arn(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.code_interpreter_arn", self.extract_ref()))
    }
    ...
    pub fn code_interpreter_id(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.code_interpreter_id", self.extract_ref()))
    }
    ...
    pub fn network_configuration(&self) -> ListRef<BedrockagentcoreCodeInterpreterNetworkConfigurationElRef> {
...
impl Ref for BedrockagentcoreCodeInterpreterNetworkConfigurationElVpcConfigElRef {
    fn new(shared: StackShared, base: String) -> BedrockagentcoreCodeInterpreterNetworkConfigurationElVpcConfigElRef {
...
struct BedrockagentcoreCodeInterpreterNetworkConfigurationElDynamic {
    vpc_config: Option<DynamicBlock<BedrockagentcoreCodeInterpreterNetworkConfigurationElVpcConfigEl>>,
}
...
impl Ref for BedrockagentcoreCodeInterpreterNetworkConfigurationElRef {
    fn new(shared: StackShared, base: String) -> BedrockagentcoreCodeInterpreterNetworkConfigurationElRef {
...
impl BedrockagentcoreCodeInterpreterNetworkConfigurationElRef {
    ...
    pub fn vpc_config(&self) -> ListRef<BedrockagentcoreCodeInterpreterNetworkConfigurationElVpcConfigElRef> {
...
struct BedrockagentcoreCodeInterpreterDynamic {
    network_configuration: Option<DynamicBlock<BedrockagentcoreCodeInterpreterNetworkConfigurationEl>>,
}
