...
impl Ref for DataLbListenerDefaultActionElJwtValidationElAdditionalClaimElRef {
    fn new(shared: StackShared, base: String) -> DataLbListenerDefaultActionElJwtValidationElAdditionalClaimElRef {
...
pub struct DataLbListenerDefaultActionElJwtValidationEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    additional_claim: Option<SetField<DataLbListenerDefaultActionElJwtValidationElAdditionalClaimEl>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    issuer: Option<PrimField<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl DataLbListenerDefaultActionElJwtValidationElRef {
    ...
    pub fn additional_claim(&self) -> SetRef<DataLbListenerDefaultActionElJwtValidationElAdditionalClaimElRef> {
...
impl DataLbListenerDefaultActionEl {
    ...
    pub fn set_jwt_validation(mut self, v: impl Into<ListField<DataLbListenerDefaultActionElJwtValidationEl>>) -> Self {
