...
impl AppfabricIngestionDestination {
    ...
    pub fn ingestion_arn(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.ingestion_arn", self.extract_ref()))
    }
    ...
    pub fn destination_configuration(&self) -> ListRef<AppfabricIngestionDestinationDestinationConfigurationElRef> {
    ...
    pub fn processing_configuration(&self) -> ListRef<AppfabricIngestionDestinationProcessingConfigurationElRef> {
        ListRef::new(self.shared().clone(), format!("{}.processing_configuration", self.extract_ref()))
    }
...
impl AppfabricIngestionDestinationDestinationConfigurationElAuditLogElDestinationElFirehoseStreamEl { }
...
impl ToListMappable for AppfabricIngestionDestinationDestinationConfigurationElAuditLogElDestinationElS3BucketEl {
    type O =
        BlockAssignable<AppfabricIngestionDestinationDestinationConfigurationElAuditLogElDestinationElS3BucketEl>;
...
impl BuildAppfabricIngestionDestinationDestinationConfigurationElAuditLogElDestinationElS3BucketEl {
    pub fn build(self) -> AppfabricIngestionDestinationDestinationConfigurationElAuditLogElDestinationElS3BucketEl {
...
impl Ref for AppfabricIngestionDestinationDestinationConfigurationElAuditLogElDestinationElS3BucketElRef {
    fn new(
        shared: StackShared,
        base: String,
...
impl ToListMappable for AppfabricIngestionDestinationDestinationConfigurationElAuditLogElDestinationEl {
    type O = BlockAssignable<AppfabricIngestionDestinationDestinationConfigurationElAuditLogElDestinationEl>;
...
impl BuildAppfabricIngestionDestinationDestinationConfigurationElAuditLogElDestinationEl {
    pub fn build(self) -> AppfabricIngestionDestinationDestinationConfigurationElAuditLogElDestinationEl {
...
impl AppfabricIngestionDestinationDestinationConfigurationElAuditLogElDestinationElRef {
    ...
    pub fn firehose_stream(
        ...
        ListRef::new(self.shared().clone(), format!("{}.firehose_stream", self.base))
    }

    #[doc = "Get a reference to the value of field `s3_bucket` after provisioning.\n"]
    pub fn s3_bucket(
        &self,
    ) -> ListRef<AppfabricIngestionDestinationDestinationConfigurationElAuditLogElDestinationElS3BucketElRef> {
...
struct AppfabricIngestionDestinationDestinationConfigurationElAuditLogElDynamic {
    destination: Option<
        DynamicBlock<AppfabricIngestionDestinationDestinationConfigurationElAuditLogElDestinationEl>,
    >,
}
...
pub struct AppfabricIngestionDestinationDestinationConfigurationElAuditLogEl {
    #[serde(skip_serializing_if = "Option::is_none")]
    destination: Option<Vec<AppfabricIngestionDestinationDestinationConfigurationElAuditLogElDestinationEl>>,
...
struct AppfabricIngestionDestinationDestinationConfigurationElDynamic {
    audit_log: Option<DynamicBlock<AppfabricIngestionDestinationDestinationConfigurationElAuditLogEl>>,
}
...
impl Ref for AppfabricIngestionDestinationDestinationConfigurationElRef {
    fn new(shared: StackShared, base: String) -> AppfabricIngestionDestinationDestinationConfigurationElRef {
...
impl AppfabricIngestionDestinationDestinationConfigurationElRef {
    ...
    pub fn audit_log(&self) -> ListRef<AppfabricIngestionDestinationDestinationConfigurationElAuditLogElRef> {
...
impl Ref for AppfabricIngestionDestinationProcessingConfigurationElAuditLogElRef {
    fn new(shared: StackShared, base: String) -> AppfabricIngestionDestinationProcessingConfigurationElAuditLogElRef {
...
struct AppfabricIngestionDestinationProcessingConfigurationElDynamic {
    audit_log: Option<DynamicBlock<AppfabricIngestionDestinationProcessingConfigurationElAuditLogEl>>,
}
...
impl Ref for AppfabricIngestionDestinationProcessingConfigurationElRef {
    fn new(shared: StackShared, base: String) -> AppfabricIngestionDestinationProcessingConfigurationElRef {
...
impl AppfabricIngestionDestinationProcessingConfigurationElRef {
    ...
    #[doc = "Get a reference to the value of field `audit_log` after provisioning.\n"]
    pub fn audit_log(&self) -> ListRef<AppfabricIngestionDestinationProcessingConfigurationElAuditLogElRef> {
        ListRef::new(self.shared().clone(), format!("{}.audit_log", self.base))
    }
}
...
struct AppfabricIngestionDestinationDynamic {
    destination_configuration: Option<DynamicBlock<AppfabricIngestionDestinationDestinationConfigurationEl>>,
    processing_configuration: Option<DynamicBlock<AppfabricIngestionDestinationProcessingConfigurationEl>>,
}
