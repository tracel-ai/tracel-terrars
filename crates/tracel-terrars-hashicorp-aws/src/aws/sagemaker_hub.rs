...
impl SagemakerHub {
    ...
    pub fn set_s3_storage_config(self, v: impl Into<BlockAssignable<SagemakerHubS3StorageConfigEl>>) -> Self {
        match v.into() {
    ...
    pub fn hub_description(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.hub_description", self.extract_ref()))
    }
    ...
    pub fn hub_display_name(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.hub_display_name", self.extract_ref()))
    }

    #[doc = "Get a reference to the value of field `hub_name` after provisioning.\n"]
    pub fn hub_name(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.hub_name", self.extract_ref()))
    }
    ...
    pub fn hub_search_keywords(&self) -> SetRef<PrimExpr<String>> {
        SetRef::new(self.shared().clone(), format!("{}.hub_search_keywords", self.extract_ref()))
    }
    ...
    pub fn s3_storage_config(&self) -> ListRef<SagemakerHubS3StorageConfigElRef> {
        ListRef::new(self.shared().clone(), format!("{}.s3_storage_config", self.extract_ref()))
    }
}
...
impl BuildSagemakerHubS3StorageConfigEl {
    pub fn build(self) -> SagemakerHubS3StorageConfigEl {
        SagemakerHubS3StorageConfigEl { s3_output_path: core::default::Default::default() }
    }
}
