...
impl ElasticacheReplicationGroup {
    ...
    pub fn auth_token_update_strategy(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.auth_token_update_strategy", self.extract_ref()))
    }
...
impl Ref for ElasticacheReplicationGroupNodeGroupConfigurationElRef {
    fn new(shared: StackShared, base: String) -> ElasticacheReplicationGroupNodeGroupConfigurationElRef {
...
struct ElasticacheReplicationGroupDynamic {
    ...
    node_group_configuration: Option<DynamicBlock<ElasticacheReplicationGroupNodeGroupConfigurationEl>>,
}
