...
impl BackupRegionSettings {
    ...
    pub fn set_resource_type_management_preference(self, v: impl Into<RecField<PrimField<bool>>>) -> Self {
    ...
    pub fn resource_type_management_preference(&self) -> RecRef<PrimExpr<bool>> {
        RecRef::new(self.shared().clone(), format!("{}.resource_type_management_preference", self.extract_ref()))
    }
    ...
    pub fn resource_type_opt_in_preference(&self) -> RecRef<PrimExpr<bool>> {
        RecRef::new(self.shared().clone(), format!("{}.resource_type_opt_in_preference", self.extract_ref()))
    }
}
...
impl BuildBackupRegionSettings {
    pub fn build(self, stack: &mut Stack) -> BackupRegionSettings {
        let out = BackupRegionSettings(Rc::new(BackupRegionSettings_ {
            ...
            tf_id: self.tf_id,
            data: RefCell::new(BackupRegionSettingsData {
                ...
                resource_type_management_preference: core::default::Default::default(),
