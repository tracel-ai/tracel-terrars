...
impl PaymentcryptographyKey {
    ...
    pub fn set_key_attributes(self, v: impl Into<BlockAssignable<PaymentcryptographyKeyKeyAttributesEl>>) -> Self {
        match v.into() {
    ...
    pub fn exportable(&self) -> PrimExpr<bool> {
        PrimExpr::new(self.shared().clone(), format!("{}.exportable", self.extract_ref()))
    }
    ...
    pub fn key_check_value(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.key_check_value", self.extract_ref()))
    }
    ...
    pub fn key_check_value_algorithm(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.key_check_value_algorithm", self.extract_ref()))
    }

    #[doc = "Get a reference to the value of field `key_origin` after provisioning.\n"]
    pub fn key_origin(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.key_origin", self.extract_ref()))
    }
    ...
    pub fn key_attributes(&self) -> ListRef<PaymentcryptographyKeyKeyAttributesElRef> {
        ListRef::new(self.shared().clone(), format!("{}.key_attributes", self.extract_ref()))
    }

    #[doc = "Get a reference to the value of field `timeouts` after provisioning.\n"]
    pub fn timeouts(&self) -> PaymentcryptographyKeyTimeoutsElRef {
        PaymentcryptographyKeyTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
}
...
impl Ref for PaymentcryptographyKeyKeyAttributesElKeyModesOfUseElRef {
    fn new(shared: StackShared, base: String) -> PaymentcryptographyKeyKeyAttributesElKeyModesOfUseElRef {
...
impl PaymentcryptographyKeyKeyAttributesElKeyModesOfUseElRef {
    ...
    pub fn no_restrictions(&self) -> PrimExpr<bool> {
        PrimExpr::new(self.shared().clone(), format!("{}.no_restrictions", self.base))
    }
...
impl PaymentcryptographyKeyKeyAttributesElRef {
    ...
    pub fn key_modes_of_use(&self) -> ListRef<PaymentcryptographyKeyKeyAttributesElKeyModesOfUseElRef> {
        ListRef::new(self.shared().clone(), format!("{}.key_modes_of_use", self.base))
    }
}
