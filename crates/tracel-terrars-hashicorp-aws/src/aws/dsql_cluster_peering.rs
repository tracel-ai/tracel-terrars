...
struct DsqlClusterPeeringData {
    ...
    clusters: SetField<PrimField<String>>,
    identifier: PrimField<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    region: Option<PrimField<String>>,
    witness_region: PrimField<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl DsqlClusterPeering {
    ...
    pub fn clusters(&self) -> SetRef<PrimExpr<String>> {
        SetRef::new(self.shared().clone(), format!("{}.clusters", self.extract_ref()))
    }
    ...
    pub fn witness_region(&self) -> PrimExpr<String> {
        PrimExpr::new(self.shared().clone(), format!("{}.witness_region", self.extract_ref()))
    }

    #[doc = "Get a reference to the value of field `timeouts` after provisioning.\n"]
    pub fn timeouts(&self) -> DsqlClusterPeeringTimeoutsElRef {
        DsqlClusterPeeringTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
}
...
pub struct BuildDsqlClusterPeering {
    pub tf_id: String,
    #[doc = ""]
    pub clusters: SetField<PrimField<String>>,
    #[doc = ""]
...
impl BuildDsqlClusterPeering {
    pub fn build(self, stack: &mut Stack) -> DsqlClusterPeering {
        let out = DsqlClusterPeering(Rc::new(DsqlClusterPeering_ {
            ...
            tf_id: self.tf_id,
            data: RefCell::new(DsqlClusterPeeringData {
...
impl BuildDsqlClusterPeeringTimeoutsEl {
    pub fn build(self) -> DsqlClusterPeeringTimeoutsEl {
        DsqlClusterPeeringTimeoutsEl { create: core::default::Default::default() }
    }
}
