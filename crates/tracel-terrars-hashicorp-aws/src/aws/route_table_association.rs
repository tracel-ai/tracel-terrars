...
struct RouteTableAssociationData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    timeouts: Option<RouteTableAssociationTimeoutsEl>,
}
...
impl RouteTableAssociation {
    ...
    pub fn set_timeouts(self, v: impl Into<RouteTableAssociationTimeoutsEl>) -> Self {
    ...
    pub fn timeouts(&self) -> RouteTableAssociationTimeoutsElRef {
        RouteTableAssociationTimeoutsElRef::new(self.shared().clone(), format!("{}.timeouts", self.extract_ref()))
    }
}

impl Referable for RouteTableAssociation {
...
#[derive(Serialize)]
pub struct RouteTableAssociationTimeoutsEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl RouteTableAssociationTimeoutsEl {
...
impl ToListMappable for RouteTableAssociationTimeoutsEl {
    type O = BlockAssignable<RouteTableAssociationTimeoutsEl>;
...
pub struct BuildRouteTableAssociationTimeoutsEl {}

impl BuildRouteTableAssociationTimeoutsEl {
    pub fn build(self) -> RouteTableAssociationTimeoutsEl {
        RouteTableAssociationTimeoutsEl {
...
pub struct RouteTableAssociationTimeoutsElRef {
    shared: StackShared,
    base: String,
}

impl Ref for RouteTableAssociationTimeoutsElRef {
    fn new(shared: StackShared, base: String) -> RouteTableAssociationTimeoutsElRef {
        RouteTableAssociationTimeoutsElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl RouteTableAssociationTimeoutsElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
